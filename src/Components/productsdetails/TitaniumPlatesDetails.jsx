...
// Replace these image paths with your actual Titanium Plates product images
...
import titanium from "../../products-image/ss-titanium-plates.webp"; 
...
const mechanicalData = [
  ...
  {
    grade: "Titanium Grade 5",
    tensile: "895 MPa (130 ksi)",
    yield: "825 MPa (120 ksi)",
    elongation: "10%",
    density: "4.43 g/cm³",
  },
  {
  ...
  },
  {
    ...
    yield: "480 MPa (70 ksi)",
    elongation: "15%",
    density: "4.48 g/cm³",
  },
];

// Thickness, weight, gauge, tolerance tables (adapted for Plates/Sheets)
const leftThickness = [
...
// Approx weights for Titanium (density 4.51 g/cm³)
const leftData = [
...
const leftItems = [
  "Titanium Grade 1, 2, 5, 7 & 9 Plates & Sheets (ASTM B265)",
  "Titanium Alloy Plates for Aerospace & Marine Applications",
  "Titanium Grade 5 (Ti-6Al-4V) High-Strength Plates",
  "Titanium Grade 7 Palladium-Bearing Plates for Reducing Acids",
  "Titanium Coils, Strips & Foils",
  "Titanium Circles & Rings for Precision Components",
  "Titanium Plate Manufacturer in India",
];

const rightItems = [
  "ASTM B265 / ASME SB265 / AMS 4900 / 4911",
  "Custom Sizes, Thicknesses, and Cut-to-Length Supply",
  "Hot Rolled / Cold Rolled / Annealed Plates",
  "Solution Treated & Aged Ti-6Al-4V Plates",
  "Precision Slit Strips & Foils",
  "Titanium Circular Blanks & Rings",
  "Titanium Plate Supplier in Mumbai",
];

const searchTerms = [
  "Titanium Plate Price Per Kg",
  "Titanium Grade 2 Plate Weight Chart",
  "Titanium Plate Supplier In India",
  "Titanium Grade 5 Chemical Composition",
  "Titanium Grade 7 Plate Price",
  "Ti-6Al-4V Plate Price In Mumbai",
  "Titanium Plate Dimensions",
  "Titanium Plate Specifications Pdf",
  "Titanium Grade 1 vs Grade 2",
  "Titanium Plate Price List",
  "Titanium Plate Weight Calculator",
  "Titanium Plate Mechanical Properties",
  "Titanium Plate Stockist",
  "Titanium Plate Equivalent Grades",
  "Titanium Plate Price Per Kg In India",
  "Titanium Sheet Exporter",
  "Titanium Alloy Plate Supplier",
  "Titanium Plate Sizes",
  "Titanium Plate Thickness Chart",
  "Titanium Grade 2 UNS R50400",
  "Titanium Plate ASTM B265",
  "Titanium Plate Manufacturers In Mumbai",
  "Buy Titanium Plates In India",
];
...
const TitaniumPlatesDetails = () => {
  return (
    <>
      <Helmet>
        <title>Titanium Plates Supplier, Stockist & Exporter</title>
        <meta
          name="description"
          content="Leading supplier of Titanium Plates (Grade 1, 2, 5, 7, 9) in sheets, coils, circles, and custom sizes. ASTM B265 compliant. High strength-to-weight ratio and superior corrosion resistance for aerospace, marine, and chemical applications."
        />
      </Helmet>
      ...
      <div className="product-details-container">
        <div className="product-main-content">
          <section className="product-content">
            <div className="content-header">
              <h1>TITANIUM PLATES SUPPLIER – SHEETS, COILS, CIRCLES & CUSTOM SIZES</h1>
            </div>
            <div className="content-image">
              <img src={titanium} alt="Titanium Plates" className="main-image" />
            </div>
          ...
          <section className="product-content">
            <div className="content-header">
              <h2>TITANIUM PLATES – LIGHTWEIGHT, CORROSION-RESISTANT, AND EXTREMELY STRONG</h2>
              <p>
                Our comprehensive range of <strong>Titanium Plates</strong> covers a wide spectrum of grades, from commercially pure titanium (Grades 1, 2, and 7) to high-strength alpha-beta alloys (Grades 5 and 9). Titanium offers an exceptional combination of properties: a <strong>high strength-to-weight ratio</strong>, outstanding resistance to seawater, chlorides, and oxidizing acids, excellent biocompatibility, and high melting point. This makes titanium the preferred material for the most demanding engineering applications across aerospace, marine, chemical processing, and medical industries.
              </p>
              <hr />
              <h3>HOT ROLLED & COLD ROLLED TITANIUM PLATES</h3>
              <p>
                We supply Titanium plates in <strong>hot rolled (ASTM B265)</strong> and <strong>cold rolled (ASTM B265)</strong> conditions, available from 0.5 mm to 150 mm thickness, and widths up to 2500 mm. Our inventory includes annealed, stress-relieved, and solution-treated plates to meet the stringent demands of structural, pressure vessel, and precision component fabrication.
              </p>
              <h3>APPLICATIONS & ADVANTAGES</h3>
              <p>
                Titanium plates are the material of choice for critical applications in <strong>aerospace</strong> (airframes, landing gear, engine components), <strong>marine engineering</strong> (propellers, shafts, heat exchangers), <strong>chemical processing</strong> (reactors, vessels, piping), <strong>power generation</strong> (condensers), and <strong>medical implants</strong>. The unique combination of low density (4.51 g/cm³) and high strength ensures significant weight savings without compromising structural integrity.
              </p>
              <hr />
              <h3>COMPLIANCE & STANDARDS</h3>
              <p>
                Our Titanium plates are manufactured and tested in accordance with <strong>ASTM / ASME</strong> and <strong>AMS</strong> specifications, including <strong>ASTM B265, ASME SB265, AMS 4900, AMS 4911</strong>. We provide comprehensive mill test certificates, PMI reports, ultrasonic inspection, and third-party inspection services to ensure full traceability and quality assurance.
              </p>
            </div>
          </section>

          <section className="specification-section">
            <h2>UNIFIED SPECIFICATION: TITANIUM PLATES</h2>
            <div className="spec-grid">
              <div className="spec-card">
                <h4>Standard</h4>
                <p>ASTM B265 / ASME SB265 / AMS 4900 / 4911</p>
              </div>
              <div className="spec-card">
          ...
          <section className="stock-section">
            <div className="stock-container">
              <div className="stock-heading">
                <h2>READY STOCK AVAILABILITY – TITANIUM PLATES & SHEETS</h2>
              </div>
          ...
          <section className="chemical-section">
            <div className="container">
              <div className="section-title">
                <h2>CHEMICAL COMPOSITION OF TITANIUM PLATES</h2>
              </div>
              <div className="table-responsive">
          ...
          <section className="mechanical-section">
            <div className="container">
              <div className="section-title">
                <h2>MECHANICAL PROPERTIES OF TITANIUM PLATES</h2>
              </div>
              <div className="table-responsive">
          ...
          <section className="thickness-section">
            <div className="container">
              <div className="section-title">
                <h2>
                  THICKNESS RANGE AVAILABILITY: TITANIUM PLATES
                  <span>(ASTM / ASME B265)</span>
                </h2>
          ...
          <section className="coil-weight-section">
            <div className="container">
              <div className="section-title">
                <h2>UNIFIED WEIGHT CHART: TITANIUM PLATES</h2>
              </div>
              <div className="table-responsive">
          ...
          <section className="finish-weight-section">
            <div className="container">
              <div className="section-title">
                <h2>TITANIUM PLATE SUPPLY RANGE (UNIFIED)</h2>
          ...
          <section className="gauge-chart-section">
            <div className="container">
              <div className="section-title">
                <h2>UNIFIED TITANIUM PLATE PRICE RANGE</h2>
              </div>
              <div className="table-responsive">
          ...
          <section className="specialty-weight-section">
            <div className="container">
              <div className="section-title">
                <h2>SPECIALIZED IN FOLLOWING TITANIUM PLATES</h2>
              </div>
              <div className="table-responsive">
          ...
          <section className="tolerance-section">
            <div className="container">
              <div className="section-title">
                <h2>SEARCHES RELATED TO TITANIUM PLATES</h2>
              </div>
              <div className="table-responsive">
        ...
        <div className="product-sidebar-wrapper">
          ...
          <div className="quote-card">
            <h2>GET A QUOTE</h2>
            <p>Immediate pricing for Titanium Plates & Sheets. Contact our sales team for bulk discounts and technical support.</p>
...
export default TitaniumPlatesDetails;