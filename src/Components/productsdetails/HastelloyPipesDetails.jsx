...
// Replace these image paths with your actual Hastelloy product images
...
import hastelloyRound from "../../products-image/ss-nilo42-pipes.webp";
import hastelloySquare from "../../products-image/ss-alloy-926-pipes.webp";
import hastelloyHollow from "../../products-image/ss-alloy-a286-pipes.webp";

import hastelloySteel from "../../products-image/ss-hastelloy-pipes.webp"; 
...
const stockData = [
  {
    ...
    items: [
      "Hastelloy C276 / C22 Seamless Pipes (ASTM B622)",
      "Hastelloy B2 / B3 Seamless Pipes (ASTM B622)",
      "Hastelloy X Seamless Pipes (ASTM B622)",
      "Cold Drawn & Annealed Seamless Tubes",
    ],
  },
  {
    ...
    items: [
      "Hastelloy C276 / C22 Welded Pipes (ASTM B619 / B775)",
      "Hastelloy B2 / B3 ERW / EFW Pipes",
      "Large Diameter Welded Hastelloy Pipes",
      "Heavy Wall Welded Hastelloy Piping",
    ],
  },
  {
    ...
    image: hastelloyErw,
    items: [
      "Hastelloy C276 / C22 ERW Pipes",
      "Electric Resistance Welded Hastelloy Pipes",
      "Hastelloy ERW Round & Square Pipes",
      "Precision Welded Hastelloy for Chemical Processing",
    ],
  },
  {
    title: "HASTELLOY ROUND PIPES",
    image: hastelloyRound,
    items: [
      "Hastelloy C276 / X Round Pipes",
      "Hastelloy Round Hollow Sections",
      "Hastelloy Round Pipes for Heat Exchangers",
      "Precision Hastelloy Round Pipes",
    ],
  },
  {
    title: "HASTELLOY SQUARE PIPES",
    image: hastelloySquare,
    items: [
      "Hastelloy C22 / B2 Square Pipes",
      "Hastelloy Square Hollow Sections",
      "Hastelloy Square Tubes for Structural Use",
      "Custom Hastelloy Square Pipes",
    ],
  },
  {
    title: "HASTELLOY HOLLOW PIPES",
    image: hastelloyHollow,
    items: [
      "Hastelloy Hollow Pipes",
      "Hastelloy Heavy Wall Hollow Pipes",
      "Hastelloy Hollow Section",
      "Hastelloy Hollow Pipes for Heat Exchangers",
    ],
  }
];
...
const mechanicalData = [
  ...
  {
    grade: "Hastelloy B2",
    tensile: "760 MPa (110 ksi)",
    yield: "350 MPa (51 ksi)",
    elongation: "40%",
    density: "9.22 g/cm³",
  },
  {
...
const leftItems = [
  "Hastelloy C276 / C22 Seamless & Welded Pipes",
  "Hastelloy B2 / B3 Annealed & Cold Drawn Pipes",
  "Hastelloy X ERW & EFW Pipes",
  "Hastelloy Round, Square & Rectangular Pipes",
  "Hastelloy Heavy Wall & Hollow Pipes",
  "Hastelloy Pipes for Chemical Processing & Pollution Control",
  "Hastelloy Pipe Manufacturer in India",
];
...
const rightItems = [
  ...
  "Hastelloy Pipe Supplier in Mumbai",
];

const searchTerms = [
  "Hastelloy Pipe Price Per Kg",
  ...
  "Hastelloy C276 Pipe Price In Mumbai",
  ...
  "Hastelloy Pipe Mechanical Properties",
  "Hastelloy Pipe Stockist",
  "Hastelloy Pipe Equivalent Grades",
  "Hastelloy C276 Pipe Price Per Kg In India",
  "Hastelloy Seamless Pipe Exporter",
  "Hastelloy C22 Welded Pipe Supplier",
  "Hastelloy Pipe Sizes",
  "Hastelloy Pipe Schedule",
  "Hastelloy C276 Pipe UNS N10276",
  "Hastelloy Pipe 2.4819",
...
const HastelloyPipesDetails = () => {
  return (
    <>
      <Helmet>
        <title>Hastelloy Pipes Supplier, Stockist & Exporter</title>
        <meta
          name="description"
          content="Leading supplier of Hastelloy pipes including C276, C22, B2, B3, and X grades. Available in seamless, welded, ERW, and custom sizes. Exceptional corrosion resistance for chemical processing."
        />
      </Helmet>
      ...
      <div className="product-details-container">
        <div className="product-main-content">
          <section className="product-content">
            <div className="content-header">
              <h1>HASTELLOY PIPES SUPPLIER – C276, C22, B2, B3 & X GRADES</h1>
            </div>
            <div className="content-image">
              <img src={hastelloySteel} alt="Hastelloy Pipes" className="main-image" />
            </div>
          ...
          <section className="product-content">
            <div className="content-header">
              <h2>PREMIUM HASTELLOY PIPES – ENGINEERED FOR EXTREME CORROSION RESISTANCE</h2>
              <p>
                Our comprehensive range of <strong>Hastelloy Pipes</strong> covers the most sought-after nickel-based superalloys, including <strong>C276, C22, B2, B3, and X</strong>. These alloys are renowned for their exceptional resistance to a wide spectrum of corrosive environments, from highly oxidizing acids to strong reducing agents. Whether your application demands resistance to pitting, crevice corrosion, stress-corrosion cracking, or high-temperature oxidation, our Hastelloy pipes deliver reliable and long-lasting performance.
              </p>
              <hr />
              <h3>SEAMLESS & WELDED HASTELLOY PIPES</h3>
              <p>
                We supply Hastelloy pipes in <strong>seamless (ASTM B622)</strong> and <strong>welded (ASTM B619 / B775)</strong> forms, available from ½" NB to 24" NB and schedules SCH 5 to SCH XXS. Our inventory includes solution-annealed, cold-drawn, and precision tubes for critical service conditions in chemical reactors, heat exchangers, and high-temperature furnaces.
              </p>
              <h3>APPLICATIONS & ADVANTAGES</h3>
              <p>
                Hastelloy alloys are the material of choice for the <strong>chemical processing</strong> industry (reactors, distillation columns, heat exchangers), <strong>pollution control</strong> (scrubbers), <strong>pharmaceuticals</strong>, <strong>food processing</strong>, and <strong>petrochemical</strong> plants. Their outstanding resistance to both localized and uniform corrosion ensures long service life even in the most aggressive environments, including wet chlorine, hydrochloric acid, sulfuric acid, and mixed acids.
              </p>
              <hr />
              <h3>COMPLIANCE & STANDARDS</h3>
              <p>
                Our Hastelloy pipes are manufactured and tested in accordance with <strong>ASTM / ASME</strong> specifications, including <strong>ASTM B622, B619, B775, B366, B564</strong>. We provide comprehensive mill test certificates, PMI reports, and third-party inspection services to ensure full traceability and quality assurance.
              </p>
            </div>
          </section>

          <section className="specification-section">
            <h2>UNIFIED SPECIFICATION: HASTELLOY PIPES</h2>
        ...
        <div className="product-sidebar-wrapper">
          ...
          <div className="quote-card">
            <h2>GET A QUOTE</h2>
            <p>Immediate pricing for all Hastelloy grades. Contact our sales team for bulk discounts and technical support.</p>
...
export default HastelloyPipesDetails;
