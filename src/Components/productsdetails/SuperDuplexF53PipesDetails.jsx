...
// Replace these image paths with your actual Super Duplex S32750 product images
import superDuplexSeamless from "../../products-image/ss-nimonic-pipes.webp";
import superDuplexWelded from "../../products-image/ss-nitronic-pipes.webp";
import superDuplexErw from "../../products-image/ss-nichrome-pipes.webp";
import superDuplexRound from "../../products-image/ss-nilo42-pipes.webp";
import superDuplexSquare from "../../products-image/ss-alloy-926-pipes.webp";
import superDuplexHollow from "../../products-image/ss-alloy-a286-pipes.webp";

import superduplexf53 from "../../products-image/ss-super-duplex-32750-pipes.webp"; 
import "./Productsdetails.css";

const stockData = [
  {
    title: "SUPER DUPLEX S32750 SEAMLESS PIPES",
    image: superDuplexSeamless,
    items: [
      "Super Duplex S32750 Seamless Pipes (ASTM A789)",
      "UNS S32750 / 1.4410 Seamless Piping",
      "Cold Drawn & Annealed S32750 Seamless Tubes",
      "High Strength Seamless Pipes for Offshore Service",
    ],
  },
  {
    title: "SUPER DUPLEX S32750 WELDED PIPES",
    image: superDuplexWelded,
    items: [
      "Super Duplex S32750 Welded Pipes (ASTM A790 / A928)",
      "UNS S32750 ERW / EFW Pipes",
      "Large Diameter Welded S32750 Pipes",
      "Heavy Wall Welded Super Duplex Piping Systems",
    ],
  },
  {
    title: "SUPER DUPLEX S32750 ERW PIPES",
    image: superDuplexErw,
    items: [
      "Super Duplex S32750 ERW Pipes",
      "Electric Resistance Welded S32750 Pipes",
      "Super Duplex ERW Round & Square Pipes",
      "Precision Welded S32750 for Seawater Cooling",
    ],
  },
  {
    title: "SUPER DUPLEX S32750 ROUND PIPES",
    image: superDuplexRound,
    items: [
      "Super Duplex S32750 Round Pipes",
      "Super Duplex S32750 Round Hollow Sections",
      "Super Duplex Round Pipes for Heat Exchangers",
      "Precision Super Duplex S32750 Round Pipes",
    ],
  },
  {
    title: "SUPER DUPLEX S32750 SQUARE PIPES",
    image: superDuplexSquare,
    items: [
      "Super Duplex S32750 Square Pipes",
      "Super Duplex S32750 Square Hollow Sections",
      "Super Duplex S32750 Square Tubes for Structural Use",
      "Custom Super Duplex S32750 Square Pipes",
    ],
  },
  {
    title: "SUPER DUPLEX S32750 HOLLOW PIPES",
    image: superDuplexHollow,
    items: [
      "Super Duplex S32750 Hollow Pipes",
      "Super Duplex S32750 Heavy Wall Hollow Pipes",
      "Super Duplex S32750 Hollow Section",
      "Super Duplex S32750 Hollow Pipes for Heat Exchangers",
    ],
  }
];
...
const leftItems = [
  "Super Duplex S32750 / F53 Seamless & Welded Pipes",
  "Super Duplex S32750 Annealed & Cold Drawn Pipes",
  "Super Duplex S32750 ERW & EFW Pipes (ASTM A790)",
  "Super Duplex S32750 Round, Square & Rectangular Pipes",
  "Super Duplex S32750 Heavy Wall & Hollow Pipes",
  "Super Duplex S32750 Pipes for Offshore & Subsea Applications",
  "Super Duplex Steel UNS S32750 Pipe Manufacturer in India",
];

const rightItems = [
  "ASTM A790 / A789 / A928 / A182 F53",
  ...
  "Super Duplex S32750 Hollow Section & Square Pipes",
  "Super Duplex S32750 / F53 Pipe Supplier in Mumbai",
];

const searchTerms = [
  "Super Duplex S32750 Pipe Price Per Kg",
  "Super Duplex S32750 Seamless Pipe Weight Chart",
  "Super Duplex Pipe Supplier In India",
  "Super Duplex S32750 Chemical Composition",
  "Super Duplex F53 Pipe Pressure Rating",
  "Super Duplex S32750 Pipe Price In Mumbai",
  "Super Duplex S32750 Pipe Dimensions",
  "Super Duplex S32750 Pipe Specifications Pdf",
  "Super Duplex Steel UNS S32750 Corrosion Resistance",
  "Super Duplex S32750 Pipe Price List",
  "Super Duplex Pipe Weight Calculator",
  "Super Duplex S32750 Pipe Mechanical Properties",
  "Super Duplex S32750 Pipe Stockist",
  "Super Duplex S32750 Pipe Equivalent Grades",
  "Super Duplex S32750 Pipe Price Per Kg In India",
  "Super Duplex S32750 Seamless Pipe Exporter",
  "Super Duplex S32750 Welded Pipe Supplier",
  "Super Duplex S32750 Pipe Sizes",
  "Super Duplex S32750 Pipe Schedule",
  "Super Duplex S32750 Pipe UNS S32750",
  "Super Duplex S32750 Pipe 1.4410",
  "Super Duplex Pipe Manufacturers In Mumbai",
  "Buy Super Duplex Steel S32750 Pipes In India",
];
...
const SuperDuplexF53PipesDetails = () => {
  return (
    <>
      <Helmet>
        <title>Super Duplex Steel S32750 / F53 Pipes Supplier, Stockist & Exporter</title>
        <meta
          name="description"
          content="Leading supplier of Super Duplex Steel UNS S32750 (F53) pipes in seamless, welded, ERW, and custom sizes. High strength and excellent corrosion resistance for offshore, marine, and chemical applications."
        />
      </Helmet>
      ...
      <Banner
        title="SUPER DUPLEX STEEL S32750 / F53 PIPES"
        image={ProductBanner}
      />
      ...
      <div className="product-details-container">
        <div className="product-main-content">
          <section className="product-content">
            <div className="content-header">
              <h1>SUPER DUPLEX STEEL S32750 / F53 PIPES SUPPLIER – SEAMLESS, WELDED, ERW & CUSTOM</h1>
            </div>
            <div className="content-image">
              <img src={superduplexf53} alt="Super Duplex Steel S32750 Pipes" className="main-image" />
            </div>
          ...
          <section className="product-content">
            <div className="content-header">
              <h2>SUPER DUPLEX STEEL S32750 / F53 PIPES – UNMATCHED STRENGTH & PITTING RESISTANCE</h2>
              <p>
                <strong>Super Duplex Steel UNS S32750</strong>, commonly known as <strong>F53</strong> (Werkstoff 1.4410), is a high-performance super duplex stainless steel alloy with a Pitting Resistance Equivalent (PRE) of at least <strong>40</strong>. It offers an exceptional combination of high mechanical strength—nearly double that of standard austenitic steels—and outstanding resistance to chloride stress corrosion cracking, pitting, and crevice corrosion. This makes it the definitive choice for the most severe offshore, marine, and chemical processing environments.
              </p>
              <hr />
              <h3>SEAMLESS & WELDED SUPER DUPLEX S32750 PIPES</h3>
              <p>
                We supply Super Duplex S32750 pipes in <strong>seamless (ASTM A789)</strong> and <strong>welded (ASTM A790 / A928)</strong> forms, available from ½" NB to 24" NB and schedules SCH 5 to SCH XXS. Our inventory includes solution-annealed, cold-drawn, and precision tubes to meet the stringent demands of deep-sea subsea pipelines and high-pressure heat exchangers.
              </p>
              <h3>APPLICATIONS & ADVANTAGES</h3>
              <p>
                This super duplex grade is the material of choice for <strong>offshore oil & gas</strong> (subsea pipelines, risers, manifolds), <strong>desalination plants</strong>, <strong>marine engineering</strong>, <strong>chemical processing</strong> (aggressive chloride environments), and <strong>pollution control</strong> (scrubbers). Its high yield strength (550 MPa) allows for reduced wall thicknesses, offering significant weight savings without compromising performance or safety.
              </p>
              <hr />
              <h3>COMPLIANCE & STANDARDS</h3>
              <p>
                Our Super Duplex S32750 pipes are manufactured and tested in accordance with <strong>ASTM / ASME</strong> specifications, including <strong>ASTM A790, A789, A928</strong> and <strong>ASME SA790, SA789, SA928</strong>. We provide comprehensive mill test certificates, PMI reports, and third-party inspection services to ensure full traceability and quality assurance.
              </p>
            </div>
          </section>

          <section className="specification-section">
            <h2>UNIFIED SPECIFICATION: SUPER DUPLEX S32750 / F53 PIPES</h2>
            <div className="spec-grid">
              <div className="spec-card">
                <h4>Standard</h4>
                <p>ASTM / ASME A790, A789, A928, A182 F53</p>
              </div>
              <div className="spec-card">
                <h4>Size Range</h4>
          ...
          <section className="stock-section">
            <div className="stock-container">
              <div className="stock-heading">
                <h2>READY STOCK AVAILABILITY – SUPER DUPLEX S32750 PIPES</h2>
              </div>
          ...
          <section className="grades-section">
            <div className="container">
              <div className="section-title">
                <h2>EQUIVALENT GRADES: SUPER DUPLEX S32750 / F53</h2>
              </div>
          ...
          <section className="chemical-section">
            <div className="container">
              <div className="section-title">
                <h2>CHEMICAL COMPOSITION OF SUPER DUPLEX S32750 PIPES</h2>
              </div>
              <div className="table-responsive">
          ...
          <section className="mechanical-section">
            <div className="container">
              <div className="section-title">
                <h2>MECHANICAL PROPERTIES OF SUPER DUPLEX S32750 PIPING</h2>
              </div>
              <div className="table-responsive">
          ...
          <section className="thickness-section">
            <div className="container">
              <div className="section-title">
                <h2>
                  SIZE RANGE AVAILABILITY: SUPER DUPLEX S32750 PIPES
          ...
          <section className="coil-weight-section">
            <div className="container">
              <div className="section-title">
                <h2>UNIFIED WEIGHT CHART: SUPER DUPLEX S32750 PIPES</h2>
              </div>
              <div className="table-responsive">
          ...
          <section className="finish-weight-section">
            <div className="container">
              <div className="section-title">
                <h2>SUPER DUPLEX S32750 PIPE SUPPLY RANGE (UNIFIED)</h2>
          ...
          <section className="gauge-chart-section">
            <div className="container">
              <div className="section-title">
                <h2>UNIFIED SUPER DUPLEX S32750 PIPE PRICE RANGE</h2>
              </div>
              <div className="table-responsive">
          ...
          <section className="specialty-weight-section">
            <div className="container">
              <div className="section-title">
                <h2>SPECIALIZED IN FOLLOWING SUPER DUPLEX S32750 PIPES</h2>
              </div>
              <div className="table-responsive">
          ...
          <section className="tolerance-section">
            <div className="container">
              <div className="section-title">
                <h2>SEARCHES RELATED TO SUPER DUPLEX S32750 PIPES</h2>
              </div>
              <div className="table-responsive">
        ...
        <div className="product-sidebar-wrapper">
          ...
          <div className="quote-card">
            <h2>GET A QUOTE</h2>
            <p>Immediate pricing for Super Duplex S32750 / F53 pipes. Contact our sales team for bulk discounts and technical support.</p>
...
export default SuperDuplexF53PipesDetails;
