...
const stockData = [
  {
    ...
    items: [
      ...
      "ASTM B165 N04400 Seamless",
      "UNS N04400 / EN 2.4360",
      "High Pressure Monel 400 Pipes",
    ],
  },
  {
    ...
    items: [
      ...
      "ASTM B725 N04400 Welded",
      "Longitudinal / Spiral Welded",
      "Industrial Welded Pipes",
    ],
  },
  {
    title: "MONEL 400 ERW PIPES",
    image: monelErw,
    items: [
      "Monel 400 ERW Pipes",
      "Electric Resistance Welded",
      "ASTM B730 ERW",
      "Custom Size ERW Pipes",
    ],
  },
  {
    title: "MONEL 400 EFW PIPES",
    image: monelEfw,
    items: [
      "Monel 400 EFW Pipes",
      "Electric Fusion Welded",
      "ASTM B725 EFW",
      "Heavy Wall EFW Pipes",
    ],
  },
  {
    title: "MONEL 400 UBO PIPES",
    image: monelUbo,
    items: [
      "Monel 400 UBO Pipes",
  ...
  {
    title: "MONEL 400 SPECIALTY PIPES",
    image: monelSpecial,
    items: [
...
const leftItems = [
  ...
  "Monel 400 ERW & EFW Pipes",
  "ASTM B165 / B163 / B725 Compliant",
  "Excellent Corrosion Resistance in Seawater",
  "High Strength at Elevated & Cryogenic Temperatures",
  "Monel 400 for Offshore & Marine Applications",
  "Monel 400 Pipes Manufacturer in India",
];

const rightItems = [
  "ASTM B165 / B163 / B725 / B730 Monel 400 Pipes",
  ...
  "Monel 400 Hollow Section & Square Pipes",
...
const searchTerms = [
  ...
  "Monel 400 Pipe Specifications Pdf",
  "Monel 400 Corrosion Resistance",
  "Monel 400 Pipe Price List",
  "Monel 400 Pipe Weight Calculator",
  "Monel 400 Pipe Mechanical Properties",
  "Monel 400 Pipe Stockist",
  "Monel 400 Pipe Heat Treatment",
  "Monel 400 Pipe Price Per Kg In India",
  "Monel 400 Seamless Pipe Exporter",
  "Monel 400 Welded Pipe Supplier",
  "Monel 400 Pipe Schedule",
  "Monel 400 Equivalent Grades",
  "Monel 400 UNS N04400",
  "Monel 400 2.4360",
  "Monel 400 Pipe Manufacturers In Mumbai",
  "Buy Monel 400 Pipes In India",
];
...
const Monel400PipesDetails = () => {
  return (
    <>
        <Helmet>
            <title>Monel 400 Pipes Supplier – UNS N04400 Nickel-Copper Alloy Pipes</title>
            <meta
            name="description"
            content="Supplier of Monel 400 pipes (UNS N04400, 2.4360) with exceptional resistance to seawater, acids, and alkalis. Seamless, welded, ERW, EFW pipes available."
            />
        </Helmet>
      ...
      <div className="product-details-container">
        ...
        <section className="product-content">
            <div className="content-header">
                <h1>MONEL 400 PIPES SUPPLIER – NICKEL-COPPER ALLOY PIPES</h1>
            </div>
            <div className="content-image">
                <img src={monel400} alt="Monel 400 Pipes" className="main-image" />
            </div>
        ...
        <section className="product-content">
            <div className="content-header">
                <h2>MONEL 400 PIPES: NICKEL-COPPER ALLOY FOR EXTREME CORROSION SERVICE</h2>
                <p>Monel 400 (UNS N04400) is a nickel-copper alloy renowned for its exceptional resistance to seawater, hydrofluoric acid, sulfuric acid, and alkalis. With a high nickel content (63% minimum), it offers excellent strength and toughness over a wide temperature range, from cryogenic to elevated temperatures, making it a preferred choice for marine, chemical processing, and offshore applications.</p>
                <hr/>
                <h3>KEY FEATURES OF MONEL 400 PIPES</h3>
                <p><strong>Outstanding Corrosion Resistance</strong> – Highly resistant to seawater, steam, and acidic environments, including hydrofluoric and sulfuric acids.</p>
                <p><strong>High Strength & Toughness</strong> – Maintains mechanical properties from sub-zero temperatures up to 500°C.</p>
                <p><strong>Excellent Weldability</strong> – Can be welded using standard techniques without risk of sensitization.</p>
                <hr/>
                <h3>SPECIFICATIONS & STANDARDS</h3>
                <p>Our Monel 400 pipes conform to international standards including <strong>ASTM B165</strong> (seamless), <strong>ASTM B725</strong> (welded), <strong>ASTM B163</strong> (seamless tubes), and <strong>ASME SB165 / SB725</strong>. Available in seamless, welded, ERW, and EFW forms with custom schedules and lengths.</p>
            </div>
        </section>
    ...
    <h2>Specification: Monel 400 Pipes</h2>
    ...
    <section className="stock-section">
      <div className="stock-container">
        ...
        <div className="stock-heading">
          <h2>READY STOCK AVAILABILITY – MONEL 400 PIPES</h2>
        </div>
    ...
    <section className="chemical-section">
      <div className="container">
        ...
        <div className="section-title">
          <h2>CHEMICAL COMPOSITION OF MONEL 400 PIPES</h2>
        </div>
    ...
    <section className="mechanical-section">
      <div className="container">
        ...
        <div className="section-title">
          <h2>MECHANICAL PROPERTIES OF MONEL 400 PIPING</h2>
        </div>
    ...
    <section className="thickness-section">
      <div className="container">
        ...
        <div className="section-title">
          <h2>
            SIZE RANGE AVAILABILITY: MONEL 400 PIPES
    ...
    <section className="coil-weight-section">
      <div className="container">
        ...
        <div className="section-title">
          <h2>UNIFIED WEIGHT CHART: MONEL 400 PIPES</h2>
        </div>
    ...
    <section className="finish-weight-section">
      <div className="container">
        ...
        <div className="section-title">
          <h2>MONEL 400 PIPE SUPPLY RANGE (UNIFIED)</h2>
    ...
    <section className="gauge-chart-section">
      <div className="container">
        ...
        <div className="section-title">
          <h2>UNIFIED MONEL 400 PIPE PRICE RANGE</h2>
        </div>
    ...
    <section className="specialty-weight-section">
      <div className="container">
        ...
        <div className="section-title">
          <h2>SPECIALIZED IN FOLLOWING MONEL 400 PIPES</h2>
        </div>
    ...
    <section className="tolerance-section">
      <div className="container">
        ...
        <div className="section-title">
          <h2>SEARCHES RELATED TO MONEL 400 PIPES</h2>
        </div>
...
export default Monel400PipesDetails;