...
import duplexEfw from "../../products-image/ss-nilo42-pipes.webp";
import duplexUbo from "../../products-image/ss-alloy-926-pipes.webp";
import duplexSpecial from "../../products-image/ss-alloy-a286-pipes.webp";

import duplexSteel from "../../products-image/ss-duplex-super-duplex-pipes.webp";
...
const stockData = [
  {
    ...
    items: [
      "Duplex S31803 (F51) Seamless Pipes",
      "Duplex S32205 (F60) Seamless Pipes",
      "ASTM A790 / ASME SA790",
      "High Strength & Corrosion Resistant",
    ],
  },
  {
    title: "DUPLEX S31803 / S32205 WELDED PIPES",
    image: duplexWelded,
    items: [
      "Duplex Welded Pipes – Both Grades",
  ...
  {
    title: "DUPLEX S31803 / S32205 ERW PIPES",
    image: duplexErw,
    items: [
      "Duplex ERW Pipes",
  ...
  {
    title: "DUPLEX S31803 / S32205 EFW PIPES",
    image: duplexEfw,
    items: [
      "Duplex EFW Pipes",
  ...
  {
    title: "DUPLEX S31803 / S32205 UBO PIPES",
    image: duplexUbo,
    items: [
      "Duplex UBO Pipes",
  ...
  {
    title: "DUPLEX S31803 / S32205 SPECIALTY PIPES",
    image: duplexSpecial,
    items: [
      "Duplex Stainless Steel – F51 & F60",
      "PREN ≥ 35 – Superior Chloride Resistance",
...
const leftItems = [
  "Duplex S31803 (F51) & S32205 (F60) Pipes",
  "Seamless & Welded, ERW & EFW",
  "ASTM A790 / A928 / A789 Compliant",
  "PREN ≥ 35 – Superior Pitting Resistance",
  "High Strength (Yield 450 MPa) & Good Toughness",
  "Excellent Resistance to Chloride Stress Corrosion Cracking",
  "Duplex Steel Pipes Manufacturer in India",
];

const rightItems = [
  "ASTM A790 / A928 / A789 Duplex Steel Pipes",
  ...
  "Duplex Hollow Section & Square Pipes",
  "Duplex Steel Pipe Supplier in Mumbai",
];

const searchTerms = [
  "Duplex S31803 Pipe Price Per Kg",
  "Duplex S32205 Pipe Price Per Kg",
  "F51 Duplex Pipe Weight Chart",
  "S31803 Pipe Supplier In India",
  "Duplex S32205 Chemical Composition",
  "S32205 Pipe Pressure Rating",
  "S31803 Pipe Price In Mumbai",
  "Duplex Steel Pipe Dimensions",
  "Duplex S31803 vs S32205 Difference",
  "1.4462 Pipe Specifications",
  "S32205 Pipe Weight Calculator",
  "Duplex Steel Mechanical Properties",
  "S31803 Pipe Stockist",
  "Duplex S32205 Heat Treatment",
  "Duplex Steel Pipe Price List",
  "Duplex Stainless Steel Pipe Exporter",
  "F60 Welded Pipe Supplier",
  "S31803 Pipe Schedule",
  "Duplex Steel Equivalent Grades",
  "UNS S31803 / S32205",
  "Duplex Steel Pipe Manufacturers In Mumbai",
  "Buy Duplex Steel Pipes In India",
];
...
const DuplexSteelPipesDetails = () => {
  return (
    <>
        <Helmet>
            <title>Duplex Steel Pipes Supplier – S31803 (F51) & S32205 (F60) Duplex Stainless Steel Pipes</title>
            <meta
            name="description"
            content="Supplier of Duplex Steel S31803 (F51) & S32205 (F60) pipes with superior strength, pitting resistance (PREN ≥ 35), and chloride stress corrosion cracking resistance. Seamless, welded, ERW, EFW pipes available."
            />
        </Helmet>
        ...
        <Banner
            title="DUPLEX STEEL PIPES (S31803 / S32205)"
            image={ProductBanner}
        />
      ...
      <div className="product-details-container">
        ...
        <section className="product-content">
            <div className="content-header">
                <h1>DUPLEX STEEL PIPES SUPPLIER – UNS S31803 (F51) & UNS S32205 (F60) DUPLEX STAINLESS STEEL PIPES</h1>
            </div>
            <div className="content-image">
                <img src={duplexSteel} alt="Duplex Steel Pipes" className="main-image" />
            </div>
        ...
        <section className="product-content">
            <div className="content-header">
                <h2>DUPLEX STEEL PIPES: HIGH STRENGTH AND EXCELLENT CORROSION RESISTANCE</h2>
                <p>Duplex stainless steels are a family of alloys with a dual-phase microstructure of austenite and ferrite, offering a unique combination of high mechanical strength and outstanding resistance to corrosion, especially chloride-induced stress corrosion cracking (SCC). The two most common grades are <strong>UNS S31803 (F51)</strong> and <strong>UNS S32205 (F60)</strong>, both with a Pitting Resistance Equivalent Number (PREN) ≥ 35, making them ideal for aggressive environments in offshore, marine, chemical processing, and oil & gas industries.</p>
                <hr/>
                <h3>KEY FEATURES OF DUPLEX STEEL PIPES</h3>
                <p><strong>High Strength</strong> – Yield strength approximately twice that of conventional austenitic stainless steels (e.g., 316L), enabling reduced wall thickness and weight savings.</p>
                ...
                <p><strong>Good Weldability</strong> – Can be welded with standard techniques, though care must be taken to maintain the proper ferrite-austenite balance.</p>
                <hr/>
                <h3>DUPLEX S31803 (F51) vs. S32205 (F60)</h3>
                <p><strong>S31803</strong> is the original duplex grade with a minimum PREN of 35. It offers good resistance to localized corrosion and is widely used in many applications.</p>
                <p><strong>S32205</strong> is an enhanced version with a slightly higher chromium, molybdenum, and nitrogen content, providing a PREN ≥ 36 and improved pitting resistance. It is often preferred for more severe service conditions.</p>
                <hr/>
                <h3>SPECIFICATIONS & STANDARDS</h3>
                <p>Our duplex steel pipes conform to international standards including <strong>ASTM A790</strong> (seamless and welded), <strong>ASTM A928</strong> (welded), <strong>ASTM A789</strong> (seamless and welded tube), and <strong>ASME SA790 / SA928 / SA789</strong>. Available in seamless, welded, ERW, and EFW forms with custom schedules and lengths.</p>
            </div>
        </section>
    ...
    <h2>Specification: Duplex Steel Pipes (S31803 / S32205)</h2>
    ...
    <section className="stock-section">
      <div className="stock-container">
        ...
        <div className="stock-heading">
          <h2>READY STOCK AVAILABILITY – DUPLEX STEEL PIPES</h2>
        </div>
    ...
    <section className="grades-section">
      <div className="container">
        ...
        <div className="section-title">
          <h2>EQUIVALENT GRADES: DUPLEX STEEL</h2>
        </div>
    ...
    <section className="chemical-section">
      <div className="container">
        ...
        <div className="section-title">
          <h2>CHEMICAL COMPOSITION OF DUPLEX STEEL PIPES</h2>
        </div>
    ...
    <section className="mechanical-section">
      <div className="container">
        ...
        <div className="section-title">
          <h2>MECHANICAL PROPERTIES OF DUPLEX STEEL PIPING</h2>
        </div>
    ...
    <section className="thickness-section">
      <div className="container">
        ...
        <div className="section-title">
          <h2>
            SIZE RANGE AVAILABILITY: DUPLEX STEEL PIPES
    ...
    <section className="coil-weight-section">
      <div className="container">
        ...
        <div className="section-title">
          <h2>UNIFIED WEIGHT CHART: DUPLEX STEEL PIPES</h2>
        </div>
    ...
    <section className="finish-weight-section">
      <div className="container">
        ...
        <div className="section-title">
          <h2>DUPLEX STEEL PIPE SUPPLY RANGE (UNIFIED)</h2>
    ...
    <section className="gauge-chart-section">
      <div className="container">
        ...
        <div className="section-title">
          <h2>UNIFIED DUPLEX STEEL PIPE PRICE RANGE</h2>
        </div>
    ...
    <section className="specialty-weight-section">
      <div className="container">
        ...
        <div className="section-title">
          <h2>SPECIALIZED IN FOLLOWING DUPLEX STEEL PIPES</h2>
        </div>
    ...
    <section className="tolerance-section">
      <div className="container">
        ...
        <div className="section-title">
          <h2>SEARCHES RELATED TO DUPLEX STEEL PIPES</h2>
        </div>
...
export default DuplexSteelPipesDetails;