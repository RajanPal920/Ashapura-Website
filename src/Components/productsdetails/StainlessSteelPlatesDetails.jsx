...
import ssPlateHR from "../../products-image/ss-hr-plates.webp";
import ssPlateCR from "../../products-image/ss-cr-plates.webp";

import ssPlateSpecial from "../../products-image/ss-custom-plates.webp";

import ssPlate from "../../products-image/stainless-steel-304-plates.webp";
import "./Productsdetails.css";


const stockData = [
  {
    title: "HOT ROLLED SS PLATES",
    image: ssPlateHR,
    items: [
      "Hot Rolled Stainless Steel Plates",
      "ASTM A240 / ASME SA240",
      "Grade 304 / 304L / 316 / 316L",
      "No.1 Finish – Industrial Applications",
    ],
  },
  {
    title: "COLD ROLLED SS PLATES",
    image: ssPlateCR,
    items: [
  ...
  {
    title: "SS SPECIALTY & FINISHED PLATES",
    image: ssPlateSpecial,
    items: [
      "Polished & Custom Finish Plates",
      "2B, No.4, BA, HL, Mirror Finish",
      "Cut-to-Length & Custom Sizes",
...
const leftItems = [
  "Hot Rolled & Cold Rolled Stainless Steel Plates",
  "ASTM A240 / ASME SA240 Compliant",
  "Grades: 304, 304L, 316, 316L, 310S, 904L, Duplex",
  "No.1, 2B, BA, No.4, HL, Mirror Finishes",
  "Precision Cut-to-Length & Custom Sizes",
  "SS Plates Manufacturer in India",
];

const rightItems = [
  "ASTM A240 / SA240 SS Plates",
  "Standard Sizes: 1000x2000, 1250x2500, 1500x3000, 2000x4000",
  "Thickness Range: 0.4 mm to 100 mm",
  "Annealed, Pickled, Polished, and Edge Conditioned",
  "Mill Edge & Slit Edge Supply",
  "SS Plates Supplier in Mumbai",
];

const searchTerms = [
  "Stainless Steel Plate Price Per Kg",
  "SS 304 Plate Weight Chart",
  "SS 316 Plate Supplier In India",
  "Stainless Steel Plate Chemical Composition",
  "SS 310S Plate Price In Mumbai",
  "SS Plate Dimensions",
  "Stainless Steel Plate Specifications Pdf",
  "SS 904L Plate Price List",
  "SS Plate Weight Calculator",
  "Stainless Steel Plate Mechanical Properties",
  "SS Plate Stockist",
  "SS 316L Plate Heat Treatment",
  "SS Plate Price Per Kg In India",
  "Cold Rolled SS Plate Exporter",
  "Hot Rolled SS Plate Supplier",
  "SS Plate Manufacturers In Mumbai",
  "Buy Stainless Steel Plates In India",
];
...
const StainlessSteelPlatesDetails = () => {
  return (
    <>
        <Helmet>
            <title>Stainless Steel Plates Supplier – SS Plates Stockist (304, 316, 310S, 904L, Duplex)</title>
            <meta
            name="description"
            content="Supplier of Stainless Steel Plates in grades 304/304L, 316/316L, 310S, 904L, Duplex, and Super Duplex. Available in Hot Rolled, Cold Rolled, and polished finishes. Sizes and custom cut-to-length available."
            />
        </Helmet>
      ...
      <div className="product-details-container">
        ...
        <section className="product-content">
            <div className="content-header">
                <h1>STAINLESS STEEL PLATES SUPPLIER – SS PLATES STOCKIST</h1>
            </div>
            <div className="content-image">
                <img src={ssPlate} alt="Stainless Steel Plates" className="main-image" />
            </div>
        ...
        <section className="product-content">
            <div className="content-header">
                <h2>STAINLESS STEEL PLATES: VERSATILE SOLUTIONS FOR INDUSTRIAL FABRICATION</h2>
                <p>Stainless steel plates are flat-rolled products available in a wide range of grades, thicknesses, and finishes to meet the diverse needs of industrial fabrication. From the most commonly used <strong>304/304L and 316/316L</strong> grades, to high-temperature <strong>310S</strong>, corrosion-resistant <strong>904L</strong>, and high-strength <strong>Duplex / Super Duplex</strong> grades, our inventory covers all major specifications. Whether you need hot-rolled plates for structural applications or cold-rolled polished plates for architectural and food-grade equipment, we provide precision-cut solutions tailored to your requirements.</p>
                <hr/>
                <h3>KEY FEATURES OF STAINLESS STEEL PLATES</h3>
                ...
                <p><strong>Versatile Finishes</strong> – No.1 (Hot Rolled), 2B (Cold Rolled), BA (Bright Annealed), No.4 (Brushed), HL (Hairline), and Mirror finishes.</p>
                <p><strong>Customizable Dimensions</strong> – Cut-to-length services, standard sizes up to 2000x4000 mm, and thicknesses ranging from 0.4 mm to 100 mm.</p>
                <hr/>
                <h3>SPECIFICATIONS & STANDARDS</h3>
                <p>Our stainless steel plates conform to international standards including <strong>ASTM A240 / ASME SA240</strong> (standard specification for chromium and chromium-nickel stainless steel plate, sheet, and strip). We also supply to <strong>ASTM A480</strong> (general requirements for flat-rolled stainless steel). All plates are supplied with mill test certificates and can be custom-processed to meet your specific fabrication needs.</p>
            </div>
        </section>
    ...
    <h2>Specification: Stainless Steel Plates</h2>

    <div className="spec-grid">

        <div className="spec-card">
            <h4>Standard</h4>
            <p>ASTM A240 / ASME SA240, ASTM A480</p>
        </div>
        ...
        <div className="spec-card">
            <h4>Finish / Form</h4>
            <p>Hot Rolled (No.1), Cold Rolled (2B, BA, No.4, HL, Mirror), Polished</p>
        </div>
    ...
    <section className="stock-section">
      <div className="stock-container">
        ...
        <div className="stock-heading">
          <h2>READY STOCK AVAILABILITY – STAINLESS STEEL PLATES</h2>
        </div>
    ...
    <section className="grades-section">
      <div className="container">
        ...
        <div className="section-title">
          <h2>EQUIVALENT GRADES: STAINLESS STEEL PLATES</h2>
        </div>
    ...
    <section className="chemical-section">
      <div className="container">
        ...
        <div className="section-title">
          <h2>CHEMICAL COMPOSITION OF SS PLATES</h2>
        </div>
    ...
    <section className="mechanical-section">
      <div className="container">
        ...
        <div className="section-title">
          <h2>MECHANICAL PROPERTIES OF SS PLATES</h2>
        </div>
    ...
    <section className="thickness-section">
      <div className="container">
        ...
        <div className="section-title">
          <h2>
            SIZE RANGE AVAILABILITY: SS PLATES
            <span>(ASTM A240 / SA240)</span>
          </h2>

          <p>
            Available in Hot Rolled & Cold Rolled conditions across all grades
          </p>
        </div>
    ...
    <section className="coil-weight-section">
      <div className="container">
        ...
        <div className="section-title">
          <h2>UNIFIED WEIGHT CHART: SS PLATES</h2>
        </div>
    ...
    <section className="finish-weight-section">
      <div className="container">
        ...
        <div className="section-title">
          <h2>SS PLATE SUPPLY RANGE (UNIFIED)</h2>
    ...
    <section className="gauge-chart-section">
      <div className="container">
        ...
        <div className="section-title">
          <h2>UNIFIED SS PLATE PRICE RANGE</h2>
        </div>
    ...
    <section className="specialty-weight-section">
      <div className="container">
        ...
        <div className="section-title">
          <h2>SPECIALIZED IN FOLLOWING SS PLATES</h2>
        </div>
    ...
    <section className="tolerance-section">
      <div className="container">
        ...
        <div className="section-title">
          <h2>SEARCHES RELATED TO SS PLATES</h2>
        </div>
...
export default StainlessSteelPlatesDetails;