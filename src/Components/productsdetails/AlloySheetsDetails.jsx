...
// Replace these image paths with your actual Alloy 28 Sheets product images
import alloy28HRSheets from "../../products-image/ss-hr-sheets.webp";
import alloy28CRSheets from "../../products-image/ss-cr-sheets.webp";
import alloy28Coils from "../../products-image/ss-perforated-sheets.webp";
...
const stockData = [
  {
    title: "ALLOY 28 HOT ROLLED SHEETS",
    image: alloy28HRSheets,
    items: [
      "Alloy 28 Hot Rolled Sheets (ASTM B709)",
      "UNS N08028 / 1.4563",
      "No.1 Finish – Industrial Fabrication",
      "Superior Resistance to Sulfuric & Phosphoric Acids",
    ],
  },
  {
    title: "ALLOY 28 COLD ROLLED SHEETS",
    image: alloy28CRSheets,
    items: [
      "Alloy 28 Cold Rolled Sheets (ASTM B709)",
  ...
  {
    title: "ALLOY 28 COILS & STRIPS",
    image: alloy28Coils,
    items: [
      "Alloy 28 Coils (ASTM B709)",
      "Alloy 28 Strips & Foils",
...
// Thickness and weight charts for sheets (density 8.0 g/cm³)
const leftThickness = [
...
// Approx weights for alloy 28 sheets (density 8.0 g/cm³)
const leftData = [
...
const leftItems = [
  "Alloy 28 Hot Rolled & Cold Rolled Sheets",
  ...
  "Alloy 28 Sheets Manufacturer in India",
];
...
const rightItems = [
  ...
  "Alloy 28 Sheets Supplier in Mumbai",
];

const searchTerms = [
  "Alloy 28 Sheet Price Per Kg",
  "Alloy 28 Sheet Weight Chart",
  "Alloy 28 Sheet Supplier In India",
  "UNS N08028 Sheet Chemical Composition",
  "Alloy 28 Sheet Price In Mumbai",
  "Alloy 28 Sheet Dimensions",
  "Alloy 28 Sheet Specifications Pdf",
  "Alloy 28 Sulfuric Acid Resistance",
  "Alloy 28 Sheet Price List",
  "Alloy 28 Sheet Weight Calculator",
  "Alloy 28 Sheet Mechanical Properties",
  "Alloy 28 Sheet Stockist",
  "Alloy 28 Sheet Heat Treatment",
  "Alloy 28 Sheet Price Per Kg In India",
  "Alloy 28 1.4563 Sheet",
  "Alloy 28 Sheet Manufacturers In Mumbai",
  "Buy Alloy 28 Sheets In India",
];
...
const AlloySheetsDetails = () => {
  return (
    <>
      <Helmet>
        <title>Alloy 28 Sheets Supplier – UNS N08028 Nickel-Iron-Chromium Alloy Sheets</title>
        <meta
          name="description"
          content="Supplier of Alloy 28 sheets (UNS N08028, 1.4563) with exceptional resistance to sulfuric acid, phosphoric acid, and chloride SCC. Hot rolled, cold rolled, coils, strips, circles available."
        />
      </Helmet>
      ...
      <div className="product-details-container">
        <div className="product-main-content">
          <section className="product-content">
            <div className="content-header">
              <h1>ALLOY 28 SHEETS SUPPLIER – UNS N08028 NICKEL-IRON-CHROMIUM ALLOY SHEETS</h1>
            </div>
            <div className="content-image">
              <img src={alloy28} alt="Alloy 28 Sheets" className="main-image" />
            </div>
          ...
          <section className="product-content">
            <div className="content-header">
              <h2>ALLOY 28 SHEETS: SUPERIOR RESISTANCE TO SULFURIC ACID AND CHLORIDE STRESS CORROSION CRACKING</h2>
              <p>
              ...
              <hr />
              <h3>KEY FEATURES OF ALLOY 28 SHEETS</h3>
              ...
              <p>
                Our Alloy 28 sheets conform to international standards including <strong>ASTM B709 / ASME SB709</strong> (standard specification for nickel‑iron‑chromium‑molybdenum‑copper alloy plate, sheet, and strip). We supply sheets in various finishes (No.1, 2B, BA, No.4, HL, Mirror) and can custom‑cut to your exact dimensions.
              </p>
            </div>
          </section>

          <section className="specification-section">
            <h2>Specification: Alloy 28 Sheets</h2>
          ...
          <section className="stock-section">
            <div className="stock-container">
              <div className="stock-heading">
                <h2>READY STOCK AVAILABILITY – ALLOY 28 SHEETS</h2>
              </div>
          ...
          <section className="chemical-section">
            <div className="container">
              <div className="section-title">
                <h2>CHEMICAL COMPOSITION OF ALLOY 28 SHEETS</h2>
              </div>
              <div className="table-responsive">
          ...
          <section className="mechanical-section">
            <div className="container">
              <div className="section-title">
                <h2>MECHANICAL PROPERTIES OF ALLOY 28 SHEETS</h2>
              </div>
              <div className="table-responsive">
          ...
          <section className="thickness-section">
            <div className="container">
              <div className="section-title">
                <h2>
                  THICKNESS RANGE AVAILABILITY: ALLOY 28 SHEETS
                  <span>(ASTM B709 / ASME SB709)</span>
                </h2>
          ...
          <section className="coil-weight-section">
            <div className="container">
              <div className="section-title">
                <h2>UNIFIED WEIGHT CHART: ALLOY 28 SHEETS</h2>
              </div>
              <div className="table-responsive">
          ...
          <section className="finish-weight-section">
            <div className="container">
              <div className="section-title">
                <h2>ALLOY 28 SHEET SUPPLY RANGE (UNIFIED)</h2>
          ...
          <section className="gauge-chart-section">
            <div className="container">
              <div className="section-title">
                <h2>UNIFIED ALLOY 28 SHEET PRICE RANGE</h2>
              </div>
              <div className="table-responsive">
          ...
          <section className="specialty-weight-section">
            <div className="container">
              <div className="section-title">
                <h2>SPECIALIZED IN FOLLOWING ALLOY 28 SHEETS</h2>
              </div>
              <div className="table-responsive">
          ...
          <section className="tolerance-section">
            <div className="container">
              <div className="section-title">
                <h2>SEARCHES RELATED TO ALLOY 28 SHEETS</h2>
              </div>
              <div className="table-responsive">
        ...
        <div className="product-sidebar-wrapper">
          ...
          <div className="quote-card">
            <h2>GET A QUOTE</h2>
            <p>Immediate pricing for Alloy 28 sheets. Contact our sales team for bulk discounts and technical support.</p>
...
export default AlloySheetsDetails;