...
import incoloyHR from "../../products-image/ss-hr-plates.webp";
import incoloyCR from "../../products-image/ss-cr-plates.webp";

import incoloySpecialty from "../../products-image/ss-custom-plates.webp";


import incoloy from "../../products-image/ss-incoloy-800-plates.webp";
import "./Productsdetails.css";


const stockData = [
  {
    title: "INCOLOY HOT ROLLED PLATES",
    image: incoloyHR,
    items: [
      "Incoloy Hot Rolled Plates",
  ...
  {
    title: "INCOLOY COLD ROLLED PLATES",
    image: incoloyCR,
    items: [
      "Incoloy Cold Rolled Plates",
      "ASTM B409 / ASME SB409",
  ...
  {
    title: "INCOLOY SPECIALTY PLATES",
    image: incoloySpecialty,
    items: [
      "Incoloy Specialty Plates",
      "High-Temperature Creep & Rupture Strength",
      "Resistant to Oxidation, Carburization & Corrosion",
      "For Furnace, Petrochemical, Chemical",
    ],
  },
...
const leftItems = [
  "Hot Rolled & Cold Rolled Incoloy Plates",
  "ASTM B409 / ASME SB409 Compliant",
  "Grades: 800, 800H, 800HT, 825, 925",
  "High Ni & Cr for High-Temperature & Acid Resistance",
  "Excellent Creep & Rupture Strength",
  "Incoloy Plates Manufacturer in India",
];

const rightItems = [
  "ASTM B409 / SB409 Incoloy Plates",
  ...
  "Incoloy Plates Supplier in Mumbai",
];

const searchTerms = [
  "Incoloy 800 Plate Price Per Kg",
  "Incoloy 825 Plate Price Per Kg",
  "Incoloy 800H Plate Weight Chart",
  "Incoloy Plate Supplier In India",
  "UNS N08800 Chemical Composition",
  "Incoloy 800HT Plate Price In Mumbai",
  "Incoloy Plate Dimensions",
  "Incoloy Plate Specifications Pdf",
  "Incoloy 800 vs 825 Difference",
  "Incoloy Plate Price List",
  "Incoloy Plate Weight Calculator",
  "Incoloy Mechanical Properties",
  "Incoloy Plate Stockist",
  "Incoloy 925 Heat Treatment",
  "Incoloy Plate Price Per Kg In India",
  "Incoloy 1.4876 / 2.4858",
  "Incoloy Plates Manufacturers In Mumbai",
  "Buy Incoloy Plates In India",
];
...
const IncoloyPlatesDetails = () => {
  return (
    <>
        <Helmet>
            <title>Incoloy Plates Supplier – Nickel-Iron-Chromium Alloy Plates (800, 800H, 800HT, 825, 925)</title>
            <meta
            name="description"
            content="Supplier of Incoloy plates (UNS N08800, N08810, N08811, N08825, N09925) with exceptional high-temperature creep strength and corrosion resistance. Hot rolled, cold rolled, polished plates available."
            />
        </Helmet>
      ...
      <div className="product-details-container">
        ...
        <section className="product-content">
            <div className="content-header">
                <h1>INCOLOY PLATES SUPPLIER – NICKEL-IRON-CHROMIUM ALLOY PLATES (800, 800H, 800HT, 825, 925)</h1>
            </div>
            <div className="content-image">
                <img src={incoloy} alt="Incoloy Plates" className="main-image" />
            </div>
        ...
        <section className="product-content">
            <div className="content-header">
                ...
                <p>Our Incoloy plates conform to international standards including <strong>ASTM B409 / ASME SB409</strong> (standard specification for nickel‑iron‑chromium alloy plate, sheet, and strip). We supply plates in various finishes (No.1, 2B, BA, No.4, HL, Mirror) and can custom‑cut to your exact dimensions.</p>
            </div>
        </section>
    ...
    <h2>Specification: Incoloy Plates</h2>
    ...
    <section className="stock-section">
      <div className="stock-container">
        ...
        <div className="stock-heading">
          <h2>READY STOCK AVAILABILITY – INCOLOY PLATES</h2>
        </div>
    ...
    <section className="chemical-section">
      <div className="container">
        ...
        <div className="section-title">
          <h2>CHEMICAL COMPOSITION OF INCOLOY PLATES</h2>
        </div>
    ...
    <section className="mechanical-section">
      <div className="container">
        ...
        <div className="section-title">
          <h2>MECHANICAL PROPERTIES OF INCOLOY PLATES</h2>
        </div>
    ...
    <section className="thickness-section">
      <div className="container">
        ...
        <div className="section-title">
          <h2>
            SIZE RANGE AVAILABILITY: INCOLOY PLATES
            <span>(ASTM B409 / SB409)</span>
          </h2>
    ...
    <section className="coil-weight-section">
      <div className="container">
        ...
        <div className="section-title">
          <h2>UNIFIED WEIGHT CHART: INCOLOY PLATES</h2>
        </div>
    ...
    <section className="finish-weight-section">
      <div className="container">
        ...
        <div className="section-title">
          <h2>INCOLOY PLATE SUPPLY RANGE (UNIFIED)</h2>
    ...
    <section className="gauge-chart-section">
      <div className="container">
        ...
        <div className="section-title">
          <h2>UNIFIED INCOLOY PLATE PRICE RANGE</h2>
        </div>
    ...
    <section className="specialty-weight-section">
      <div className="container">
        ...
        <div className="section-title">
          <h2>SPECIALIZED IN FOLLOWING INCOLOY PLATES</h2>
        </div>
    ...
    <section className="tolerance-section">
      <div className="container">
        ...
        <div className="section-title">
          <h2>SEARCHES RELATED TO INCOLOY PLATES</h2>
        </div>
...
export default IncoloyPlatesDetails;