...
const stockData = [
  {
    ...
    items: [
      "Cupro Nickel 90/10 Seamless Pipes",
  ...
  },
  {
    ...
    items: [
      "Cupro Nickel 90/10 Welded Pipes",
      "ASTM B467 UNS C70600",
  ...
  {
    title: "COPPER NICKEL 90/10 UBO PIPES",
    image: cupronickelUbo,
    items: [
      "Cupro Nickel 90/10 UBO Pipes",
  ...
  {
    title: "COPPER NICKEL 90/10 SPECIALTY PIPES",
    image: cupronickelSpecial,
    items: [
      "Copper Nickel 90/10 (C70600)",
      "Ni 10% & Fe 1.5% for Enhanced Strength",
...
const leftItems = [
  "Copper Nickel 90/10 Seamless & Welded Pipes",
  "Copper Nickel 90/10 ERW & EFW Pipes",
  "ASTM B466 / B467 Compliant",
  "Excellent Resistance to Seawater & Biofouling",
  "High Thermal Conductivity for Heat Exchangers",
  "Copper Nickel 90/10 Pipes Manufacturer in India",
];

const rightItems = [
  "ASTM B466 / B467 Copper Nickel 90/10 Pipes",
  ...
  "Copper Nickel 90/10 Pipe Supplier in Mumbai",
];

const searchTerms = [
  "Copper Nickel 90/10 Pipe Price Per Kg",
  "Cupro Nickel 90/10 Seamless Pipe Weight Chart",
  "Copper Nickel 90/10 Pipe Supplier In India",
  "UNS C70600 Chemical Composition",
  "Cupro Nickel 90/10 Pipe Pressure Rating",
  "Copper Nickel 90/10 Pipe Price In Mumbai",
  "CuNi 90/10 Pipe Dimensions",
  "Copper Nickel 90/10 Pipe Specifications Pdf",
  "C70600 Corrosion Resistance",
  "Copper Nickel 90/10 Pipe Price List",
  "Cupro Nickel 90/10 Pipe Weight Calculator",
  "Copper Nickel 90/10 Pipe Mechanical Properties",
  "Cupro Nickel 90/10 Pipe Stockist",
  "Copper Nickel 90/10 Heat Treatment",
  "Copper Nickel 90/10 Pipe Price Per Kg In India",
  "C70600 Seamless Pipe Exporter",
  "Cupro Nickel 90/10 Welded Pipe Supplier",
  "Copper Nickel 90/10 Pipe Schedule",
  "Cupro Nickel 90/10 Equivalent Grades",
  "Copper Nickel UNS C70600",
  "CuNi 90/10 2.0872",
  "Copper Nickel 90/10 Pipe Manufacturers In Mumbai",
  "Buy Copper Nickel 90/10 Pipes In India",
];
...
const CopperNickel9010PipesDetails = () => {
  return (
    <>
        <Helmet>
            <title>Copper Nickel 90/10 Pipes Supplier – UNS C70600 Cupro Nickel Alloy Pipes</title>
            <meta
            name="description"
            content="Supplier of Copper Nickel 90/10 pipes (UNS C70600, 2.0872) with exceptional resistance to seawater, biofouling, and erosion. Seamless, welded, ERW, EFW pipes available."
            />
        </Helmet>
        ...
        <Banner
            title="COPPER NICKEL 90/10 PIPES"
            image={ProductBanner}
        />
      ...
      <div className="product-details-container">
        ...
        <section className="product-content">
            <div className="content-header">
                <h1>COPPER NICKEL 90/10 PIPES SUPPLIER – CUPRO NICKEL ALLOY PIPES</h1>
            </div>
            <div className="content-image">
                <img src={copperNickel9010} alt="Copper Nickel 90/10 Pipes" className="main-image" />
            </div>
        ...
        <section className="product-content">
            <div className="content-header">
                <h2>COPPER NICKEL 90/10 PIPES: EXCEPTIONAL RESISTANCE TO SEAWATER AND BIOFOULING</h2>
                <p>Copper Nickel 90/10 (UNS C70600) is a high‑performance copper‑nickel alloy containing 10% nickel and approximately 1.5% iron. This composition provides outstanding resistance to seawater corrosion, biofouling, and erosion, making it the premier material for marine and offshore applications. The addition of iron enhances the formation of a protective oxide film, ensuring long‑term durability in aggressive aqueous environments.</p>
                <hr/>
                <h3>KEY FEATURES OF COPPER NICKEL 90/10 PIPES</h3>
                <p><strong>Superior Seawater Resistance</strong> – Excellent performance in both static and flowing seawater, with minimal corrosion rates and high resistance to pitting.</p>
                ...
                <p><strong>High Thermal Conductivity</strong> – Excellent heat transfer properties, making it an ideal choice for heat exchangers, condensers, and cooling water systems.</p>
                <hr/>
                <h3>SPECIFICATIONS & STANDARDS</h3>
                <p>Our Copper Nickel 90/10 pipes conform to international standards including <strong>ASTM B466</strong> (seamless), <strong>ASTM B467</strong> (welded), <strong>ASTM B111</strong> (seamless tubes), and <strong>ASME SB466 / SB467</strong>. Available in seamless, welded, ERW, and EFW forms with custom schedules and lengths.</p>
            </div>
        </section>
    ...
    <h2>Specification: Copper Nickel 90/10 Pipes</h2>
    ...
    <section className="stock-section">
      <div className="stock-container">
        ...
        <div className="stock-heading">
          <h2>READY STOCK AVAILABILITY – COPPER NICKEL 90/10 PIPES</h2>
        </div>
    ...
    <section className="grades-section">
      <div className="container">
        ...
        <div className="section-title">
          <h2>EQUIVALENT GRADES: COPPER NICKEL 90/10</h2>
        </div>
    ...
    <section className="chemical-section">
      <div className="container">
        ...
        <div className="section-title">
          <h2>CHEMICAL COMPOSITION OF COPPER NICKEL 90/10 PIPES</h2>
        </div>
    ...
    <section className="mechanical-section">
      <div className="container">
        ...
        <div className="section-title">
          <h2>MECHANICAL PROPERTIES OF COPPER NICKEL 90/10 PIPING</h2>
        </div>
    ...
    <section className="thickness-section">
      <div className="container">
        ...
        <div className="section-title">
          <h2>
            SIZE RANGE AVAILABILITY: COPPER NICKEL 90/10 PIPES
    ...
    <section className="coil-weight-section">
      <div className="container">
        ...
        <div className="section-title">
          <h2>UNIFIED WEIGHT CHART: COPPER NICKEL 90/10 PIPES</h2>
        </div>
    ...
    <section className="finish-weight-section">
      <div className="container">
        ...
        <div className="section-title">
          <h2>COPPER NICKEL 90/10 PIPE SUPPLY RANGE (UNIFIED)</h2>
    ...
    <section className="gauge-chart-section">
      <div className="container">
        ...
        <div className="section-title">
          <h2>UNIFIED COPPER NICKEL 90/10 PIPE PRICE RANGE</h2>
        </div>
    ...
    <section className="specialty-weight-section">
      <div className="container">
        ...
        <div className="section-title">
          <h2>SPECIALIZED IN FOLLOWING COPPER NICKEL 90/10 PIPES</h2>
        </div>
    ...
    <section className="tolerance-section">
      <div className="container">
        ...
        <div className="section-title">
          <h2>SEARCHES RELATED TO COPPER NICKEL 90/10 PIPES</h2>
        </div>
...
export default CopperNickel9010PipesDetails;