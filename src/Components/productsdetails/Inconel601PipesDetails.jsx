...
const stockData = [
  {
    title: "INCONEL 601 SEAMLESS PIPES",
    image: inconelSeamless,
    items: [
      "Inconel 601 Seamless Pipes",
      "ASTM B167 / B163 Seamless",
      "UNS N06601 / EN 2.4851",
      "High-Temperature Oxidation Resistant",
    ],
  },
  {
    title: "INCONEL 601 WELDED PIPES",
    image: inconelWelded,
    items: [
      "Inconel 601 Welded Pipes",
  ...
  {
    title: "INCONEL 601 ERW PIPES",
    image: inconelErw,
    items: [
      "Inconel 601 ERW Pipes",
  ...
  {
    title: "INCONEL 601 EFW PIPES",
    image: inconelEfw,
    items: [
      "Inconel 601 EFW Pipes",
  ...
  {
    title: "INCONEL 601 UBO PIPES",
    image: inconelUbo,
    items: [
      "Inconel 601 UBO Pipes",
      "Unified Bare Outer Pipes",
      "Superior Oxidation & Carburization Resistance",
      "For Furnace & Heat Treatment Service",
    ],
  },
  {
    title: "INCONEL 601 SPECIALTY PIPES",
    image: inconelSpecial,
    items: [
      "Inconel 601 Nickel-Chromium Alloy",
      "High Chromium (21-25%) + Aluminum",
      "Excellent Resistance to High-Temperature Oxidation",
      "For Petrochemical & Power Generation",
    ],
  }
];
...
const chemicalData = [
  {
    ...
    ni: "58.0 min",
    mo: "—",
    other: "Al: 1.0-1.7, Fe: Balance, Cu: 1.0 max",
  }
];
...
const leftItems = [
  "Inconel 601 Seamless & Welded Pipes",
  "Inconel 601 ERW & EFW Pipes",
  "ASTM B163 / B167 / B407 / B517 Compliant",
  "Excellent High-Temperature Oxidation Resistance",
  "Resistant to Carburization & Nitriding",
  "Inconel 601 for Furnace & Heat Treatment",
  "Inconel 601 Pipes Manufacturer in India",
];

const rightItems = [
  "ASTM B163 / B167 / B407 / B517 Inconel 601 Pipes",
  ...
  "Inconel 601 Hollow Section & Square Pipes",
  "Inconel 601 Pipe Supplier in Mumbai",
];

const searchTerms = [
  "Inconel 601 Pipe Price Per Kg",
...
const Inconel601PipesDetails = () => {
  return (
    <>
        <Helmet>
            <title>Inconel 601 Pipes Supplier – UNS N06601 Nickel-Chromium Alloy Pipes</title>
            <meta
            name="description"
            content="Supplier of Inconel 601 pipes (UNS N06601, 2.4851) with exceptional high-temperature oxidation and carburization resistance. Seamless, welded, ERW, EFW pipes available."
            />
        </Helmet>
      ...
      <div className="product-details-container">
        ...
        <section className="product-content">
            <div className="content-header">
                <h1>INCONEL 601 PIPES SUPPLIER – NICKEL-CHROMIUM ALLOY PIPES</h1>
            </div>
            <div className="content-image">
                <img src={inconel601} alt="Inconel 601 Pipes" className="main-image" />
            </div>
        ...
        <section className="product-content">
            <div className="content-header">
                <h2>INCONEL 601 PIPES: EXCEPTIONAL HIGH-TEMPERATURE OXIDATION RESISTANCE</h2>
                <p>Inconel 601 (UNS N06601) is a nickel-chromium alloy designed for outstanding resistance to oxidation and corrosion at elevated temperatures. With a chromium content of 21–25% and aluminum additions, it forms a tenacious oxide scale that protects against oxidation, carburization, and nitriding up to 1200°C. This makes it ideal for furnace components, heat-treating equipment, and petrochemical applications.</p>
                <hr/>
                <h3>KEY FEATURES OF INCONEL 601 PIPES</h3>
                <p><strong>High-Temperature Oxidation Resistance</strong> – The alloy's chromium and aluminum content provide excellent resistance to oxidation and scaling in air and combustion atmospheres.</p>
                <p><strong>Resistance to Carburization & Nitriding</strong> – Maintains integrity in carbon-rich and nitrogen-rich environments, common in heat treating and chemical processing.</p>
                <p><strong>Good Weldability & Fabrication</strong> – Can be welded using standard techniques, with good ductility and strength at high temperatures.</p>
                <hr/>
                <h3>SPECIFICATIONS & STANDARDS</h3>
                <p>Our Inconel 601 pipes conform to international standards including <strong>ASTM B163</strong> (seamless tubes), <strong>ASTM B167</strong> (seamless pipes), <strong>ASTM B407</strong> (welded), and <strong>ASTM B517</strong> (EFW). Available in seamless, welded, ERW, and EFW forms with custom schedules and lengths to suit critical high-temperature applications.</p>
            </div>
        </section>
    ...
    <h2>Specification: Inconel 601 Pipes</h2>
    ...
    <section className="stock-section">
      <div className="stock-container">
        ...
        <div className="stock-heading">
          <h2>READY STOCK AVAILABILITY – INCONEL 601 PIPES</h2>
        </div>
    ...
    <section className="grades-section">
      <div className="container">
        ...
        <div className="section-title">
          <h2>EQUIVALENT GRADES: INCONEL 601</h2>
        </div>
    ...
    <section className="chemical-section">
      <div className="container">
        ...
        <div className="section-title">
          <h2>CHEMICAL COMPOSITION OF INCONEL 601 PIPES</h2>
        </div>
    ...
    <section className="mechanical-section">
      <div className="container">
        ...
        <div className="section-title">
          <h2>MECHANICAL PROPERTIES OF INCONEL 601 PIPING</h2>
        </div>
    ...
    <section className="thickness-section">
      <div className="container">
        ...
        <div className="section-title">
          <h2>
            SIZE RANGE AVAILABILITY: INCONEL 601 PIPES
    ...
    <section className="coil-weight-section">
      <div className="container">
        ...
        <div className="section-title">
          <h2>UNIFIED WEIGHT CHART: INCONEL 601 PIPES</h2>
        </div>
    ...
    <section className="finish-weight-section">
      <div className="container">
        ...
        <div className="section-title">
          <h2>INCONEL 601 PIPE SUPPLY RANGE (UNIFIED)</h2>
    ...
    <section className="gauge-chart-section">
      <div className="container">
        ...
        <div className="section-title">
          <h2>UNIFIED INCONEL 601 PIPE PRICE RANGE</h2>
        </div>
    ...
    <section className="specialty-weight-section">
      <div className="container">
        ...
        <div className="section-title">
          <h2>SPECIALIZED IN FOLLOWING INCONEL 601 PIPES</h2>
        </div>
    ...
    <section className="tolerance-section">
      <div className="container">
        ...
        <div className="section-title">
          <h2>SEARCHES RELATED TO INCONEL 601 PIPES</h2>
        </div>
...
export default Inconel601PipesDetails;