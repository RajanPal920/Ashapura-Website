...
import superDuplexF55 from "../../products-image/ss-super-duplex-32760-pipes.webp";
...
const stockData = [
  {
    title: "S32760 SEAMLESS PIPES",
    image: superDuplexSeamless,
    items: [
      "Super Duplex S32760 Seamless Pipes",
      "ASTM A790 / ASME SA790 UNS S32760",
      "F55 / 1.4501 Grade",
      "High Strength & Corrosion Resistant",
    ],
  },
  {
    title: "S32760 WELDED PIPES",
    image: superDuplexWelded,
    items: [
      "Super Duplex S32760 Welded Pipes",
  ...
  {
    title: "S32760 ERW PIPES",
    image: superDuplexErw,
    items: [
      "Super Duplex S32760 ERW Pipes",
  ...
  {
    title: "S32760 EFW PIPES",
    image: superDuplexRound,
    items: [
      "Super Duplex S32760 EFW Pipes",
  ...
  {
    title: "S32760 UBO PIPES",
    image: superDuplexHollow,
    items: [
      "Super Duplex S32760 UBO Pipes",
  ...
  {
    title: "S32760 SPECIALTY PIPES",
    image: superDuplexSquare,
    items: [
      "Super Duplex S32760 (F55)",
      "High Cr, Mo, N & W",
      "PREN ≥ 40 – Excellent Chloride Resistance",
...
const leftItems = [
  "Super Duplex S32760 (F55) Seamless & Welded Pipes",
  "Super Duplex S32760 ERW & EFW Pipes",
  "ASTM A790 / A928 / A789 Compliant",
  "PREN ≥ 40 – Superior Pitting Resistance",
  "High Strength (Yield 550 MPa) & Excellent Toughness",
  "Super Duplex S32760 Pipes Manufacturer in India",
];

const rightItems = [
  "ASTM A790 / A928 / A789 Super Duplex S32760 Pipes",
  ...
  "Super Duplex S32760 Hollow Section & Square Pipes",
  "Super Duplex S32760 Pipe Supplier in Mumbai",
];

const searchTerms = [
  "Super Duplex S32760 Pipe Price Per Kg",
  "F55 Super Duplex Pipe Weight Chart",
  "S32760 Pipe Supplier In India",
  "Super Duplex S32760 Chemical Composition",
  "S32760 Pipe Pressure Rating",
  "S32760 Pipe Price In Mumbai",
  "Super Duplex S32760 Pipe Dimensions",
  "S32760 Pipe Specifications Pdf",
  "Super Duplex 1.4501",
  "S32760 Pipe Price List",
  "S32760 Pipe Weight Calculator",
  "Super Duplex S32760 Mechanical Properties",
  "S32760 Pipe Stockist",
  "Super Duplex S32760 Heat Treatment",
  "S32760 Pipe Price Per Kg In India",
  "Super Duplex S32760 Seamless Pipe Exporter",
  "F55 Welded Pipe Supplier",
  "S32760 Pipe Schedule",
  "S32760 Equivalent Grades",
  "Super Duplex UNS S32760",
  "F55 1.4501",
  "Super Duplex S32760 Pipe Manufacturers In Mumbai",
  "Buy Super Duplex S32760 Pipes In India",
];
...
const SuperDuplexF55PipesDetails = () => {
  return (
    <>
        <Helmet>
            <title>Super Duplex S32760 (F55) Pipes Supplier – UNS S32760 Super Duplex Steel Pipes</title>
            <meta
            name="description"
            content="Supplier of Super Duplex S32760 (F55) pipes (UNS S32760, 1.4501) with exceptional strength, pitting resistance (PREN ≥ 40), and chloride stress corrosion cracking resistance. Seamless, welded, ERW, EFW pipes available."
            />
        </Helmet>
        ...
        <Banner
            title="SUPER DUPLEX S32760 (F55) PIPES"
            image={ProductBanner}
        />
      ...
      <div className="product-details-container">
        ...
        <section className="product-content">
            <div className="content-header">
                <h1>SUPER DUPLEX S32760 (F55) PIPES SUPPLIER – SUPER DUPLEX STAINLESS STEEL PIPES</h1>
            </div>
            <div className="content-image">
                <img src={superDuplexF55} alt="Super Duplex S32760 Pipes" className="main-image" />
            </div>
        ...
        <section className="product-content">
            <div className="content-header">
                <h2>SUPER DUPLEX S32760 (F55) PIPES: UNMATCHED STRENGTH AND CORROSION RESISTANCE</h2>
                <p>Super Duplex S32760 (also known as F55) is a high‑alloy super duplex stainless steel with a PREN (Pitting Resistance Equivalent Number) of ≥ 40, offering outstanding resistance to pitting, crevice corrosion, and chloride stress corrosion cracking. With a yield strength exceeding 550 MPa, it provides superior mechanical performance compared to conventional duplex and austenitic grades. This alloy is the preferred choice for demanding offshore, marine, chemical processing, and oil & gas applications.</p>
                <hr/>
                <h3>KEY FEATURES OF SUPER DUPLEX S32760 PIPES</h3>
                <p><strong>Exceptional Pitting Resistance</strong> – PREN ≥ 40 due to high chromium, molybdenum, nitrogen, and tungsten content.</p>
                <p><strong>High Strength</strong> – Yield strength - 550 MPa, enabling reduced wall thickness and weight savings.</p>
                <p><strong>Excellent Resistance to SCC</strong> – Outstanding performance in chloride‑rich environments, including seawater and brine.</p>
                <hr/>
                <h3>SPECIFICATIONS & STANDARDS</h3>
                <p>Our Super Duplex S32760 pipes conform to international standards including <strong>ASTM A790</strong> (seamless and welded), <strong>ASTM A928</strong> (welded), <strong>ASTM A789</strong> (seamless and welded tube), and <strong>ASME SA790 / SA928 / SA789</strong>. Available in seamless, welded, ERW, and EFW forms with custom schedules and lengths.</p>
            </div>
        </section>
    ...
    <h2>Specification: Super Duplex S32760 (F55) Pipes</h2>

    <div className="spec-grid">

        <div className="spec-card">
            <h4>Standard</h4>
            <p>ASTM A790 / A928 / A789, ASME SA790 / SA928 / SA789</p>
        </div>
    ...
    <section className="stock-section">
      <div className="stock-container">
        ...
        <div className="stock-heading">
          <h2>READY STOCK AVAILABILITY – SUPER DUPLEX S32760 PIPES</h2>
        </div>
    ...
    <section className="grades-section">
      <div className="container">
        ...
        <div className="section-title">
          <h2>EQUIVALENT GRADES: SUPER DUPLEX S32760</h2>
        </div>
    ...
    <section className="chemical-section">
      <div className="container">
        ...
        <div className="section-title">
          <h2>CHEMICAL COMPOSITION OF SUPER DUPLEX S32760 PIPES</h2>
        </div>
    ...
    <section className="mechanical-section">
      <div className="container">
        ...
        <div className="section-title">
          <h2>MECHANICAL PROPERTIES OF SUPER DUPLEX S32760 PIPING</h2>
        </div>
    ...
    <section className="thickness-section">
      <div className="container">
        ...
        <div className="section-title">
          <h2>
            SIZE RANGE AVAILABILITY: SUPER DUPLEX S32760 PIPES
            <span>(ASTM A790 / A928 / A789)</span>
          </h2>
    ...
    <section className="coil-weight-section">
      <div className="container">
        ...
        <div className="section-title">
          <h2>UNIFIED WEIGHT CHART: SUPER DUPLEX S32760 PIPES</h2>
        </div>
    ...
    <section className="finish-weight-section">
      <div className="container">
        ...
        <div className="section-title">
          <h2>SUPER DUPLEX S32760 PIPE SUPPLY RANGE (UNIFIED)</h2>
    ...
    <section className="gauge-chart-section">
      <div className="container">
        ...
        <div className="section-title">
          <h2>UNIFIED SUPER DUPLEX S32760 PIPE PRICE RANGE</h2>
        </div>
    ...
    <section className="specialty-weight-section">
      <div className="container">
        ...
        <div className="section-title">
          <h2>SPECIALIZED IN FOLLOWING SUPER DUPLEX S32760 PIPES</h2>
        </div>
    ...
    <section className="tolerance-section">
      <div className="container">
        ...
        <div className="section-title">
          <h2>SEARCHES RELATED TO SUPER DUPLEX S32760 PIPES</h2>
        </div>
...
export default SuperDuplexF55PipesDetails;
