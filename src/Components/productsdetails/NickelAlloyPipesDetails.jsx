...
// Replace these image paths with your actual Nickel Alloy product images
import nickelSeamless from "../../products-image/ss-nimonic-pipes.webp";
import nickelWelded from "../../products-image/ss-nitronic-pipes.webp";
import nickelErw from "../../products-image/ss-nichrome-pipes.webp";
import nickelRound from "../../products-image/ss-nilo42-pipes.webp";
import nickelSquare from "../../products-image/ss-alloy-a286-pipes.webp";
import nickelHollow from "../../products-image/ss-alloy-926-pipes.webp";

import nickelSteel from "../../products-image/nickel-alloy-pipes-supplier.webp"; 
import "./Productsdetails.css";

const stockData = [
  {
    title: "NICKEL 200 / 201 PIPES",
    image: nickelSeamless,
    items: [
      "Nickel 200 Seamless Pipes (ASTM B161)",
      "Nickel 201 Welded Pipes (ASTM B725)",
      "UNS N02200 / N02201 Pure Nickel Pipes",
      "Low-Carbon Nickel 201 for High Temp Service",
    ],
  },
  {
    title: "NICKEL 400 (MONEL) PIPES",
    image: nickelWelded,
    items: [
      "Monel 400 Seamless & Welded Pipes",
      "UNS N04400 / 2.4360 Alloy 400 Piping",
      "Monel 400 ERW Pipes",
      "Marine & Chemical Resistant Monel Pipes",
    ],
  },
  {
    title: "NICKEL 600 (INCONEL) PIPES",
    image: nickelErw,
    items: [
      "Inconel 600 Seamless Pipes",
      "UNS N06600 / 2.4816 Alloy 600",
      "High Temperature & Oxidation Resistant",
      "Inconel 600 Welded & ERW Pipes",
    ],
  },
  {
    title: "NICKEL 625 (INCONEL) PIPES",
    image: nickelRound,
    items: [
      "Inconel 625 Seamless Pipes (ASTM B444)",
      "UNS N06625 / 2.4856 Alloy 625",
      "Superalloy 625 for Extreme Corrosion",
      "Inconel 625 Welded & Cold Drawn Pipes",
    ],
  },
  {
    title: "NICKEL 800 (INCOLOY) PIPES",
    image: nickelSquare,
    items: [
      "Incoloy 800 Seamless & Welded Pipes",
      "UNS N08800 / 1.4876 Alloy 800",
      "High-Temperature Creep Resistant Pipes",
      "Incoloy 800 ERW & EFW Pipes",
    ],
  },
  {
    title: "NICKEL 825 (INCOLOY) PIPES",
    image: nickelHollow,
    items: [
      "Incoloy 825 Seamless Pipes (ASTM B423)",
      "UNS N08825 / 2.4858 Alloy 825",
      "Corrosion Resistant in Acidic Environments",
      "Incoloy 825 Welded & Heavy Wall Pipes",
    ],
  }
];
...
const gradesData = [
  ...
  },
  {
    ...
    uns: "N04400",
    werkstoff: "2.4360",
    standard: "ASTM B165 / B725",
  },
  {
    grade: "Nickel 600",
    uns: "N06600",
    werkstoff: "2.4816",
    standard: "ASTM B167 / B517",
  },
  {
    grade: "Nickel 625",
    uns: "N06625",
    werkstoff: "2.4856",
    standard: "ASTM B444 / B705",
  },
  {
    grade: "Nickel 800",
    uns: "N08800",
...
const mechanicalData = [
  ...
  },
  {
    grade: "Nickel 825",
    tensile: "620 MPa (90 ksi)",
    yield: "275 MPa (40 ksi)",
    elongation: "40%",
    density: "8.14 g/cm³",
  },
];

// Thickness and weight charts (standard pipe dimensions, unchanged)
const leftThickness = [
...
const leftItems = [
  "Nickel Alloy 200 / 201 Seamless & Welded Pipes",
  "Monel 400 / K500 Seamless & Welded Pipes",
  "Inconel 600 / 625 / 690 Pipes",
  "Incoloy 800 / 825 / 925 Pipes",
  "Nickel Alloy ERW & EFW Pipes",
  "Nickel Alloy Cold Drawn & Precision Pipes",
  "Nickel Alloy Pipe Manufacturer in India",
];

const rightItems = [
  "ASTM B161 / B165 / B167 / B407 / B423 / B444 / B705",
  ...
  "Nickel Alloy Hollow Section & Square Pipes",
  "Nickel Alloy Pipe Supplier in Mumbai",
];

const searchTerms = [
  "Nickel Alloy Pipe Price Per Kg",
  "Nickel Alloy Seamless Pipe Weight Chart",
  "Nickel Alloy Pipe Supplier In India",
  "Nickel Alloy 600 Chemical Composition",
  "Nickel Alloy 625 Pipe Pressure Rating",
  "Monel 400 Pipe Price In Mumbai",
  "Inconel 600 Pipe Dimensions",
  "Incoloy 825 Pipe Specifications Pdf",
  "Nickel Alloy Pipe Corrosion Resistance",
  "Nickel Alloy Pipe Price List",
  "Nickel Alloy Pipe Weight Calculator",
  "Nickel Alloy Pipe Mechanical Properties",
  "Nickel Alloy Pipe Stockist",
  "Nickel Alloy Pipe Heat Treatment",
  "Nickel Alloy Pipe Price Per Kg In India",
  "Nickel Alloy Seamless Pipe Exporter",
  "Nickel Alloy Welded Pipe Supplier",
  "Nickel Alloy Pipe Sizes",
  "Nickel Alloy Pipe Schedule",
  "Nickel Alloy Pipe Equivalent Grades",
  "Alloy 800 Pipe UNS N08800",
  "Alloy 825 Pipe 2.4858",
  "Nickel Alloy Pipe Manufacturers In Mumbai",
  "Buy Nickel Alloy Pipes In India",
];
...
const NickelAlloyPipesDetails = () => {
  return (
    <>
      <Helmet>
        <title>Nickel Alloy Pipes Supplier, Stockist & Exporter</title>
        <meta
          name="description"
          content="Leading supplier of Nickel Alloy pipes including Alloy 200/201, Monel 400, Inconel 600/625, and Incoloy 800/825. Available in seamless, welded, ERW, and custom sizes."
        />
      </Helmet>
      ...
      <div className="product-details-container">
        <div className="product-main-content">
          <section className="product-content">
            <div className="content-header">
              <h1>NICKEL ALLOY PIPES SUPPLIER – SEAMLESS, WELDED, ERW & CUSTOM</h1>
            </div>
            <div className="content-image">
              <img src={nickelSteel} alt="Nickel Alloy Pipes" className="main-image" />
            </div>
          ...
          <section className="product-content">
            <div className="content-header">
              <h2>PREMIUM NICKEL ALLOY PIPES – ENGINEERED FOR EXTREME CONDITIONS</h2>
              <p>
                Our comprehensive range of <strong>Nickel Alloy Pipes</strong> includes commercially pure nickel (200/201), nickel-copper (Monel 400), nickel-chromium (Inconel 600/625), and nickel-iron-chromium (Incoloy 800/825) grades. These alloys are specifically designed to withstand aggressive chemicals, high temperatures, and severe mechanical stress, ensuring exceptional performance and longevity in demanding industrial environments.
              </p>
              <hr />
              <h3>SEAMLESS & WELDED CONSTRUCTION</h3>
              <p>
                We supply nickel alloy pipes in <strong>seamless (ASTM B161, B165, B167, B407, B423, B444)</strong> and <strong>welded (ASTM B725, B705, B514, B517)</strong> forms. Available in sizes from ½" NB to 24" NB and schedules SCH 5 to SCH XXS, our pipes are produced using advanced cold-drawing and heat-treatment processes to meet strict dimensional tolerances and superior surface finishes.
              </p>
              <h3>APPLICATIONS & ADVANTAGES</h3>
              <p>
                Nickel alloy pipes are essential in chemical processing, petrochemical, oil & gas, power generation, marine engineering, aerospace, and food processing industries. They offer excellent resistance to sulfuric acid, hydrochloric acid, caustic soda, seawater, and high-temperature oxidation. Their unique combination of strength, ductility, and corrosion resistance ensures reliable service even in the most aggressive environments.
              </p>
              <hr />
              <h3>COMPLIANCE & STANDARDS</h3>
              <p>
                Our nickel alloy pipes are manufactured and tested in accordance with <strong>ASTM / ASME</strong> specifications including <strong>ASTM B161, B165, B167, B407, B423, B444, B705, B725</strong> and <strong>ASME SB161, SB165, SB167, SB407, SB423, SB444, SB705, SB725</strong>. We provide comprehensive mill test certificates, PMI reports, and third-party inspection services upon request.
              </p>
            </div>
          </section>

          <section className="specification-section">
            <h2>UNIFIED SPECIFICATION: NICKEL ALLOY PIPES</h2>
            <div className="spec-grid">
              <div className="spec-card">
                <h4>Standard</h4>
                <p>ASTM / ASME B161, B165, B167, B407, B423, B444, B705, B725</p>
              </div>
              <div className="spec-card">
                <h4>Size Range</h4>
          ...
          <section className="stock-section">
            <div className="stock-container">
              <div className="stock-heading">
                <h2>READY STOCK AVAILABILITY – NICKEL ALLOY PIPES</h2>
              </div>
          ...
          <section className="grades-section">
            <div className="container">
              <div className="section-title">
                <h2>EQUIVALENT GRADES: NICKEL ALLOYS</h2>
              </div>
          ...
          <section className="chemical-section">
            <div className="container">
              <div className="section-title">
                <h2>CHEMICAL COMPOSITION OF NICKEL ALLOY PIPES</h2>
              </div>
              <div className="table-responsive">
          ...
          <section className="mechanical-section">
            <div className="container">
              <div className="section-title">
                <h2>MECHANICAL PROPERTIES OF NICKEL ALLOY PIPING</h2>
              </div>
              <div className="table-responsive">
          ...
          <section className="thickness-section">
            <div className="container">
              <div className="section-title">
                <h2>
                  SIZE RANGE AVAILABILITY: NICKEL ALLOY PIPES
                  <span>(ASTM / ASME B161, B165, B167, B407, B423, B444, B705, B725)</span>
                </h2>
          ...
          <section className="coil-weight-section">
            <div className="container">
              <div className="section-title">
                <h2>UNIFIED WEIGHT CHART: NICKEL ALLOY PIPES</h2>
              </div>
              <div className="table-responsive">
          ...
          <section className="finish-weight-section">
            <div className="container">
              <div className="section-title">
                <h2>NICKEL ALLOY PIPE SUPPLY RANGE (UNIFIED)</h2>
          ...
          <section className="gauge-chart-section">
            <div className="container">
              <div className="section-title">
                <h2>UNIFIED NICKEL ALLOY PIPE PRICE RANGE</h2>
              </div>
              <div className="table-responsive">
          ...
          <section className="specialty-weight-section">
            <div className="container">
              <div className="section-title">
                <h2>SPECIALIZED IN FOLLOWING NICKEL ALLOY PIPES</h2>
              </div>
              <div className="table-responsive">
          ...
          <section className="tolerance-section">
            <div className="container">
              <div className="section-title">
                <h2>SEARCHES RELATED TO NICKEL ALLOY PIPES</h2>
              </div>
              <div className="table-responsive">
        ...
        <div className="product-sidebar-wrapper">
          ...
          <div className="quote-card">
            <h2>GET A QUOTE</h2>
            <p>Immediate pricing for all Nickel Alloy pipes. Contact our sales team for bulk discounts and technical support.</p>
...
export default NickelAlloyPipesDetails;