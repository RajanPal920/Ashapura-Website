...
// Replace these image paths with your actual Incoloy Sheets product images
import incoloySheetsHR from "../../products-image/ss-hr-sheets.webp";
import incoloySheetsCR from "../../products-image/ss-cr-sheets.webp";
import incoloySheetsPolished from "../../products-image/ss-hr-sheets.webp";
...
const stockData = [
  {
    title: "INCOLOY HOT ROLLED SHEETS",
    image: incoloySheetsHR,
    items: [
      "Incoloy 800, 800H, 800HT, 825, 925 Hot Rolled Sheets",
      "ASTM B409 / ASME SB409",
      "No.1 Finish – Industrial Fabrication",
      "Excellent Formability & High-Temperature Strength",
    ],
  },
  {
    title: "INCOLOY COLD ROLLED SHEETS",
    image: incoloySheetsCR,
    items: [
      "Incoloy 800, 800H, 800HT, 825, 925 Cold Rolled Sheets",
      "ASTM B409 / ASME SB409",
  ...
  {
    title: "INCOLOY POLISHED SHEETS",
    image: incoloySheetsPolished,
    items: [
      "Incoloy Polished Sheets",
...
// Approx weights for Incoloy sheets (average density ~8.0 g/cm³, adjusted per grade)
const leftData = [
...
const leftItems = [
  "Incoloy 800, 800H, 800HT, 825, 925 Hot Rolled & Cold Rolled Sheets",
  "ASTM B409 / ASME SB409 Compliant",
  "High Ni & Cr for High-Temperature & Acid Resistance",
  "Excellent Creep & Rupture Strength",
  "Resistant to Oxidation, Carburization & SCC",
  "Incoloy Sheets Manufacturer in India",
];
...
const rightItems = [
  ...
  "Incoloy Sheets Supplier in Mumbai",
];

const searchTerms = [
  "Incoloy 800 Sheet Price Per Kg",
  "Incoloy 825 Sheet Price Per Kg",
  "Incoloy 800H Sheet Weight Chart",
  "Incoloy 925 Mechanical Properties",
  "Incoloy Sheet Supplier In India",
  "UNS N08800 Chemical Composition",
  "Incoloy 800HT Sheet Price In Mumbai",
  "Incoloy 825 Sheet Dimensions",
  "Incoloy 800 vs 825 Difference",
  "Incoloy Sheet Price List",
  "Incoloy Sheet Weight Calculator",
  "Incoloy Mechanical Properties",
  "Incoloy Sheet Stockist",
  "Incoloy 925 Heat Treatment",
  "Incoloy Sheet Price Per Kg In India",
  "Incoloy 1.4876 / 2.4858",
  "Incoloy Sheets Manufacturers In Mumbai",
  "Buy Incoloy Sheets In India",
];
...
const IncoloySheetsDetails = () => {
  return (
    <>
      <Helmet>
        <title>Incoloy Sheets Supplier – Incoloy 800, 800H, 800HT, 825, 925 Sheets & Coils</title>
        <meta
          name="description"
          content="Supplier of Incoloy sheets (UNS N08800, N08810, N08811, N08825, N09925) with exceptional high-temperature creep strength and corrosion resistance. Hot rolled, cold rolled, polished sheets, coils & strips available."
        />
      </Helmet>
      ...
      <div className="product-details-container">
        <div className="product-main-content">
          <section className="product-content">
            <div className="content-header">
              <h1>INCOLOY SHEETS SUPPLIER – NICKEL-IRON-CHROMIUM ALLOY SHEETS (800, 800H, 800HT, 825, 925)</h1>
            </div>
            <div className="content-image">
              <img src={incoloy} alt="Incoloy Sheets" className="main-image" />
            </div>
          ...
          <section className="product-content">
            <div className="content-header">
              <h2>INCOLOY SHEETS: HIGH-TEMPERATURE STRENGTH AND CORROSION RESISTANCE</h2>
              <p>
                Incoloy is a family of nickel‑iron‑chromium alloys renowned for their outstanding resistance to oxidation, carburization, and corrosion at elevated temperatures. Available in a wide range of grades—<strong>Incoloy 800, 800H, 800HT, 825, and 925</strong>—each alloy is tailored to specific service conditions, from steam methane reformers and furnace components to chemical processing and sour gas environments. These sheets combine excellent creep rupture strength with good fabricability, making them the material of choice for demanding industries worldwide.
              </p>
              <hr />
              ...
              <p>Our Incoloy sheets conform to international standards including <strong>ASTM B409 / ASME SB409</strong> (standard specification for nickel‑iron‑chromium alloy plate, sheet, and strip). We supply sheets in various finishes (No.1, 2B, BA, No.4, HL, Mirror) and can custom‑cut to your exact dimensions.</p>
            </div>
          </section>

          <section className="specification-section">
            <h2>Specification: Incoloy Sheets</h2>
          ...
          <section className="stock-section">
            <div className="stock-container">
              <div className="stock-heading">
                <h2>READY STOCK AVAILABILITY – INCOLOY SHEETS</h2>
              </div>
          ...
          <section className="chemical-section">
            <div className="container">
              <div className="section-title">
                <h2>CHEMICAL COMPOSITION OF INCOLOY SHEETS</h2>
              </div>
              <div className="table-responsive">
          ...
          <section className="mechanical-section">
            <div className="container">
              <div className="section-title">
                <h2>MECHANICAL PROPERTIES OF INCOLOY SHEETS</h2>
              </div>
              <div className="table-responsive">
          ...
          <section className="thickness-section">
            <div className="container">
              <div className="section-title">
                <h2>
                  THICKNESS RANGE AVAILABILITY: INCOLOY SHEETS
          ...
          <section className="coil-weight-section">
            <div className="container">
              <div className="section-title">
                <h2>UNIFIED WEIGHT CHART: INCOLOY SHEETS</h2>
              </div>
              <div className="table-responsive">
          ...
          <section className="finish-weight-section">
            <div className="container">
              <div className="section-title">
                <h2>INCOLOY SHEET SUPPLY RANGE (UNIFIED)</h2>
          ...
          <section className="gauge-chart-section">
            <div className="container">
              <div className="section-title">
                <h2>UNIFIED INCOLOY SHEET PRICE RANGE</h2>
              </div>
              <div className="table-responsive">
          ...
          <section className="specialty-weight-section">
            <div className="container">
              <div className="section-title">
                <h2>SPECIALIZED IN FOLLOWING INCOLOY SHEETS</h2>
              </div>
              <div className="table-responsive">
          ...
          <section className="tolerance-section">
            <div className="container">
              <div className="section-title">
                <h2>SEARCHES RELATED TO INCOLOY SHEETS</h2>
              </div>
              <div className="table-responsive">
        ...
        <div className="product-sidebar-wrapper">
          ...
          <div className="quote-card">
            <h2>GET A QUOTE</h2>
            <p>Immediate pricing for Incoloy sheets. Contact our sales team for bulk discounts and technical support.</p>
...
export default IncoloySheetsDetails;