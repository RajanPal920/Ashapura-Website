...
import hastelloyHR from "../../products-image/ss-hr-plates.webp";
import hastelloyCR from "../../products-image/ss-cr-plates.webp";
import hastelloySpecialty from "../../products-image/ss-custom-plates.webp";

import hastelloy from "../../products-image/ss-hastelloy-plates.webp";

import "./Productsdetails.css";

const stockData = [
  {
    title: "HASTELLOY C276 HOT ROLLED PLATES",
    image: hastelloyHR,
    items: [
      "Hastelloy C276 Hot Rolled Plates",
  ...
  {
    title: "HASTELLOY C276 COLD ROLLED PLATES",
    image: hastelloyCR,
    items: [
      "Hastelloy C276 Cold Rolled Plates",
      "ASTM B575 / ASME SB575",
  ...
  {
    title: "HASTELLOY C276 / C22 / B2 SPECIALTY PLATES",
    image: hastelloySpecialty,
    items: [
      "Hastelloy C276, C22 & B2 Specialty Plates",
      "Resistant to Oxidizing & Reducing Acids",
      "High Mo, Cr, W Content for Extreme Corrosion",
      "For Chemical Processing & Pollution Control",
    ],
  },
];
...
const leftItems = [
  "Hot Rolled & Cold Rolled Hastelloy C276 Plates",
  "ASTM B575 / ASME SB575 Compliant",
  "High Ni, Cr, Mo & W for Extreme Corrosion Resistance",
  "Excellent Resistance to Pitting & Crevice Corrosion",
  "Superior Performance in Oxidizing & Reducing Media",
  "Hastelloy Plates Manufacturer in India",
];

const rightItems = [
  "ASTM B575 / SB575 Hastelloy C276 Plates",
  ...
  "Hastelloy Plates Supplier in Mumbai",
];

const searchTerms = [
  "Hastelloy C276 Plate Price Per Kg",
  "Hastelloy C276 Plate Weight Chart",
  "Hastelloy C276 Plate Supplier In India",
  "UNS N10276 Chemical Composition",
  "Hastelloy C276 Plate Price In Mumbai",
  "Hastelloy C276 Plate Dimensions",
  "Hastelloy C276 Plate Specifications Pdf",
  "Hastelloy C276 Pitting Resistance",
  "Hastelloy C276 Plate Price List",
  "Hastelloy C276 Plate Weight Calculator",
  "Hastelloy C276 Mechanical Properties",
  "Hastelloy C276 Plate Stockist",
  "Hastelloy C276 Heat Treatment",
  "Hastelloy C276 Plate Price Per Kg In India",
  "Hastelloy C276 2.4819",
  "Hastelloy Plates Manufacturers In Mumbai",
  "Buy Hastelloy C276 Plates In India",
];
...
const HastelloyPlatesDetails = () => {
  return (
    <>
      <Helmet>
        <title>Hastelloy Plates Supplier – UNS N10276 Nickel-Molybdenum-Chromium Alloy Plates</title>
        <meta
          name="description"
          content="Supplier of Hastelloy C276 plates (UNS N10276, 2.4819) with exceptional resistance to pitting, crevice corrosion, and SCC. Hot rolled, cold rolled, polished plates available."
        />
      </Helmet>
        ...
        <div className="product-main-content">
          <section className="product-content">
            <div className="content-header">
              <h1>HASTELLOY PLATES SUPPLIER – UNS N10276 NICKEL-MOLYBDENUM-CHROMIUM ALLOY PLATES</h1>
            </div>
            <div className="content-image">
              <img src={hastelloy} alt="Hastelloy Plates" className="main-image" />
            </div>
          ...
          <section className="product-content">
            <div className="content-header">
              <h2>HASTELLOY PLATES: UNMATCHED CORROSION RESISTANCE FOR AGGRESSIVE CHEMICAL ENVIRONMENTS</h2>
              <p>Hastelloy C276 (UNS N10276) is a nickel‑molybdenum‑chromium alloy with tungsten additions, known for exceptional resistance to pitting, crevice corrosion, and stress corrosion cracking (SCC) in both oxidizing and reducing media. With a high molybdenum (15‑17%) and chromium (14.5‑16.5%) content, combined with tungsten (3‑4.5%), Hastelloy C276 offers outstanding performance in the most severe chemical processing applications, including chlorination, pollution control, and pharmaceutical industries. The low carbon content (0.02% max) ensures excellent weldability and resistance to sensitization.</p>
              <hr />
              <h3>KEY FEATURES OF HASTELLOY C276 PLATES</h3>
              ...
              <p>Our Hastelloy C276 plates conform to international standards including <strong>ASTM B575 / ASME SB575</strong> (standard specification for nickel‑molybdenum‑chromium‑tungsten alloy plate, sheet, and strip). We supply plates in various finishes (No.1, 2B, BA, No.4, HL, Mirror) and can custom‑cut to your exact dimensions.</p>
            </div>
          </section>

          <section className="specification-section">
            <h2>Specification: Hastelloy C276 Plates</h2>
          ...
          <section className="stock-section">
            <div className="stock-container">
              <div className="stock-heading">
                <h2>READY STOCK AVAILABILITY – HASTELLOY C276 PLATES</h2>
              </div>
          ...
          <section className="grades-section">
            <div className="container">
              <div className="section-title">
                <h2>EQUIVALENT GRADES: HASTELLOY C276</h2>
              </div>
          ...
          <section className="chemical-section">
            <div className="container">
              <div className="section-title">
                <h2>CHEMICAL COMPOSITION OF HASTELLOY C276 PLATES</h2>
              </div>
              <div className="table-responsive">
          ...
          <section className="mechanical-section">
            <div className="container">
              <div className="section-title">
                <h2>MECHANICAL PROPERTIES OF HASTELLOY C276 PLATES</h2>
              </div>
              <div className="table-responsive">
          ...
          <section className="thickness-section">
            <div className="container">
              <div className="section-title">
                <h2>
                  SIZE RANGE AVAILABILITY: HASTELLOY C276 PLATES
                  <span>(ASTM B575 / SB575)</span>
                </h2>
          ...
          <section className="coil-weight-section">
            <div className="container">
              <div className="section-title">
                <h2>UNIFIED WEIGHT CHART: HASTELLOY C276 PLATES</h2>
              </div>
              <div className="table-responsive">
          ...
          <section className="finish-weight-section">
            <div className="container">
              <div className="section-title">
                <h2>HASTELLOY C276 PLATE SUPPLY RANGE (UNIFIED)</h2>
          ...
          <section className="gauge-chart-section">
            <div className="container">
              <div className="section-title">
                <h2>UNIFIED HASTELLOY C276 PLATE PRICE RANGE</h2>
              </div>
              <div className="table-responsive">
          ...
          <section className="specialty-weight-section">
            <div className="container">
              <div className="section-title">
                <h2>SPECIALIZED IN FOLLOWING HASTELLOY C276 PLATES</h2>
              </div>
              <div className="table-responsive">
          ...
          <section className="tolerance-section">
            <div className="container">
              <div className="section-title">
                <h2>SEARCHES RELATED TO HASTELLOY C276 PLATES</h2>
              </div>
              <div className="table-responsive">
...
export default HastelloyPlatesDetails;