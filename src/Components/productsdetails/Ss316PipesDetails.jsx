...
import ss316Seamless from "../../products-image/ss-nimonic-pipes.webp";
import ss316Welded from "../../products-image/ss-nitronic-pipes.webp";
import ss316Erw from "../../products-image/ss-nichrome-pipes.webp";
import ss316Efw from "../../products-image/ss-nilo42-pipes.webp";
import ss316Ubo from "../../products-image/ss-alloy-a286-pipes.webp";
import ss316Special from "../../products-image/ss-alloy-926-pipes.webp";

import ss316 from "../../products-image/stainless-steel-316-316l-pipes.webp";
...
const stockData = [
  ...
  {
    title: "SS 316 / 316L UBO PIPES",
    image: ss316Ubo,
    items: [
      "SS 316 / 316L UBO Pipes",
      "Unified Bare Outer Pipes",
      "Excellent Resistance to Pitting & Crevice Corrosion",
      "For Chemical & Marine Applications",
    ],
  },
  {
    title: "SS 316 / 316L SPECIALTY PIPES",
    image: ss316Special,
    items: [
      "SS 316 / 316L Stainless Steel",
      "Molybdenum (2-3%) for Improved Pitting Resistance",
      "Low Carbon 316L for Enhanced Weldability",
...
const chemicalData = [
  {
    ...
    ni: "10.0 – 14.0",
    mo: "2.0 – 3.0",
    other: "Fe: Balance, P: 0.045 max, S: 0.03 max",
  },
  {
    grade: "SS 316L",
    c: "0.03 max",
...
const leftItems = [
  "SS 316 / 316L Seamless & Welded Pipes",
  "SS 316 / 316L ERW & EFW Pipes",
  "ASTM A312 / A358 / A269 Compliant",
  "Molybdenum Content for Enhanced Pitting Resistance",
  "Low Carbon 316L for Welding Without Sensitization",
  "SS 316 / 316L Pipes Manufacturer in India",
];

const rightItems = [
  "ASTM A312 / A358 / A269 SS 316 / 316L Pipes",
  ...
  "SS 316 / 316L Hollow Section & Square Pipes",
  "SS 316 / 316L Pipe Supplier in Mumbai",
];

const searchTerms = [
  "SS 316 Pipe Price Per Kg",
  "SS 316L Pipe Price Per Kg",
  "SS 316 Seamless Pipe Weight Chart",
  "SS 316L Pipe Supplier In India",
  "SS 316 Chemical Composition",
  "SS 316L UNS S31603",
  "SS 316 Pipe Price In Mumbai",
  "SS 316L Pipe Dimensions",
  "SS 316 vs 316L Difference",
  "SS 316L Pipe Specifications Pdf",
  "SS 316 Pipe Weight Calculator",
  "SS 316 Mechanical Properties",
  "SS 316L Pipe Stockist",
  "SS 316 Heat Treatment",
  "SS 316L Pipe Price Per Kg In India",
  "SS 316 Seamless Pipe Exporter",
  "SS 316L Welded Pipe Supplier",
  "SS 316 Pipe Schedule",
  "SS 316L Equivalent Grades",
  "UNS S31600 / S31603",
  "1.4401 / 1.4404",
  "SS 316 Pipe Manufacturers In Mumbai",
  "Buy SS 316 Pipes In India",
];
...
const Ss316PipesDetails = () => {
  return (
    <>
        <Helmet>
            <title>SS 316 / 316L Pipes Supplier – Stainless Steel 316 / 316L Pipes</title>
            <meta
            name="description"
            content="Supplier of Stainless Steel 316 / 316L pipes (UNS S31600 / S31603) with excellent pitting resistance and weldability. Seamless, welded, ERW, EFW pipes available."
            />
        </Helmet>
      ...
      <div className="product-details-container">
        ...
        <section className="product-content">
            <div className="content-header">
                <h1>SS 316 / 316L PIPES SUPPLIER – STAINLESS STEEL 316 / 316L PIPES</h1>
            </div>
            <div className="content-image">
                <img src={ss316} alt="SS 316 / 316L Pipes" className="main-image" />
            </div>
        ...
        <section className="product-content">
            <div className="content-header">
                <h2>SS 316 / 316L PIPES: EXCELLENT CORROSION RESISTANCE AND WELDABILITY</h2>
                <p>Stainless Steel 316 and 316L are austenitic stainless steels containing molybdenum (2‑3%), which provides superior resistance to pitting and crevice corrosion in chloride‑containing environments. Grade 316 (UNS S31600) is the standard version with a carbon content of 0.08% max, while 316L (UNS S31603) has a low carbon content (0.03% max) to prevent sensitization during welding, ensuring excellent corrosion resistance in the heat‑affected zone. These grades are widely used in chemical processing, marine, pharmaceutical, and food industries.</p>
                <hr/>
                <h3>KEY FEATURES OF SS 316 / 316L PIPES</h3>
                <p><strong>Molybdenum Addition</strong> – Provides enhanced resistance to pitting and crevice corrosion in chloride‑rich media.</p>
                <p><strong>Low Carbon 316L</strong> – Prevents carbide precipitation during welding, maintaining corrosion resistance without post‑weld heat treatment.</p>
                <p><strong>Excellent Weldability</strong> – Both grades can be welded using standard techniques, with 316L being preferred for heavy‑section welds.</p>
                <hr/>
                <h3>DIFFERENCE BETWEEN 316 AND 316L</h3>
                <p>The primary difference is the carbon content. 316L has a lower maximum carbon content (0.03% vs 0.08% for 316), which reduces the risk of sensitization. For applications involving welding or high‑temperature service, 316L is often preferred. For non‑welded applications or where post‑weld heat treatment is possible, 316 is also suitable.</p>
                <hr/>
                <h3>SPECIFICATIONS & STANDARDS</h3>
                <p>Our SS 316 / 316L pipes conform to international standards including <strong>ASTM A312</strong> (seamless and welded), <strong>ASTM A358</strong> (welded), <strong>ASTM A269</strong> (seamless and welded tubes), and <strong>ASME SA312 / SA358</strong>. Available in seamless, welded, ERW, and EFW forms with custom schedules and lengths.</p>
            </div>
        </section>
    ...
    <h2>Specification: SS 316 / 316L Pipes</h2>

    <div className="spec-grid">

        <div className="spec-card">
            <h4>Standard</h4>
            <p>ASTM A312 / A358 / A269, ASME SA312 / SA358 / SA269</p>
        </div>
    ...
    <section className="stock-section">
      <div className="stock-container">
        ...
        <div className="stock-heading">
          <h2>READY STOCK AVAILABILITY – SS 316 / 316L PIPES</h2>
        </div>
    ...
    <section className="grades-section">
      <div className="container">
        ...
        <div className="section-title">
          <h2>EQUIVALENT GRADES: SS 316 / 316L</h2>
        </div>
    ...
    <section className="chemical-section">
      <div className="container">
        ...
        <div className="section-title">
          <h2>CHEMICAL COMPOSITION OF SS 316 / 316L PIPES</h2>
        </div>
    ...
    <section className="mechanical-section">
      <div className="container">
        ...
        <div className="section-title">
          <h2>MECHANICAL PROPERTIES OF SS 316 / 316L PIPING</h2>
        </div>
    ...
    <section className="thickness-section">
      <div className="container">
        ...
        <div className="section-title">
          <h2>
            SIZE RANGE AVAILABILITY: SS 316 / 316L PIPES
            <span>(ASTM A312 / A358 / A269)</span>
          </h2>
    ...
    <section className="coil-weight-section">
      <div className="container">
        ...
        <div className="section-title">
          <h2>UNIFIED WEIGHT CHART: SS 316 / 316L PIPES</h2>
        </div>
    ...
    <section className="finish-weight-section">
      <div className="container">
        ...
        <div className="section-title">
          <h2>SS 316 / 316L PIPE SUPPLY RANGE (UNIFIED)</h2>
    ...
    <section className="gauge-chart-section">
      <div className="container">
        ...
        <div className="section-title">
          <h2>UNIFIED SS 316 / 316L PIPE PRICE RANGE</h2>
        </div>
    ...
    <section className="specialty-weight-section">
      <div className="container">
        ...
        <div className="section-title">
          <h2>SPECIALIZED IN FOLLOWING SS 316 / 316L PIPES</h2>
        </div>
    ...
    <section className="tolerance-section">
      <div className="container">
        ...
        <div className="section-title">
          <h2>SEARCHES RELATED TO SS 316 / 316L PIPES</h2>
        </div>
...
export default Ss316PipesDetails;
