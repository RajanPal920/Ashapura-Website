...
import cupronickelSeamless from "../../products-image/ss-seamless-copper.webp";
import cupronickelWelded from "../../products-image/ss-welded-copper.webp";
import cupronickelErw from "../../products-image/ss-erw-copper.webp";
import cupronickelEfw from "../../products-image/ss-round-copper.webp";
import cupronickelUbo from "../../products-image/ss-square-copper.webp";
import cupronickelSpecial from "../../products-image/ss-hollow-copper.webp";
...
const stockData = [
  {
    title: "COPPER NICKEL 70/30 SEAMLESS PIPES",
    image: cupronickelSeamless,
    items: [
      "Cupro Nickel 70/30 Seamless Pipes",
      "ASTM B466 UNS C71500",
      "Superior Seawater Corrosion Resistance",
      "High Strength & Erosion Resistance",
    ],
  },
  {
    title: "COPPER NICKEL 70/30 WELDED PIPES",
    image: cupronickelWelded,
    items: [
      "Cupro Nickel 70/30 Welded Pipes",
      "ASTM B467 UNS C71500",
      "Longitudinal & Spiral Welded",
      "Industrial Process Piping",
    ],
  },
  {
    title: "COPPER NICKEL 70/30 ERW PIPES",
    image: cupronickelErw,
    items: [
      "Cupro Nickel 70/30 ERW Pipes",
  ...
  {
    title: "COPPER NICKEL 70/30 EFW PIPES",
    image: cupronickelEfw,
    items: [
      "Cupro Nickel 70/30 EFW Pipes",
  ...
  {
    title: "COPPER NICKEL 70/30 UBO PIPES",
    image: cupronickelUbo,
    items: [
      "Cupro Nickel 70/30 UBO Pipes",
      "Unified Bare Outer Pipes",
      "Excellent Resistance to Biofouling & Erosion",
      "For Offshore & Marine",
    ],
  },
  {
    title: "COPPER NICKEL 70/30 SPECIALTY PIPES",
    image: cupronickelSpecial,
    items: [
      "Copper Nickel 70/30 (C71500)",
      "Ni 30% & Fe 0.7% for Enhanced Strength",
...
const leftItems = [
  "Copper Nickel 70/30 Seamless & Welded Pipes",
  "Copper Nickel 70/30 ERW & EFW Pipes",
  "ASTM B466 / B467 Compliant",
  "Excellent Resistance to Seawater & Biofouling",
  "Higher Strength & Erosion Resistance than 90/10",
  "Copper Nickel 70/30 Pipes Manufacturer in India",
];

const rightItems = [
  "ASTM B466 / B467 Copper Nickel 70/30 Pipes",
  ...
  "Cupro Nickel Hollow Section & Square Pipes",
  "Copper Nickel 70/30 Pipe Supplier in Mumbai",
];

const searchTerms = [
  "Copper Nickel 70/30 Pipe Price Per Kg",
  "Cupro Nickel 70/30 Seamless Pipe Weight Chart",
  "Copper Nickel 70/30 Pipe Supplier In India",
  "UNS C71500 Chemical Composition",
  "Cupro Nickel 70/30 Pipe Pressure Rating",
  "Copper Nickel 70/30 Pipe Price In Mumbai",
  "CuNi 70/30 Pipe Dimensions",
  "Copper Nickel 70/30 Pipe Specifications Pdf",
  "C71500 Corrosion Resistance",
  "Copper Nickel 70/30 Pipe Price List",
  "Cupro Nickel 70/30 Pipe Weight Calculator",
  "Copper Nickel 70/30 Pipe Mechanical Properties",
  "Cupro Nickel 70/30 Pipe Stockist",
  "Copper Nickel 70/30 Heat Treatment",
  "Copper Nickel 70/30 Pipe Price Per Kg In India",
  "C71500 Seamless Pipe Exporter",
  "Cupro Nickel 70/30 Welded Pipe Supplier",
  "Copper Nickel 70/30 Pipe Schedule",
  "Cupro Nickel 70/30 Equivalent Grades",
  "Copper Nickel UNS C71500",
  "CuNi 70/30 2.0882",
  "Copper Nickel 70/30 Pipe Manufacturers In Mumbai",
  "Buy Copper Nickel 70/30 Pipes In India",
];
...
const CopperNickel7030PipesDetails = () => {
  return (
    <>
        <Helmet>
            <title>Copper Nickel 70/30 Pipes Supplier – UNS C71500 Cupro Nickel Alloy Pipes</title>
            <meta
            name="description"
            content="Supplier of Copper Nickel 70/30 pipes (UNS C71500, 2.0882) with exceptional resistance to seawater, biofouling, and erosion. Higher strength than 90/10. Seamless, welded, ERW, EFW pipes available."
            />
        </Helmet>
        ...
        <Banner
            title="COPPER NICKEL 70/30 PIPES"
            image={ProductBanner}
        />
      ...
      <div className="product-details-container">
        ...
        <section className="product-content">
            <div className="content-header">
                <h1>COPPER NICKEL 70/30 PIPES SUPPLIER – CUPRO NICKEL ALLOY PIPES</h1>
            </div>
            <div className="content-image">
                <img src={copperNickel7030} alt="Copper Nickel 70/30 Pipes" className="main-image" />
            </div>
        ...
        <section className="product-content">
            <div className="content-header">
                <h2>COPPER NICKEL 70/30 PIPES: SUPERIOR EROSION RESISTANCE FOR DEMANDING MARINE SERVICE</h2>
                <p>Copper Nickel 70/30 (UNS C71500) is a high‑performance copper‑nickel alloy containing 30% nickel and a controlled iron content. This composition provides outstanding resistance to seawater corrosion, erosion, and cavitation, making it the preferred material for critical marine applications where higher flow velocities are encountered. The 70/30 alloy offers improved strength and erosion resistance compared to the 90/10 grade, ensuring long‑term reliability in heat exchangers, condensers, and desalination plants.</p>
                <hr/>
                <h3>KEY FEATURES OF COPPER NICKEL 70/30 PIPES</h3>
                <p><strong>Superior Erosion Resistance</strong> – Withstands higher seawater flow velocities and turbulent conditions better than 90/10, making it ideal for applications with aggressive flow regimes.</p>
                <p><strong>Natural Biofouling Resistance</strong> – The copper content imparts a natural anti‑fouling property, reducing the attachment of marine organisms and lowering maintenance costs.</p>
                <p><strong>High Strength & Toughness</strong> – Higher nickel content provides increased mechanical strength, allowing for thinner walls and weight savings in some applications.</p>
                <hr/>
                <h3>SPECIFICATIONS & STANDARDS</h3>
                <p>Our Copper Nickel 70/30 pipes conform to international standards including <strong>ASTM B466</strong> (seamless), <strong>ASTM B467</strong> (welded), <strong>ASTM B111</strong> (seamless tubes), and <strong>ASME SB466 / SB467</strong>. Available in seamless, welded, ERW, and EFW forms with custom schedules and lengths.</p>
            </div>
        </section>
    ...
    <h2>Specification: Copper Nickel 70/30 Pipes</h2>

    <div className="spec-grid">

        <div className="spec-card">
            <h4>Standard</h4>
            <p>ASTM B466 / B467 / B111, ASME SB466 / SB467 / SB111</p>
        </div>
    ...
    <section className="stock-section">
      <div className="stock-container">
        ...
        <div className="stock-heading">
          <h2>READY STOCK AVAILABILITY – COPPER NICKEL 70/30 PIPES</h2>
        </div>
    ...
    <section className="grades-section">
      <div className="container">
        ...
        <div className="section-title">
          <h2>EQUIVALENT GRADES: COPPER NICKEL 70/30</h2>
        </div>
    ...
    <section className="chemical-section">
      <div className="container">
        ...
        <div className="section-title">
          <h2>CHEMICAL COMPOSITION OF COPPER NICKEL 70/30 PIPES</h2>
        </div>
    ...
    <section className="mechanical-section">
      <div className="container">
        ...
        <div className="section-title">
          <h2>MECHANICAL PROPERTIES OF COPPER NICKEL 70/30 PIPING</h2>
        </div>
    ...
    <section className="thickness-section">
      <div className="container">
        ...
        <div className="section-title">
          <h2>
            SIZE RANGE AVAILABILITY: COPPER NICKEL 70/30 PIPES
            <span>(ASTM B466 / B467)</span>
          </h2>

          <p>
            Available in Seamless, Welded, ERW, EFW
          </p>
        </div>
    ...
    <section className="coil-weight-section">
      <div className="container">
        ...
        <div className="section-title">
          <h2>UNIFIED WEIGHT CHART: COPPER NICKEL 70/30 PIPES</h2>
        </div>
    ...
    <section className="finish-weight-section">
      <div className="container">
        ...
        <div className="section-title">
          <h2>COPPER NICKEL 70/30 PIPE SUPPLY RANGE (UNIFIED)</h2>
    ...
    <section className="gauge-chart-section">
      <div className="container">
        ...
        <div className="section-title">
          <h2>UNIFIED COPPER NICKEL 70/30 PIPE PRICE RANGE</h2>
        </div>
    ...
    <section className="specialty-weight-section">
      <div className="container">
        ...
        <div className="section-title">
          <h2>SPECIALIZED IN FOLLOWING COPPER NICKEL 70/30 PIPES</h2>
        </div>
    ...
    <section className="tolerance-section">
      <div className="container">
        ...
        <div className="section-title">
          <h2>SEARCHES RELATED TO COPPER NICKEL 70/30 PIPES</h2>
        </div>
...
export default CopperNickel7030PipesDetails;