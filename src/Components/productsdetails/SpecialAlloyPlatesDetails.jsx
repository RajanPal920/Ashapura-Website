...
// Replace these image paths with your actual Special Alloy Plates product images
...
import specialPlates from "../../products-image/ss-special-alloy-plates.webp"; 
...
const gradesData = [
  { grade: "Nimonic 75", uns: "N06075", werkstoff: "2.4951 / 2.4630", standard: "ASTM B168 / ASME SB168" },
  ...
  { grade: "Nitronic 50 / XM-19", uns: "S20910", werkstoff: "—", standard: "ASTM B168 / ASME SB168" },
  { grade: "Nilo 42", uns: "K94100", werkstoff: "1.3917", standard: "ASTM B168 / ASME SB168" },
  { grade: "Nilo 48", uns: "K94800", werkstoff: "1.7745", standard: "ASTM B168 / ASME SB168" },
  { grade: "Alloy A286 (660)", uns: "S66286", werkstoff: "1.4980", standard: "ASTM B670 / ASME SB670" },
  { grade: "Alloy 926", uns: "N08926", werkstoff: "1.4529", standard: "ASTM B670 / ASME SB670" },
];
...
const mechanicalData = [
  { grade: "Nimonic 75 / 80A", tensile: "104,000 psi", yield: "40,000 psi", elongation: "42%", density: "8.37 g/cm³" },
  { grade: "Nichrome 80/20", tensile: "650 MPa", yield: "280 MPa", elongation: "20%", density: "8.4 g/cm³" },
  { grade: "Nitronic 50", tensile: "100 ksi", yield: "55 ksi", elongation: "35%", density: "7.9 g/cm³" },
...
// Thickness and weight charts adapted for plates (similar to previous plate pages)
const leftThickness = [
...
// Approx weights for alloy plates (average density ~8.0 g/cm³)
const leftData = [
...
const leftItems = [
  "Nimonic 75 / 80A Plates & Sheets",
  "Nichrome 80/20 Resistance Alloy Plates",
  "Nitronic 50 (XM-19) High Strength Plates",
  "Nilo 42 / 48 Controlled Expansion Alloy Plates",
  "Alloy A286 (660) Iron-Based Superalloy Plates",
  "Alloy 926 Super-Austenitic Corrosion Plates",
  "Special Alloy Plates Manufacturer in India",
];

const rightItems = [
  "ASTM B168 / B670 / B409 / B443 / B575 Specialty Plates",
  "Hot Rolled / Cold Rolled Alloy Plates",
  "Custom Sizes, Thicknesses, and Cut-to-Length Supply",
  "Annealed / Solution Treated / Age Hardened Plates",
  "Electropolished & Precision Cut Sheets",
  "Special Alloy Hollow Section & Circles",
  "Special Alloy Plate Supplier in Mumbai",
];

const searchTerms = [
  "Nimonic 75 Plate Price Per Kg",
  "Nimonic 80A Alloy Plate Weight Chart",
  "Nichrome 80/20 Plate Supplier In India",
  "Nitronic 50 Plate Chemical Composition",
  "Nitronic 50 XM-19 Plate Price",
  "Nilo 42 Plate Price In Mumbai",
  "Nilo 48 Expansion Plate Dimensions",
  "Alloy A286 Plate Specifications Pdf",
  "Alloy 926 Plate Corrosion Resistance",
  "Nimonic 75 / 80A Plate Price List",
  "Nichrome 80/20 Plate Weight Calculator",
  "Nitronic 50 Plate Mechanical Properties",
  "Nilo 42 / 48 Plate Stockist",
  "Alloy A286 Plate Heat Treatment",
  "Alloy 926 Plate Price Per Kg In India",
  "Special Alloy Plate Exporter",
  "Special Alloy Plate Supplier",
  "Nimonic 75 Plate Dimensions",
  "Nichrome 80/20 Plate Sizes",
  "Nitronic 50 Plate Schedule",
  "Nilo 42 Plate Equivalent Grades",
  "Alloy A286 Plate UNS S66286",
  "Alloy 926 Plate 1.4529",
  "Special Alloy Plate Manufacturers In Mumbai",
  "Buy Special Alloy Plates In India",
];
...
const SpecialPlatesDetails = () => {
  return (
    <>
      <Helmet>
        <title>Special Alloy Plates Supplier, Stockist & Exporter</title>
        <meta
          name="description"
          content="Leading supplier of Special Alloy Plates including Nimonic, Nichrome, Nitronic, Nilo, Alloy 286, Alloy 926. Available in sheets, coils, circles, and custom sizes. ASTM compliant for high-temperature and corrosive applications."
        />
      </Helmet>
      ...
      <div className="product-details-container">
        <div className="product-main-content">
          <section className="product-content">
            <div className="content-header">
              <h1>SPECIAL ALLOY PLATES SUPPLIER – NIMONIC, NICHROME, NITRONIC, NILO & ALLOY</h1>
            </div>
            <div className="content-image">
              <img src={specialPlates} alt="Special Alloy Plates" className="main-image" />
            </div>
          ...
          <section className="product-content">
            <div className="content-header">
              <h2>SPECIAL ALLOY PLATES – ENGINEERED FOR EXTREME CONDITIONS</h2>
              <p>
                Our comprehensive range of <strong>Special Alloy Plates</strong> covers a wide spectrum of high-performance materials, including <strong>Nimonic 75/80A</strong>, <strong>Nichrome 80/20</strong>, <strong>Nitronic 50 (XM-19)</strong>, <strong>Nilo 42/48</strong>, <strong>Alloy A286 (660)</strong>, and <strong>Alloy 926</strong>. These alloys are specifically engineered for demanding applications requiring exceptional resistance to high temperatures, oxidation, corrosion, and mechanical stress. Whether you need creep-resistant plates for gas turbine components, controlled expansion alloys for precision instruments, or super-austenitic plates for aggressive chemical environments, our specialty plates deliver reliable performance in the most challenging industrial settings.
              </p>
              <hr />
              <h3>HOT ROLLED & COLD ROLLED ALLOY PLATES</h3>
              <p>
                We supply special alloy plates in <strong>hot rolled</strong> and <strong>cold rolled</strong> conditions, available in thicknesses from 0.5 mm to 150 mm, widths up to 2500 mm, and lengths up to 6000 mm. Our inventory includes annealed, solution-treated, and age-hardened plates to meet the stringent specifications of the aerospace, power generation, chemical processing, and marine industries.
              </p>
              <h3>APPLICATIONS & ADVANTAGES</h3>
              <p>
                These specialty alloys are the material of choice for critical applications in <strong>aerospace</strong> (turbine discs, combustors), <strong>power generation</strong> (gas turbine components), <strong>chemical processing</strong> (reactors, vessels), <strong>marine engineering</strong> (propeller shafts, heat exchangers), and <strong>precision instrumentation</strong> (Nilo alloys for glass-to-metal seals). Their unique combination of properties ensures reliable service under extreme temperatures, corrosive media, and high mechanical loads.
              </p>
              <hr />
              <h3>COMPLIANCE & STANDARDS</h3>
              <p>
                Our special alloy plates are manufactured and tested in accordance with <strong>ASTM / ASME</strong> specifications, including <strong>ASTM B168, B670, B409, B443, B575</strong> and their ASME equivalents. We provide comprehensive mill test certificates, PMI reports, ultrasonic inspection, and third-party inspection services to ensure full traceability and quality assurance.
              </p>
            </div>
          </section>

          <section className="specification-section">
            <h2>UNIFIED SPECIFICATION: SPECIAL ALLOY PLATES</h2>
            <div className="spec-grid">
              <div className="spec-card">
                <h4>Standard</h4>
                <p>ASTM / ASME B168, B670, B409, B443, B575</p>
              </div>
              <div className="spec-card">
          ...
          <section className="stock-section">
            <div className="stock-container">
              <div className="stock-heading">
                <h2>READY STOCK AVAILABILITY – SPECIAL ALLOY PLATES</h2>
              </div>
          ...
          <section className="chemical-section">
            <div className="container">
              <div className="section-title">
                <h2>CHEMICAL COMPOSITION OF SPECIAL ALLOY PLATES</h2>
              </div>
              <div className="table-responsive">
          ...
          <section className="mechanical-section">
            <div className="container">
              <div className="section-title">
                <h2>MECHANICAL PROPERTIES OF SPECIAL ALLOY PLATES</h2>
              </div>
              <div className="table-responsive">
          ...
          <section className="thickness-section">
            <div className="container">
              <div className="section-title">
                <h2>
                  THICKNESS RANGE AVAILABILITY: SPECIAL ALLOY PLATES
                  <span>(ASTM / ASME B168, B670, B409, etc.)</span>
                </h2>
          ...
          <section className="coil-weight-section">
            <div className="container">
              <div className="section-title">
                <h2>UNIFIED WEIGHT CHART: SPECIAL ALLOY PLATES</h2>
              </div>
              <div className="table-responsive">
          ...
          <section className="finish-weight-section">
            <div className="container">
              <div className="section-title">
                <h2>SPECIAL ALLOY PLATE SUPPLY RANGE (UNIFIED)</h2>
          ...
          <section className="gauge-chart-section">
            <div className="container">
              <div className="section-title">
                <h2>UNIFIED SPECIAL ALLOY PLATE PRICE RANGE</h2>
              </div>
              <div className="table-responsive">
          ...
          <section className="specialty-weight-section">
            <div className="container">
              <div className="section-title">
                <h2>SPECIALIZED IN FOLLOWING SPECIAL ALLOY PLATES</h2>
              </div>
              <div className="table-responsive">
          ...
          <section className="tolerance-section">
            <div className="container">
              <div className="section-title">
                <h2>SEARCHES RELATED TO SPECIAL ALLOY PLATES</h2>
              </div>
              <div className="table-responsive">
        ...
        <div className="product-sidebar-wrapper">
          ...
          <div className="quote-card">
            <h2>GET A QUOTE</h2>
            <p>Immediate pricing for Special Alloy Plates. Contact our sales team for bulk discounts and technical support.</p>
...
export default SpecialPlatesDetails;
