...
import ss310sSeamless from "../../products-image/ss-nimonic-pipes.webp";
import ss310sWelded from "../../products-image/ss-nitronic-pipes.webp";
import ss310sErw from "../../products-image/ss-nichrome-pipes.webp";
import ss310sEfw from "../../products-image/ss-nilo42-pipes.webp";
import ss310sUbo from "../../products-image/ss-alloy-a286-pipes.webp";
import ss310sSpecial from "../../products-image/ss-alloy-926-pipes.webp";

import ss310 from "../../products-image/stainless-steel-310s-pipes.webp";
...
const stockData = [
  {
    ...
    image: ss310sSeamless,
    items: [
      "Stainless Steel 310S Seamless Pipes",
      "ASTM A312 / ASME SA312",
      "UNS S31008 / 1.4845",
      "High-Temperature Service up to 1100°C",
    ],
  },
  {
    ...
    image: ss310sWelded,
    items: [
      "Stainless Steel 310S Welded Pipes",
  ...
  {
    title: "SS 310S UBO PIPES",
    image: ss310sUbo,
    items: [
      "SS 310S UBO Pipes",
      "Unified Bare Outer Pipes",
      "Superior Oxidation & Carburization Resistance",
      "For Furnace & Heat Treatment",
    ],
  },
  {
    title: "SS 310S SPECIALTY PIPES",
    image: ss310sSpecial,
    items: [
      "SS 310S High-Temperature Alloy",
      "High Chromium (24-26%) & Nickel (19-22%)",
...
const leftItems = [
  "Stainless Steel 310S Seamless & Welded Pipes",
  "SS 310S ERW & EFW Pipes",
  "ASTM A312 / A358 / A269 Compliant",
  "High Chromium & Nickel for Superior Oxidation Resistance",
  "Excellent Creep & Rupture Strength at Elevated Temperatures",
  "SS 310S Pipes Manufacturer in India",
];

const rightItems = [
  "ASTM A312 / A358 / A269 SS 310S Pipes",
  ...
  "SS 310S Hollow Section & Square Pipes",
  "SS 310S Pipe Supplier in Mumbai",
];

const searchTerms = [
  "SS 310S Pipe Price Per Kg",
  "Stainless Steel 310S Seamless Pipe Weight Chart",
  "310S Pipe Supplier In India",
  "SS 310S Chemical Composition",
  "310S Pipe Pressure Rating",
  "310S Pipe Price In Mumbai",
  "SS 310S Pipe Dimensions",
  "310S Pipe Specifications Pdf",
  "Stainless 310S High Temperature",
  "310S Pipe Price List",
  "310S Pipe Weight Calculator",
  "SS 310S Pipe Mechanical Properties",
  "310S Pipe Stockist",
  "310S Heat Treatment",
  "310S Pipe Price Per Kg In India",
  "SS 310S Seamless Pipe Exporter",
  "310S Welded Pipe Supplier",
  "310S Pipe Schedule",
  "310S Equivalent Grades",
  "UNS S31008",
  "1.4845",
  "SS 310S Pipe Manufacturers In Mumbai",
  "Buy SS 310S Pipes In India",
];
...
const Ss310SPipesDetails = () => {
  return (
    <>
        <Helmet>
            <title>SS 310S Pipes Supplier – Stainless Steel 310S (UNS S31008) High-Temperature Pipes</title>
            <meta
            name="description"
            content="Supplier of Stainless Steel 310S pipes (UNS S31008, 1.4845) with exceptional oxidation resistance and high-temperature strength up to 1100°C. Seamless, welded, ERW, EFW pipes available."
            />
        </Helmet>
      ...
      <div className="product-details-container">
        ...
        <section className="product-content">
            <div className="content-header">
                <h1>SS 310S PIPES SUPPLIER – STAINLESS STEEL 310S (UNS S31008) HIGH-TEMPERATURE PIPES</h1>
            </div>
            <div className="content-image">
                <img src={ss310} alt="SS 310S Pipes" className="main-image" />
            </div>
        ...
        <section className="product-content">
            <div className="content-header">
                <h2>SS 310S PIPES: EXCEPTIONAL HIGH-TEMPERATURE OXIDATION RESISTANCE</h2>
                <p>Stainless Steel 310S (UNS S31008) is a high‑alloy austenitic stainless steel with a high chromium (24‑26%) and nickel (19‑22%) content. This composition provides outstanding resistance to oxidation and carburization at temperatures up to 1100°C in continuous service and 1035°C in intermittent service. The low carbon content (0.08% max) ensures good weldability and reduces the risk of sensitization. 310S is the ideal material for furnace components, heat‑treating equipment, and thermal processing applications.</p>
                <hr/>
                <h3>KEY FEATURES OF SS 310S PIPES</h3>
                <p><strong>Superior High‑Temperature Strength</strong> – Maintains excellent creep and rupture strength at elevated temperatures, suitable for load‑bearing applications.</p>
                <p><strong>Outstanding Oxidation Resistance</strong> – Forms a tenacious chromium‑oxide scale that protects the metal from oxidation and scaling up to 1100°C.</p>
                <p><strong>Resistance to Carburization & Nitriding</strong> – Performs well in carbon‑rich and nitrogen‑rich atmospheres, common in heat‑treating and petrochemical industries.</p>
                <hr/>
                <h3>SPECIFICATIONS & STANDARDS</h3>
                <p>Our SS 310S pipes conform to international standards including <strong>ASTM A312</strong> (seamless and welded), <strong>ASTM A358</strong> (welded), <strong>ASTM A269</strong> (seamless and welded tubes), and <strong>ASME SA312 / SA358</strong>. Available in seamless, welded, ERW, and EFW forms with custom schedules and lengths.</p>
            </div>
        </section>
    ...
    <h2>Specification: SS 310S Pipes</h2>
    ...
    <section className="stock-section">
      <div className="stock-container">
        ...
        <div className="stock-heading">
          <h2>READY STOCK AVAILABILITY – SS 310S PIPES</h2>
        </div>
    ...
    <section className="grades-section">
      <div className="container">
        ...
        <div className="section-title">
          <h2>EQUIVALENT GRADES: SS 310S</h2>
        </div>
    ...
    <section className="chemical-section">
      <div className="container">
        ...
        <div className="section-title">
          <h2>CHEMICAL COMPOSITION OF SS 310S PIPES</h2>
        </div>
    ...
    <section className="mechanical-section">
      <div className="container">
        ...
        <div className="section-title">
          <h2>MECHANICAL PROPERTIES OF SS 310S PIPING</h2>
        </div>
    ...
    <section className="thickness-section">
      <div className="container">
        ...
        <div className="section-title">
          <h2>
            SIZE RANGE AVAILABILITY: SS 310S PIPES
    ...
    <section className="coil-weight-section">
      <div className="container">
        ...
        <div className="section-title">
          <h2>UNIFIED WEIGHT CHART: SS 310S PIPES</h2>
        </div>
    ...
    <section className="finish-weight-section">
      <div className="container">
        ...
        <div className="section-title">
          <h2>SS 310S PIPE SUPPLY RANGE (UNIFIED)</h2>
    ...
    <section className="gauge-chart-section">
      <div className="container">
        ...
        <div className="section-title">
          <h2>UNIFIED SS 310S PIPE PRICE RANGE</h2>
        </div>
    ...
    <section className="specialty-weight-section">
      <div className="container">
        ...
        <div className="section-title">
          <h2>SPECIALIZED IN FOLLOWING SS 310S PIPES</h2>
        </div>
    ...
    <section className="tolerance-section">
      <div className="container">
        ...
        <div className="section-title">
          <h2>SEARCHES RELATED TO SS 310S PIPES</h2>
        </div>
...
export default Ss310SPipesDetails;
