...
import CoilsBanner from "../../products-image/ss-hastelloy-coils.webp";
...
const gradesData = [
  {
    ...
    uns: "N10276",
    werkstoff: "2.4819",
    standard: "NW 0276 / NiMo16Cr15W",
  },
  {
    grade: "Hastelloy C22",
    uns: "N06022",
    werkstoff: "2.4602",
    standard: "NW 6022 / NiCr21Mo14W / EP760",
  },
  {
    grade: "Hastelloy B2",
    uns: "N10665",
...
const mechanicalData = [
  ...
  {
    grade: "B3 / C2000 / C59 / C4",
    tensile: "1000 - 2000 MPa",
    yield: "—",
    elongation: "—",
    density: "9.22 g/cm³",
  },
...
const rightItems = [
  ...
  "Hastelloy Grade B2 Coil Stockist",
  "Best Price Hastelloy Coil Supplier in India",
...
const HastelloyCoilsDetails = () => {
  return (
    <>
        <Helmet>
            <title>Hastelloy Coils Supplier</title>
            <meta
            name="description"
            content="Supplier and stockist of Hastelloy coils including grades C276, C22, B2, B3, C2000, C59, C4, and HN for aggressive chemical environments."
            />
        </Helmet>
      ...
      <div className="product-details-container">
        ...
        <section className="product-content">
            <div className="content-header">
                <h1>HASTELLOY COILS SUPPLIER – C276, C22, B2, B3, C2000, C59, C4 &amp; HN</h1>
            </div>
            <div className="content-image">
                <img src={CoilsBanner} alt="Hastelloy Coils" className="main-image" />
            </div>
        ...
        <section className="product-content">
            <div className="content-header">
                <h2>HASTELLOY ALLOY COILS: TECHNICAL OVERVIEW AND MATERIAL PROPERTIES</h2>
                <p>Hastelloy coils are a family of high-performance nickel-based superalloys engineered for aggressive chemical environments. These alloys resist oxidizing and reducing acids, chlorides, and mixed chemical streams, making them essential in chemical processing, pollution control, and oil &amp; gas applications.</p>
                <hr/>
                <h3>HASTELLOY C-SERIES (C276, C22, C2000, C4, C59)</h3>
                <p><strong>Hastelloy C276 (UNS N10276):</strong> The industry standard for aggressive chemicals, especially wet chlorine gas, hypochlorites, and chlorine dioxide. It is widely used in FGD systems.</p>
                <p><strong>Hastelloy C22 (UNS N06022):</strong> Offers better overall corrosion resistance than C276 in oxidizing environments and superior protection against weld-zone attack and pitting.</p>
                <p><strong>Hastelloy C2000 (UNS N06200):</strong> Designed for flexibility, with added copper for excellent sulfuric acid resistance and mixed-stream performance.</p>
                <p><strong>Hastelloy C4 (UNS N06455):</strong> Offers high-temperature stability and resistance to grain-boundary precipitation. <strong>Hastelloy C59 (UNS N06059):</strong> A high-purity alloy with excellent thermal stability and resistance to pitting in halide media.</p>
                <h3>HASTELLOY B-SERIES (B2, B3)</h3>
                <p><strong>Hastelloy B2 (UNS N10665):</strong> A nickel-molybdenum alloy with significant resistance to reducing environments, ideal for pure hydrochloric, phosphoric, and sulfuric acids.</p>
                <p><strong>Hastelloy B3 (UNS N10675):</strong> An improved version of B2 offering the same high resistance to hydrochloric acid with better thermal stability and easier fabrication.</p>
                <h3>SPECIALIZED HASTELLOY GRADES (H-N / ALLOY N)</h3>
                <p><strong>Hastelloy N (UNS N10003):</strong> Also known as Alloy N, developed for molten fluoride salts and oxidation resistance up to 704°C (1300°F).</p>
                <hr/>
                <h3>INDUSTRIAL APPLICATIONS &amp; QUALITY</h3>
                <p>Used in chemical processing, pollution-control systems, and oil &amp; gas equipment where reliability under harsh conditions is essential. Our coils comply with strict quality control and come with complete testing and documentation.</p>
            </div>
        </section>
    ...
    <h2>Specification of Hastelloy Coils – C276, C22, B2, B3, C2000, C59, C4 &amp; HN</h2>
    ...
    <div className="spec-grid">
        ...
        <div className="spec-card">
            ...
            <p>Cutting, Polishing, Threading, Destructive &amp; NDT Testing</p>
        </div>
    ...
    <section className="stock-section">
      <div className="stock-container">
        ...
        <div className="stock-heading">
          <h2>STOCK AVAILABILITY OF HASTELLOY COILS</h2>
        </div>
    ...
    <section className="grades-section">
      <div className="container">
        ...
        <div className="section-title">
          <h2>EQUIVALENT GRADES OF HASTELLOY ALLOY COILS</h2>
        </div>
    ...
    <section className="chemical-section">
      <div className="container">
        ...
        <div className="section-title">
          <h2>CHEMICAL COMPOSITION OF HASTELLOY COILS</h2>
        </div>
    ...
    <section className="thickness-section">
      <div className="container">
        ...
        <div className="section-title">
          <h2>
            THICKNESS AVAILABILITY: HASTELLOY COILS
            <span>(ASTM B575 / ASME SB575)</span>
          </h2>

          <p>
            Available for Hastelloy C276, C22, B2, B3, C2000, C59, C4, and HN coils
          </p>
        </div>
    ...
    <section className="coil-weight-section">
      <div className="container">
        ...
        <div className="section-title">
          <h2>HASTELLOY C276 / C22 / B2 / B3 / C2000 COLD ROLLED COILS WEIGHT CHART</h2>
        </div>
    ...
    <section className="finish-weight-section">
      <div className="container">
        ...
        <div className="section-title">
          <h2>HASTELLOY ALLOY COIL STOCK AVAILABILITY (C276, C22, B2, B3, C2000)</h2>

          <p>
            ASTM SB575 / SB622 Hastelloy coils available in standard stock thicknesses
          </p>
        </div>
    ...
    <section className="gauge-chart-section">
      <div className="container">
        ...
        <div className="section-title">
          <h2>HASTELLOY COILS THICKNESS GAUGE CHART</h2>
        </div>
    ...
    <section className="specialty-weight-section">
      <div className="container">
        ...
        <div className="section-title">
          <h2>HASTELLOY COILS WEIGHT / SIZE CHART</h2>
        </div>
    ...
    <section className="tolerance-section">
      <div className="container">
        ...
        <div className="section-title">
          <h2>HASTELLOY COILS THICKNESS TOLERANCE</h2>
        </div>
    ...
    <section className="specialized-section">
      <div className="container">
        ...
        <div className="section-title orange-border">
          <h2>SPECIALIZED IN FOLLOWING HASTELLOY ALLOY COILS</h2>
        </div>
    ...
    <section className="searches-section">
      <div className="container">
        ...
        <div className="search-box">
          ...
          <div className="section-title">
            <h2>SEARCHES RELATED TO HASTELLOY ALLOY COILS</h2>
          </div>
...
export default HastelloyCoilsDetails;
