...
import smo254 from "../../products-image/ss-nimonic-pipes.webp";
import smo254Seamless from "../../products-image/ss-nitronic-pipes.webp";
import smo254Welded from "../../products-image/ss-nichrome-pipes.webp";
import smo254Erw from "../../products-image/ss-nilo42-pipes.webp";
import smo254Eff from "../../products-image/ss-alloy-a286-pipes.webp";
import smo254Ubo from "../../products-image/ss-alloy-926-pipes.webp";

import specialAlloy from "../../products-image/ss-smo-pipes.webp";
...
const stockData = [
  {
    ...
    image: smo254Seamless,
    items: [
      "SMO 254 Seamless Pipes",
      "ASTM A312 S31254 Seamless",
      "UNS S31254 / EN 1.4547",
      "High Pressure SMO 254 Pipes",
    ],
  },
  {
  ...
  {
    title: "SMO 254 SPECIALTY PIPES",
    image: smo254,
    items: [
      "SMO 254 Super Austenitic",
      "High Molybdenum 6%",
      "High Nitrogen & Copper",
      "For Severe Chloride Service",
    ],
  }
];
...
const leftItems = [
  "SMO 254 Seamless & Welded Pipes",
  "SMO 254 ERW & EFW Pipes",
  "ASTM A312 / A358 / A269 Compliant",
  "High Molybdenum (6%) Super Austenitic",
  "Excellent Pitting & Crevice Corrosion Resistance",
  "SMO 254 for Offshore & Marine Applications",
  "SMO 254 Pipes Manufacturer in India",
];

const rightItems = [
  "ASTM A312 / A358 / A269 / A270 SMO 254 Pipes",
  ...
  "SMO 254 Hollow Section & Square Pipes",
  "SMO 254 Pipe Supplier in Mumbai",
];

const searchTerms = [
  "SMO 254 Pipe Price Per Kg",
  "SMO 254 Seamless Pipe Weight Chart",
  "SMO 254 Pipe Supplier In India",
  "SMO 254 Chemical Composition",
  "SMO 254 Pipe Pressure Rating",
  "SMO 254 Pipe Price In Mumbai",
  "SMO 254 Pipe Dimensions",
  "SMO 254 Pipe Specifications Pdf",
  "SMO 254 Corrosion Resistance",
  "SMO 254 Pipe Price List",
  "SMO 254 Pipe Weight Calculator",
  "SMO 254 Pipe Mechanical Properties",
  "SMO 254 Pipe Stockist",
  "SMO 254 Pipe Heat Treatment",
  "SMO 254 Pipe Price Per Kg In India",
  "SMO 254 Seamless Pipe Exporter",
  "SMO 254 Welded Pipe Supplier",
  "SMO 254 Pipe Schedule",
  "SMO 254 Equivalent Grades",
  "SMO 254 UNS S31254",
  "SMO 254 1.4547",
  "SMO 254 Pipe Manufacturers In Mumbai",
  "Buy SMO 254 Pipes In India",
];
...
const SpecialAlloyPipesDetails = () => {
  return (
    <>
        <Helmet>
            <title>SMO 254 Pipes Supplier – Super Austenitic Stainless Steel Pipes</title>
            <meta
            name="description"
            content="Supplier of SMO 254 super austenitic stainless steel pipes (UNS S31254, 1.4547) for high chloride and corrosive environments. Seamless, welded, ERW, EFW pipes available."
            />
        </Helmet>
      ...
      <div className="product-details-container">
        ...
        <section className="product-content">
            <div className="content-header">
                <h1>SMO 254 PIPES SUPPLIER – SUPER AUSTENITIC STAINLESS STEEL PIPES</h1>
            </div>
            <div className="content-image">
                <img src={specialAlloy} alt="SMO 254 Pipes" className="main-image" />
            </div>
        ...
        <section className="product-content">
            <div className="content-header">
                <h2>SMO 254 PIPES: SUPER AUSTENITIC STAINLESS STEEL FOR EXTREME CORROSION SERVICE</h2>
                <p>SMO 254 (UNS S31254) is a high-alloy austenitic stainless steel with outstanding resistance to pitting, crevice corrosion, and stress corrosion cracking in chloride‑rich environments. With 6% molybdenum, high nitrogen, and copper, it outperforms standard 316L and 904L in seawater, chemical processing, and offshore applications.</p>
                <hr/>
                <h3>KEY FEATURES OF SMO 254 PIPES</h3>
                <p><strong>Excellent Pitting Resistance</strong> – PREN ≥ 43, making it ideal for high‑chloride media.</p>
                <p><strong>High Strength</strong> – Yield strength ~300 MPa, significantly higher than conventional austenitics.</p>
                <p><strong>Good Weldability</strong> – Can be welded with standard methods, with low carbon content to avoid sensitization.</p>
                <hr/>
                <h3>SPECIFICATIONS & STANDARDS</h3>
                <p>Our SMO 254 pipes conform to international standards including <strong>ASTM A312</strong> (seamless and welded), <strong>ASTM A358</strong> (welded), <strong>ASTM A269</strong> (tubing), and <strong>ASME SA312 / SA358</strong>. Available in seamless, welded, ERW, and EFW forms.</p>
            </div>
        </section>
    ...
    <h2>Specification: SMO 254 Pipes</h2>

    <div className="spec-grid">

        <div className="spec-card">
            <h4>Standard</h4>
            <p>ASTM A312 / A358 / A269 / A270, ASME SA312 / SA358</p>
        </div>
    ...
    <section className="stock-section">
      <div className="stock-container">
        ...
        <div className="stock-heading">
          <h2>READY STOCK AVAILABILITY – SMO 254 PIPES</h2>
        </div>
    ...
    <section className="grades-section">
      <div className="container">
        ...
        <div className="section-title">
          <h2>EQUIVALENT GRADES: SMO 254</h2>
        </div>
    ...
    <section className="chemical-section">
      <div className="container">
        ...
        <div className="section-title">
          <h2>CHEMICAL COMPOSITION OF SMO 254 PIPES</h2>
        </div>
    ...
    <section className="mechanical-section">
      <div className="container">
        ...
        <div className="section-title">
          <h2>MECHANICAL PROPERTIES OF SMO 254 PIPING</h2>
        </div>
    ...
    <section className="thickness-section">
      <div className="container">
        ...
        <div className="section-title">
          <h2>
            SIZE RANGE AVAILABILITY: SMO 254 PIPES
    ...
    <section className="coil-weight-section">
      <div className="container">
        ...
        <div className="section-title">
          <h2>UNIFIED WEIGHT CHART: SMO 254 PIPES</h2>
        </div>
    ...
    <section className="finish-weight-section">
      <div className="container">
        ...
        <div className="section-title">
          <h2>SMO 254 PIPE SUPPLY RANGE (UNIFIED)</h2>
    ...
    <section className="gauge-chart-section">
      <div className="container">
        ...
        <div className="section-title">
          <h2>UNIFIED SMO 254 PIPE PRICE RANGE</h2>
        </div>
    ...
    <section className="specialty-weight-section">
      <div className="container">
        ...
        <div className="section-title">
          <h2>SPECIALIZED IN FOLLOWING SMO 254 PIPES</h2>
        </div>
    ...
    <section className="tolerance-section">
      <div className="container">
        ...
        <div className="section-title">
          <h2>SEARCHES RELATED TO SMO 254 PIPES</h2>
        </div>
...
export default SpecialAlloyPipesDetails;
