...
import ss904lSeamless from "../../products-image/ss-nimonic-pipes.webp";
import ss904lWelded from "../../products-image/ss-nitronic-pipes.webp";
import ss904lErw from "../../products-image/ss-nichrome-pipes.webp";
import ss904lEfw from "../../products-image/ss-nilo42-pipes.webp";
import ss904lUbo from "../../products-image/ss-alloy-a286-pipes.webp";
import ss904lSpecial from "../../products-image/ss-alloy-926-pipes.webp";

import ss904l from "../../products-image/stainless-steel-904l-pipes.webp";
...
const stockData = [
  {
    ...
    image: ss904lSeamless,
    items: [
      "Stainless Steel 904L Seamless Pipes",
  ...
  },
  {
    ...
    image: ss904lWelded,
    items: [
      "Stainless Steel 904L Welded Pipes",
  ...
  },
  {
    ...
    image: ss904lErw,
    items: [
      "Stainless Steel 904L ERW Pipes",
  ...
  },
  {
    ...
    image: ss904lEfw,
    items: [
      "Stainless Steel 904L EFW Pipes",
  ...
  {
    title: "SS 904L UBO PIPES",
    image: ss904lUbo,
    items: [
      "Stainless Steel 904L UBO Pipes",
  ...
  {
    title: "SS 904L SPECIALTY PIPES",
    image: ss904lSpecial,
    items: [
      "Stainless Steel 904L (N08904)",
      "High Mo (4.5%) & Cu (1.5%)",
      "Resistant to Sulfuric & Phosphoric Acids",
...
const chemicalData = [
  {
    ...
    ni: "23.0 – 28.0",
    mo: "4.0 – 5.0",
    other: "Cu: 1.0-2.0, N: 0.10 max, Fe: Balance",
  }
];
...
const leftItems = [
  "Stainless Steel 904L Seamless & Welded Pipes",
  "SS 904L ERW & EFW Pipes",
  "ASTM B677 / B673 / B675 Compliant",
  "Excellent Resistance to Sulfuric & Phosphoric Acids",
  "High Molybdenum & Copper for Superior Pitting Resistance",
  "Stainless Steel 904L Pipes Manufacturer in India",
];

const rightItems = [
  "ASTM B677 / B673 / B675 SS 904L Pipes",
  ...
  "SS 904L Hollow Section & Square Pipes",
  "SS 904L Pipe Supplier in Mumbai",
];

const searchTerms = [
  "SS 904L Pipe Price Per Kg",
  "Stainless Steel 904L Seamless Pipe Weight Chart",
  "904L Pipe Supplier In India",
  "SS 904L Chemical Composition",
  "904L Pipe Pressure Rating",
  "904L Pipe Price In Mumbai",
  "SS 904L Pipe Dimensions",
  "904L Pipe Specifications Pdf",
  "Stainless 904L Corrosion Resistance",
  "904L Pipe Price List",
  "904L Pipe Weight Calculator",
  "SS 904L Pipe Mechanical Properties",
  "904L Pipe Stockist",
  "904L Heat Treatment",
  "904L Pipe Price Per Kg In India",
  "SS 904L Seamless Pipe Exporter",
  "904L Welded Pipe Supplier",
  "904L Pipe Schedule",
  "904L Equivalent Grades",
  "UNS N08904",
  "1.4539",
  "SS 904L Pipe Manufacturers In Mumbai",
  "Buy SS 904L Pipes In India",
];
...
const Ss904LPipesDetails = () => {
  return (
    <>
        <Helmet>
            <title>SS 904L Pipes Supplier – Stainless Steel 904L (UNS N08904) Pipes</title>
            <meta
            name="description"
            content="Supplier of Stainless Steel 904L pipes (UNS N08904, 1.4539) with exceptional resistance to sulfuric acid, phosphoric acid, and chloride stress corrosion cracking. Seamless, welded, ERW, EFW pipes available."
            />
        </Helmet>
      ...
      <div className="product-details-container">
        ...
        <section className="product-content">
            <div className="content-header">
                <h1>SS 904L PIPES SUPPLIER – STAINLESS STEEL 904L (UNS N08904) PIPES</h1>
            </div>
            <div className="content-image">
                <img src={ss904l} alt="SS 904L Pipes" className="main-image" />
            </div>
        ...
        <section className="product-content">
            <div className="content-header">
                <h2>SS 904L PIPES: SUPERIOR RESISTANCE TO SULFURIC ACID AND CHLORIDE CORROSION</h2>
                <p>Stainless Steel 904L (UNS N08904) is a high‑alloy austenitic stainless steel with a high nickel (23‑28%) and molybdenum (4‑5%) content, along with copper (1‑2%) addition. This composition provides outstanding resistance to sulfuric acid, phosphoric acid, and chloride‑induced stress corrosion cracking. With a low carbon content (0.02% max), 904L offers excellent weldability without sensitization, making it the ideal choice for chemical processing, petrochemical, and pollution control applications.</p>
                <hr/>
                <h3>KEY FEATURES OF SS 904L PIPES</h3>
                <p><strong>Superior Acid Resistance</strong> – Excellent performance in sulfuric, phosphoric, and acetic acids, even at elevated concentrations and temperatures.</p>
                <p><strong>High Resistance to Pitting & Crevice Corrosion</strong> – The combination of molybdenum and nitrogen provides a PREN of 30+, ensuring reliable service in chloride‑rich environments.</p>
                <p><strong>Low Carbon Content</strong> – Reduces the risk of sensitization during welding, maintaining corrosion resistance in the heat‑affected zone.</p>
                <hr/>
                <h3>SPECIFICATIONS & STANDARDS</h3>
                <p>Our SS 904L pipes conform to international standards including <strong>ASTM B677</strong> (seamless), <strong>ASTM B673</strong> (welded), <strong>ASTM B675</strong> (ERW), and <strong>ASME SB677 / SB673 / SB675</strong>. Available in seamless, welded, ERW, and EFW forms with custom schedules and lengths.</p>
            </div>
        </section>
    ...
    <h2>Specification: SS 904L Pipes</h2>

    <div className="spec-grid">

        <div className="spec-card">
            <h4>Standard</h4>
            <p>ASTM B677 / B673 / B675, ASME SB677 / SB673 / SB675</p>
        </div>
    ...
    <section className="stock-section">
      <div className="stock-container">
        ...
        <div className="stock-heading">
          <h2>READY STOCK AVAILABILITY – SS 904L PIPES</h2>
        </div>
    ...
    <section className="grades-section">
      <div className="container">
        ...
        <div className="section-title">
          <h2>EQUIVALENT GRADES: SS 904L</h2>
        </div>
    ...
    <section className="chemical-section">
      <div className="container">
        ...
        <div className="section-title">
          <h2>CHEMICAL COMPOSITION OF SS 904L PIPES</h2>
        </div>
    ...
    <section className="mechanical-section">
      <div className="container">
        ...
        <div className="section-title">
          <h2>MECHANICAL PROPERTIES OF SS 904L PIPING</h2>
        </div>
    ...
    <section className="thickness-section">
      <div className="container">
        ...
        <div className="section-title">
          <h2>
            SIZE RANGE AVAILABILITY: SS 904L PIPES
            <span>(ASTM B677 / B673 / B675)</span>
          </h2>
    ...
    <section className="coil-weight-section">
      <div className="container">
        ...
        <div className="section-title">
          <h2>UNIFIED WEIGHT CHART: SS 904L PIPES</h2>
        </div>
    ...
    <section className="finish-weight-section">
      <div className="container">
        ...
        <div className="section-title">
          <h2>SS 904L PIPE SUPPLY RANGE (UNIFIED)</h2>
    ...
    <section className="gauge-chart-section">
      <div className="container">
        ...
        <div className="section-title">
          <h2>UNIFIED SS 904L PIPE PRICE RANGE</h2>
        </div>
    ...
    <section className="specialty-weight-section">
      <div className="container">
        ...
        <div className="section-title">
          <h2>SPECIALIZED IN FOLLOWING SS 904L PIPES</h2>
        </div>
    ...
    <section className="tolerance-section">
      <div className="container">
        ...
        <div className="section-title">
          <h2>SEARCHES RELATED TO SS 904L PIPES</h2>
        </div>
...
export default Ss904LPipesDetails;