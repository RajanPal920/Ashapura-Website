...
import CoilsBanner from "../../products-image/ss-special-coils.webp";
...
const gradesData = [
  {
    ...
    uns: "S31254",
    werkstoff: "1.4547",
    standard: "2378 / Z1 CNDU 20.18.06Az / X1CrNiMoCuN20-18-7",
  },
  {
    grade: "Alloy 20 (Carpenter)",
    uns: "N08020",
    werkstoff: "2.4660",
    standard: "NiCr20CuMo / Z2NCUD31-20AZ / 20cb-3®",
  },
];
...
const SpecialAlloyCoilsDetails = () => {
  return (
    <>
        <Helmet>
            <title>Special Alloy Coils Supplier – SMO 254 & Alloy 20</title>
            <meta
            name="description"
            content="Supplier of special alloy coils including SMO 254 and Alloy 20 with corrosion resistance, technical data, applications and stock availability."
            />
        </Helmet>
      ...
      <div className="product-details-container">
        ...
        <section className="product-content">
            <div className="content-header">
                <h1>SPECIAL ALLOY COILS SUPPLIER – SMO 254 &amp; ALLOY 20</h1>
            </div>
            <div className="content-image">
                <img src={CoilsBanner} alt="Special Alloy Coils Supplier" className="main-image" />
            </div>
        ...
        <section className="product-content">
            <div className="content-header">
                <h2>SPECIAL ALLOY COILS: TECHNICAL OVERVIEW &amp; PROPERTIES</h2>
                <p>
                ...
                <hr/>
                <h3>SMO 254 COILS (UNS S31254)</h3>
                <ul>
                    <li><strong>Chloride Resistance:</strong> Virtually immune to chloride-induced stress corrosion cracking and pitting in seawater, making it superior to 316L and 904L.</li>
                    <li><strong>Mechanical Strength:</strong> Due to its nitrogen content, SMO 254 has higher yield strength than conventional austenitic steels, allowing for thinner, more cost-effective coil designs.</li>
                    <li><strong>Key Applications:</strong> Desalination plants, offshore oil and gas seawater cooling systems, and pulp/paper bleach plant equipment.</li>
                </ul>
                <h3>ALLOY 20 COILS (UNS N08020)</h3>
                <ul>
                    <li><strong>Sulfuric Acid Specialist:</strong> Offers exceptional resistance to boiling sulfuric acid in concentrations of 20% to 40%. The addition of copper protects the material in reducing environments.</li>
                    <li><strong>Intergranular Stability:</strong> Niobium stabilization prevents carbide precipitation during welding, maintaining corrosion resistance in the heat-affected zone.</li>
                    <li><strong>Key Applications:</strong> Chemical production of plastics and synthetic fibers, pharmaceutical processing, and pickling tanks for metal finishing.</li>
                </ul>
                <hr/>
                <h3>MANUFACTURING STANDARDS AND QUALITY ASSURANCE</h3>
                <p>Our specialized coils are manufactured to meet stringent international standards, including <strong>ASTM A240, B463, and ASME SB463</strong>. We supply them in various processing formats to suit your blueprints.</p>
            </div>
        </section>
    ...
    <h2>Specification of SMO 254 &amp; Alloy 20 Coils</h2>

    <div className="spec-grid">

        <div className="spec-card">
            <h4>Standard</h4>
            <p>ASTM A240 / B463 | ASME SA240 / SB463</p>
        </div>
        ...
        <div className="spec-card">
            ...
            <p>Cladding, Annealing, Pickling, Polishing, Bending, Fabrication</p>
        </div>
    ...
    <section className="grades-section">
      <div className="container">
        ...
        <div className="section-title">
          <h2>EQUIVALENT GRADES: SMO 254 &amp; ALLOY 20 COILS</h2>
        </div>
    ...
    <section className="chemical-section">
      <div className="container">
        ...
        <div className="section-title">
          <h2>CHEMICAL COMPOSITION OF SPECIAL ALLOY COILS</h2>
        </div>
    ...
    <section className="thickness-section">
      <div className="container">
        ...
        <div className="section-title">
          <h2>
            THICKNESS AVAILABILITY: SMO 254 &amp; ALLOY 20 COILS
            <span>(ASTM A240 / B463 | ASME SA240 / SB463)</span>
          </h2>

          <p>
            Available for Grades: SMO 254, Alloy 20, and related special alloy coils
          </p>
        </div>
    ...
    <section className="coil-weight-section">
      <div className="container">
        ...
        <div className="section-title">
          <h2>SMO 254 &amp; ALLOY 20 COILS WEIGHT / SIZE CHART</h2>
        </div>
    ...
    <section className="finish-weight-section">
      <div className="container">
        ...
        <div className="section-title">
          <h2>SMO 254 &amp; ALLOY 20 COILS THICKNESS GAUGE CHART</h2>
        </div>
    ...
    <section className="tolerance-section">
      <div className="container">
        ...
        <div className="section-title">
          <h2>SMO 254 &amp; ALLOY 20 COILS THICKNESS TOLERANCE</h2>
        </div>
    ...
    <section className="specialized-section">
      <div className="container">
        ...
        <div className="section-title orange-border">
          <h2>SPECIALIZED IN SMO 254 &amp; ALLOY 20 COILS</h2>
        </div>
    ...
    <section className="searches-section">
      <div className="container">
        ...
        <div className="search-box">
          ...
          <div className="section-title">
            <h2>SEARCHES RELATED TO SMO 254 &amp; ALLOY 20 COILS</h2>
          </div>
...
export default SpecialAlloyCoilsDetails;
