...
import duplexRBHR from "../../products-image/ss-hr-roundbars.webp";
import duplexRBCR from "../../products-image/ss-cr-roundbars.webp";

import duplexRBSpecialty from "../../products-image/ss-special-roundbars.webp";


import duplexsuperduplex from "../../products-image/ss-duplex-super-duplex-roundbars.webp";
import "./Productsdetails.css";


const stockData = [
  {
    title: "DUPLEX / SUPER DUPLEX HOT ROLLED ROUND BARS",
    image: duplexRBHR,
    items: [
      "Duplex & Super Duplex Hot Rolled Round Bars",
      "ASTM A276 / ASME SA276, ASTM A479",
      "Grades: S31803, S32205, S32750, S32760",
      "No.1 Finish – Industrial Fabrication",
    ],
  },
  {
    title: "DUPLEX / SUPER DUPLEX COLD DRAWN ROUND BARS",
    image: duplexRBCR,
    items: [
      "Cold Drawn Duplex & Super Duplex Bars",
  ...
  {
    title: "DUPLEX / SUPER DUPLEX SPECIALTY ROUND BARS",
    image: duplexRBSpecialty,
    items: [
      "Specialty Duplex & Super Duplex Bars",
      "High Strength (Yield > 550 MPa)",
      "PREN ≥ 35 (Duplex) / ≥ 40 (Super Duplex)",
      "For Offshore, Marine, Chemical, Oil & Gas",
    ],
  },
...
const leftItems = [
  "Duplex & Super Duplex Hot Rolled / Cold Drawn Bars",
  "ASTM A276 / A479 Compliant",
  "Grades: S31803, S32205, S32750, S32760",
  "PREN ≥ 35 (Duplex) / ≥ 40 (Super Duplex)",
  "High Yield Strength (450-550 MPa) for Weight Savings",
  "Excellent Resistance to Chloride SCC & Pitting",
  "Duplex Round Bars Manufacturer in India",
];

const rightItems = [
  "ASTM A276 / A479 Duplex & Super Duplex Bars",
  ...
  "Duplex Round Bars Supplier in Mumbai",
];

const searchTerms = [
  "Duplex Round Bar Price Per Kg",
  "Super Duplex Round Bar Price Per Kg",
  "S31803 Round Bar Weight Chart",
  "S32205 Round Bar Supplier In India",
  "S32750 Round Bar Chemical Composition",
  "Duplex Round Bar Price In Mumbai",
  "Super Duplex Round Bar Dimensions",
  "Duplex Round Bar Specifications Pdf",
  "S31803 vs S32205 Difference",
  "Duplex Round Bar Price List",
  "Duplex Round Bar Weight Calculator",
  "S32760 Mechanical Properties",
  "Duplex Round Bar Stockist",
  "Super Duplex S32750 Heat Treatment",
  "Duplex Round Bar Price Per Kg In India",
  "S32750 1.4410",
  "S32760 1.4501",
  "Duplex Round Bars Manufacturers In Mumbai",
  "Buy Duplex Round Bars In India",
];
...
const DuplexSuperDuplexRoundBarsDetails = () => {
  return (
    <>
      <Helmet>
        <title>Duplex & Super Duplex Round Bars Supplier – S31803, S32205, S32750, S32760</title>
        <meta
          name="description"
          content="Supplier of Duplex & Super Duplex round bars (UNS S31803, S32205, S32750, S32760) with high strength, excellent chloride SCC resistance, and PREN ≥ 35/40. Hot rolled, cold drawn, polished bars available."
        />
      </Helmet>
        ...
        <div className="product-main-content">
          <section className="product-content">
            <div className="content-header">
              <h1>DUPLEX & SUPER DUPLEX ROUND BARS SUPPLIER – S31803, S32205, S32750, S32760</h1>
            </div>
            <div className="content-image">
              <img src={duplexsuperduplex} alt="Duplex & Super Duplex Round Bars" className="main-image" />
            </div>
          ...
          <section className="product-content">
            <div className="content-header">
              ...
              <p><strong>Good Weldability & Machinability</strong> – Can be welded with standard techniques, though care must be taken to maintain the proper ferrite‑austenite balance.</p>
              <hr />
              ...
              <p>Our Duplex & Super Duplex round bars conform to international standards including <strong>ASTM A276 / ASME SA276</strong> (standard specification for stainless steel bars) and <strong>ASTM A479 / ASME SA479</strong> (bars for pressure vessels). We supply bars in various finishes (No.1, 2B, BA, No.4, HL, Mirror, Peeled) and can custom‑cut to your exact dimensions.</p>
            </div>
          </section>

          <section className="specification-section">
            <h2>Specification: Duplex & Super Duplex Round Bars</h2>
            <div className="spec-grid">
              <div className="spec-card">
                <h4>Standard</h4>
                <p>ASTM A276 / ASME SA276, ASTM A479 / ASME SA479</p>
              </div>
              <div className="spec-card">
              ...
              <div className="spec-card">
                <h4>Grades</h4>
                <p>S31803, S32205, S32750, S32760</p>
              </div>
              <div className="spec-card">
                <h4>Finish / Form</h4>
          ...
          <section className="stock-section">
            <div className="stock-container">
              <div className="stock-heading">
                <h2>READY STOCK AVAILABILITY – DUPLEX & SUPER DUPLEX ROUND BARS</h2>
              </div>
          ...
          <section className="chemical-section">
            <div className="container">
              <div className="section-title">
                <h2>CHEMICAL COMPOSITION OF DUPLEX & SUPER DUPLEX ROUND BARS</h2>
              </div>
              <div className="table-responsive">
          ...
          <section className="mechanical-section">
            <div className="container">
              <div className="section-title">
                <h2>MECHANICAL PROPERTIES OF DUPLEX & SUPER DUPLEX ROUND BARS</h2>
              </div>
              <div className="table-responsive">
          ...
          <section className="thickness-section">
            <div className="container">
              <div className="section-title">
                <h2>
                  DIAMETER RANGE AVAILABILITY: DUPLEX & SUPER DUPLEX ROUND BARS
                  <span>(ASTM A276 / A479)</span>
                </h2>
                <p>Available in Hot Rolled & Cold Drawn conditions for all grades</p>
              </div>
              <div className="table-responsive">
          ...
          <section className="coil-weight-section">
            <div className="container">
              <div className="section-title">
                <h2>UNIFIED WEIGHT CHART: DUPLEX & SUPER DUPLEX ROUND BARS (APPROX. WEIGHT PER 3 M LENGTH)</h2>
              </div>
              <div className="table-responsive">
          ...
          <section className="finish-weight-section">
            <div className="container">
              <div className="section-title">
                <h2>DUPLEX & SUPER DUPLEX ROUND BAR SUPPLY RANGE (UNIFIED)</h2>
          ...
          <section className="gauge-chart-section">
            <div className="container">
              <div className="section-title">
                <h2>UNIFIED DUPLEX & SUPER DUPLEX ROUND BAR PRICE RANGE</h2>
              </div>
              <div className="table-responsive">
          ...
          <section className="specialty-weight-section">
            <div className="container">
              <div className="section-title">
                <h2>SPECIALIZED IN FOLLOWING DUPLEX & SUPER DUPLEX ROUND BARS</h2>
              </div>
              <div className="table-responsive">
          ...
          <section className="tolerance-section">
            <div className="container">
              <div className="section-title">
                <h2>SEARCHES RELATED TO DUPLEX & SUPER DUPLEX ROUND BARS</h2>
              </div>
              <div className="table-responsive">
...
export default DuplexSuperDuplexRoundBarsDetails;