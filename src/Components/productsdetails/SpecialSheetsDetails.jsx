...
// Replace these image paths with your actual Special Alloy Sheets product images
import nimonicSheets from "../../products-image/ss-hr-sheets.webp";
import nichromeSheets from "../../products-image/ss-cr-sheets.webp";
import nitronicSheets from "../../products-image/ss-perforated-sheets.webp";
...
const stockData = [
  {
    title: "NIMONIC 75/80A SHEETS",
    image: nimonicSheets,
    items: [
      "Nimonic 75 Sheets & Plates",
      "Nimonic 80A Hot Rolled Sheets",
      "UNS N06075 / N07080 Stock",
      "High Temperature Nimonic Sheets",
    ],
  },
  {
    title: "NICHROME 80/20 SHEETS",
    image: nichromeSheets,
    items: [
      "Nichrome 80/20 Sheets & Coils",
      "Resistance Alloy Flat Products",
      "Industrial Heating Element Sheets",
      "Custom Size Nichrome Sheets",
    ],
  },
  {
    title: "NITRONIC 50 (XM-19) SHEETS",
    image: nitronicSheets,
    items: [
      "Nitronic 50 (XM-19) Sheets",
      "Nilo 42 / 48 Expansion Alloy Sheets",
      "Alloy A286 / 926 Sheets",
      "ASTM B167 / B517 Specialty Sheets",
    ],
  },
...
// Approx weights for sheets (using average density ~8.0 g/cm³ for simplicity, can be adjusted)
const leftData = [
...
const leftItems = [
  "Nimonic 75 / 80A Sheets & Plates",
  "Nichrome 80/20 High Resistance Sheets",
  "Nitronic 50 (XM-19) High Strength Sheets",
  "Nilo 42 / 48 Controlled Expansion Alloy Sheets",
  "Alloy A286 (660) Iron-Based Superalloy Sheets",
  "Alloy 926 Super-Austenitic Corrosion Sheets",
  "Special Alloy Sheets Manufacturer in India",
];

const rightItems = [
  "ASTM B167 / B517 Special Alloy Sheets",
  "Hot Rolled, Cold Rolled, and Polished Sheets",
  "Custom Sizes, Finishes, and Cut-to-Length Supply",
  "Full Hard / Soft Annealed / Cold Drawn Sheets",
  "Electropolished & Precision Sheet Solutions",
  "Special Alloy Coils & Strips",
  "High-Performance Alloy Sheets Supplier in Mumbai",
];

const searchTerms = [
  "Nimonic 75 Sheet Price Per Kg",
  "Nimonic 80A Sheet Weight Chart",
  "Nichrome 80/20 Sheet Supplier In India",
  "Nitronic 50 Sheet Chemical Composition",
  "Nilo 42 Sheet Price In Mumbai",
  "Nilo 48 Expansion Sheet Dimensions",
  "Alloy A286 Sheet Specifications Pdf",
  "Alloy 926 Sheet Corrosion Resistance",
  "Nimonic 75 / 80A Sheet Price List",
  "Nichrome 80/20 Sheet Weight Calculator",
  "Nitronic 50 Sheet Mechanical Properties",
  "Nilo 42 / 48 Sheet Stockist",
  "Alloy A286 Sheet Heat Treatment",
  "Alloy 926 Sheet Price Per Kg In India",
  "Special Alloy Sheet Exporter",
  "Special Alloy Sheet Supplier",
  "Nimonic 75 Sheet Dimensions",
  "Nichrome 80/20 Sheet Sizes",
  "Nitronic 50 Sheet Schedule",
  "Nilo 42 Sheet Equivalent Grades",
  "Alloy A286 Sheet UNS S66286",
  "Alloy 926 Sheet 1.4529",
  "Special Alloy Sheet Manufacturers In Mumbai",
  "Buy Special Alloy Sheets In India",
];
...
const SpecialSheetsDetails = () => {
  return (
    <>
      <Helmet>
        <title>High-Performance Alloy Sheets Supplier – Nimonic, Nichrome, Nitronic, Nilo & Alloy</title>
        <meta
          name="description"
          content="Supplier of high-performance alloy sheets including Nimonic, Nichrome, Nitronic, Nilo, Alloy 286 and Alloy 926 for extreme temperature and corrosive service. Hot rolled, cold rolled, polished sheets available."
        />
      </Helmet>
        ...
        <div className="product-main-content">
          <section className="product-content">
            <div className="content-header">
              <h1>Special Alloy Sheets Supplier</h1>
            </div>
            <div className="content-image">
              <img src={specialAlloy} alt="Special Alloy Sheets" className="main-image" />
            </div>
          ...
          <section className="product-content">
            <div className="content-header">
              <h2>Special Alloy Sheets: EXTREME SERVICE ENGINEERING</h2>
              <p>This selection of specialized alloys covers a broad spectrum of extreme engineering requirements, from ultra-high temperature resistance and controlled thermal expansion to superior strength in corrosive marine environments. These sheets are engineered for mission-critical applications where standard stainless steels fail due to thermal fatigue, mechanical stress, or aggressive chemical attack.</p>
              <hr/>
              <h3>NIMONIC 75 / 80A SHEETS</h3>
              ...
              <h3>NITRONIC 50 (XM-19) SHEETS</h3>
              ...
              <p>Our specialty alloy sheets are supplied to global standards including <strong>ASTM / ASME</strong> specifications such as <strong>ASTM B167, B517, A453</strong> and others. We offer hot rolled, cold rolled, polished, and custom-finished sheets in standard and custom sizes for critical industrial applications.</p>
            </div>
          </section>

          <section className="specification-section">
            <h2>Unified Specification: Nimonic, Nichrome, Nitronic, Nilo & Alloy 286/926 Sheets</h2>
            <div className="spec-grid">
              <div className="spec-card">
                <h4>Standard</h4>
                <p>ASTM / ASME B167, B517, A453 (varies by grade)</p>
              </div>
              <div className="spec-card">
              ...
              <div className="spec-card">
                <h4>Supply Forms</h4>
                <p>Hot Rolled, Cold Rolled, Polished, Coils, Strips</p>
              </div>
            </div>
          </section>
          ...
          <section className="stock-section">
            <div className="stock-container">
              <div className="stock-heading">
                <h2>READY STOCK AVAILABILITY - SPECIAL ALLOY SHEETS</h2>
              </div>
          ...
          <section className="chemical-section">
            <div className="container">
              <div className="section-title">
                <h2>CHEMICAL COMPOSITION OF SPECIALTY ALLOY SHEETS</h2>
              </div>
              <div className="table-responsive">
          ...
          <section className="mechanical-section">
            <div className="container">
              <div className="section-title">
                <h2>MECHANICAL PROPERTIES OF SPECIALTY ALLOY SHEETS</h2>
              </div>
              <div className="table-responsive">
          ...
          <section className="thickness-section">
            <div className="container">
              <div className="section-title">
                <h2>
                  THICKNESS RANGE AVAILABILITY: SPECIAL ALLOY SHEETS
                  <span>(ASTM / ASME B167, B517, A453)</span>
                </h2>
          ...
          <section className="coil-weight-section">
            <div className="container">
              <div className="section-title">
                <h2>UNIFIED WEIGHT CHART: NIMONIC, NICHROME, NITRONIC, NILO & ALLOY 286/926 SHEETS</h2>
              </div>
              <div className="table-responsive">
          ...
          <section className="finish-weight-section">
            <div className="container">
              <div className="section-title">
                <h2>SPECIAL ALLOY SHEET SUPPLY RANGE (UNIFIED)</h2>
                <p>Applicable for: Hot rolled, cold rolled, polished, and custom sizes</p>
              </div>
              <div className="table-responsive">
          ...
          <section className="gauge-chart-section">
            <div className="container">
              <div className="section-title">
                <h2>UNIFIED SPECIAL ALLOY SHEET PRICE RANGE</h2>
              </div>
              <div className="table-responsive">
          ...
          <section className="specialty-weight-section">
            <div className="container">
              <div className="section-title">
                <h2>SPECIALIZED IN FOLLOWING SPECIAL ALLOY SHEETS</h2>
              </div>
              <div className="table-responsive">
          ...
          <section className="tolerance-section">
            <div className="container">
              <div className="section-title">
                <h2>SEARCHES RELATED TO SPECIALTY ALLOY SHEETS</h2>
              </div>
              <div className="table-responsive">
...
export default SpecialSheetsDetails;