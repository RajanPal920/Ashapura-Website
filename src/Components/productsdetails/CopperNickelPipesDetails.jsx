...
// Replace these image paths with your actual Copper Nickel product images
import cuNiSeamless from "../../products-image/ss-seamless-copper.webp";
import cuNiWelded from "../../products-image/ss-welded-copper.webp";
import cuNiErw from "../../products-image/ss-erw-copper.webp";
import cuNiRound from "../../products-image/ss-round-copper.webp";
import cuNiSquare from "../../products-image/ss-square-copper.webp";
import cuNiHollow from "../../products-image/ss-hollow-copper.webp";
...
const stockData = [
  {
    title: "CU-NI 90/10 & 70/30 SEAMLESS PIPES",
    image: cuNiSeamless,
    items: [
      "Cu-Ni 90/10 (UNS C70600) Seamless Pipes (ASTM B466)",
      "Cu-Ni 70/30 (UNS C71500) Seamless Pipes (ASTM B466)",
      "Cold Drawn & Annealed Copper Nickel Seamless Tubes",
      "Seamless Pipes for Marine & Offshore Seawater Service",
    ],
  },
  {
    title: "CU-NI 90/10 & 70/30 WELDED PIPES",
    image: cuNiWelded,
    items: [
      "Cu-Ni 90/10 Welded Pipes (ASTM B467)",
      "Cu-Ni 70/30 Welded Pipes (ASTM B467)",
      "ERW / EFW Copper Nickel Pipes",
      "Large Diameter Welded Cu-Ni Pipes for Condensers",
    ],
  },
  {
    title: "CU-NI 90/10 & 70/30 ERW PIPES",
    image: cuNiErw,
    items: [
      "Cu-Ni 90/10 ERW Pipes",
      "Cu-Ni 70/30 ERW Pipes",
      "Electric Resistance Welded Copper Nickel Pipes",
      "ERW Round & Square Pipes for Seawater Cooling Systems",
    ],
  },
  {
    title: "CU-NI 90/10 & 70/30 ROUND PIPES",
    image: cuNiRound,
    items: [
      "Cu-Ni 90/10 Round Pipes",
      "Cu-Ni 70/30 Round Hollow Sections",
      "Round Pipes for Heat Exchangers & Condensers",
      "Precision Copper Nickel Round Pipes",
    ],
  },
  {
    title: "CU-NI 90/10 & 70/30 SQUARE PIPES",
    image: cuNiSquare,
    items: [
      "Cu-Ni 90/10 Square Pipes",
      "Cu-Ni 70/30 Square Hollow Sections",
      "Square Tubes for Structural Marine Components",
      "Custom Copper Nickel Square Pipes",
    ],
  },
  {
    title: "CU-NI 90/10 & 70/30 HOLLOW PIPES",
    image: cuNiHollow,
    items: [
      "Cu-Ni 90/10 Hollow Pipes",
      "Cu-Ni 70/30 Heavy Wall Hollow Pipes",
      "Copper Nickel Hollow Section",
      "Cu-Ni Hollow Pipes for Desalination Plants",
    ],
  }
];
...
const chemicalData = [
  {
    ...
    ni: "9.0-11.0",
    mo: "—",
    other: "Cu: Balance, Fe: 1.0-1.8, Zn: 1.0 max, Pb: 0.02 max",
  },
  {
    grade: "Cu-Ni 70/30 (C71500)",
    c: "—",
    mn: "1.0 max",
    si: "—",
    cr: "—",
    ni: "29.0-33.0",
    mo: "—",
    other: "Cu: Balance, Fe: 0.4-1.0, Zn: 1.0 max, Pb: 0.02 max",
  },
];
...
const mechanicalData = [
  {
    grade: "Cu-Ni 90/10 (C70600)",
    tensile: "310 MPa (45 ksi) min",
    yield: "110 MPa (16 ksi) min",
    elongation: "30%",
    density: "8.94 g/cm³",
  },
  {
    grade: "Cu-Ni 70/30 (C71500)",
    tensile: "370 MPa (54 ksi) min",
    yield: "130 MPa (19 ksi) min",
    elongation: "30%",
    density: "8.95 g/cm³",
  },
];
...
const leftItems = [
  "Cu-Ni 90/10 (C70600) & 70/30 (C71500) Seamless & Welded Pipes",
  "Cu-Ni 90/10 Annealed & Cold Drawn Pipes",
  "Copper Nickel ERW / EFW Pipes (ASTM B467)",
  "Cu-Ni 90/10 & 70/30 Round, Square & Rectangular Pipes",
  "Copper Nickel Heavy Wall & Hollow Pipes",
  "Cu-Ni Pipes for Marine, Offshore & Desalination Applications",
  "Copper Nickel Pipe Manufacturer in India",
];

const rightItems = [
  "ASTM B466 / B467 / B111 / B151 / B171",
  ...
  "Copper Nickel Hollow Section & Square Pipes",
  "Copper Nickel Pipe Supplier in Mumbai",
];

const searchTerms = [
  "Copper Nickel 90/10 Pipe Price Per Kg",
  "Cu-Ni 70/30 Seamless Pipe Weight Chart",
  "Copper Nickel Pipe Supplier In India",
  "Cu-Ni 90/10 Chemical Composition",
  "Copper Nickel Pipe Pressure Rating",
  "Cu-Ni 70/30 Pipe Price In Mumbai",
  "Copper Nickel Pipe Dimensions",
  "Copper Nickel Pipe Specifications Pdf",
  "Cu-Ni 90/10 Seawater Corrosion Resistance",
  "Copper Nickel Pipe Price List",
  "Cu-Ni Pipe Weight Calculator",
  "Copper Nickel Pipe Mechanical Properties",
  "Cu-Ni 90/10 Pipe Stockist",
  "Copper Nickel Pipe Equivalent Grades",
  "Cu-Ni 70/30 Pipe Price Per Kg In India",
  "Copper Nickel Seamless Pipe Exporter",
  "Cu-Ni 90/10 Welded Pipe Supplier",
  "Copper Nickel Pipe Sizes",
  "Copper Nickel Pipe Schedule",
  "Cu-Ni 90/10 Pipe UNS C70600",
  "Copper Nickel Pipe 2.0872",
  "Copper Nickel Pipe Manufacturers In Mumbai",
  "Buy Copper Nickel Pipes In India",
];
...
const CopperNickelPipesDetails = () => {
  return (
    <>
      <Helmet>
        <title>Copper Nickel Pipes Supplier, Stockist & Exporter</title>
        <meta
          name="description"
          content="Leading supplier of Copper Nickel pipes (90/10 UNS C70600 & 70/30 UNS C71500) in seamless, welded, ERW, and custom sizes. Exceptional seawater corrosion and biofouling resistance for marine and offshore applications."
        />
      </Helmet>
      ...
      <div className="product-details-container">
        <div className="product-main-content">
          <section className="product-content">
            <div className="content-header">
              <h1>COPPER NICKEL PIPES SUPPLIER – 90/10 & 70/30 SEAMLESS, WELDED, ERW & CUSTOM</h1>
            </div>
            <div className="content-image">
              <img src={copperNickel} alt="Copper Nickel Pipes" className="main-image" />
            </div>
          ...
          <section className="product-content">
            <div className="content-header">
              <h2>COPPER NICKEL PIPES – ENGINEERED FOR SUPERIOR MARINE & OFFSHORE PERFORMANCE</h2>
              <p>
                Our comprehensive range of <strong>Copper Nickel Pipes</strong> includes the two most popular grades: <strong>90/10 (UNS C70600 / Werkstoff 2.0872)</strong> and <strong>70/30 (UNS C71500 / Werkstoff 2.0882)</strong>. These alloys are renowned for their exceptional resistance to seawater corrosion, biofouling, and chloride stress corrosion cracking. The 90/10 grade offers an excellent balance of cost and performance for general marine applications, while the 70/30 grade provides superior resistance to high-velocity seawater, making it the preferred choice for critical offshore and naval applications.
              </p>
              <hr />
              <h3>SEAMLESS & WELDED COPPER NICKEL PIPES</h3>
              <p>
                We supply Copper Nickel pipes in <strong>seamless (ASTM B466)</strong> and <strong>welded (ASTM B467)</strong> forms, available from ½" NB to 24" NB and schedules SCH 5 to SCH XXS. Our inventory includes annealed, cold-drawn, and precision tubes that meet the rigorous demands of seawater cooling systems, heat exchangers, and condensers.
              </p>
              <h3>APPLICATIONS & ADVANTAGES</h3>
              <p>
                Copper Nickel pipes are widely used in <strong>offshore oil & gas</strong> (seawater piping, firewater systems), <strong>marine engineering</strong> (shipbuilding, naval vessels), <strong>desalination plants</strong>, and <strong>power generation</strong> (condensers and heat exchangers). Their inherent resistance to macrofouling eliminates the need for coatings, while their excellent fabricability and weldability ensure reliable, long-lasting service even in the most aggressive marine environments.
              </p>
              <hr />
              <h3>COMPLIANCE & STANDARDS</h3>
              <p>
                Our Copper Nickel pipes are manufactured and tested in accordance with <strong>ASTM / ASME</strong> specifications, including <strong>ASTM B466, B467, B111, B151, B171</strong>. We provide comprehensive mill test certificates, PMI reports, and third-party inspection services to ensure full traceability and quality assurance.
              </p>
            </div>
          </section>

          <section className="specification-section">
            <h2>UNIFIED SPECIFICATION: COPPER NICKEL PIPES</h2>
            <div className="spec-grid">
              <div className="spec-card">
                <h4>Standard</h4>
                <p>ASTM / ASME B466, B467, B111, B151, B171</p>
              </div>
              <div className="spec-card">
                <h4>Size Range</h4>
          ...
          <section className="stock-section">
            <div className="stock-container">
              <div className="stock-heading">
                <h2>READY STOCK AVAILABILITY – COPPER NICKEL PIPES</h2>
              </div>
          ...
          <section className="chemical-section">
            <div className="container">
              <div className="section-title">
                <h2>CHEMICAL COMPOSITION OF COPPER NICKEL PIPES</h2>
              </div>
              <div className="table-responsive">
          ...
          <section className="mechanical-section">
            <div className="container">
              <div className="section-title">
                <h2>MECHANICAL PROPERTIES OF COPPER NICKEL PIPING</h2>
              </div>
              <div className="table-responsive">
          ...
          <section className="thickness-section">
            <div className="container">
              <div className="section-title">
                <h2>
                  SIZE RANGE AVAILABILITY: COPPER NICKEL PIPES
                  <span>(ASTM / ASME B466, B467, B111)</span>
                </h2>
          ...
          <section className="coil-weight-section">
            <div className="container">
              <div className="section-title">
                <h2>UNIFIED WEIGHT CHART: COPPER NICKEL PIPES</h2>
              </div>
              <div className="table-responsive">
          ...
          <section className="finish-weight-section">
            <div className="container">
              <div className="section-title">
                <h2>COPPER NICKEL PIPE SUPPLY RANGE (UNIFIED)</h2>
          ...
          <section className="gauge-chart-section">
            <div className="container">
              <div className="section-title">
                <h2>UNIFIED COPPER NICKEL PIPE PRICE RANGE</h2>
              </div>
              <div className="table-responsive">
          ...
          <section className="specialty-weight-section">
            <div className="container">
              <div className="section-title">
                <h2>SPECIALIZED IN FOLLOWING COPPER NICKEL PIPES</h2>
              </div>
              <div className="table-responsive">
          ...
          <section className="tolerance-section">
            <div className="container">
              <div className="section-title">
                <h2>SEARCHES RELATED TO COPPER NICKEL PIPES</h2>
              </div>
              <div className="table-responsive">
        ...
        <div className="product-sidebar-wrapper">
          ...
          <div className="quote-card">
            <h2>GET A QUOTE</h2>
            <p>Immediate pricing for Copper Nickel pipes (90/10 & 70/30). Contact our sales team for bulk discounts and technical support.</p>
...
export default CopperNickelPipesDetails;