...
import hastelloyB2Seamless from "../../products-image/ss-nimonic-pipes.webp";
import hastelloyB2Welded from "../../products-image/ss-nitronic-pipes.webp";
import hastelloyB2Erw from "../../products-image/ss-nichrome-pipes.webp";
import hastelloyB2Round from "../../products-image/ss-nilo42-pipes.webp";
import hastelloyB2Square from "../../products-image/ss-alloy-926-pipes.webp";
import hastelloyB2Hollow from "../../products-image/ss-alloy-a286-pipes.webp";
...
const stockData = [
  {
    title: "HASTELLOY B2 SEAMLESS PIPES",
    image: hastelloyB2Seamless,
    items: [
      "Hastelloy B2 Seamless Pipes",
      "ASTM B622 / B619 UNS N10665",
      "Superior Resistance to Reducing Acids",
      "High-Temperature Strength",
    ],
  },
  {
    title: "HASTELLOY B2 WELDED PIPES",
    image: hastelloyB2Welded,
    items: [
      "Hastelloy B2 Welded Pipes",
      "ASTM B619 / B626 UNS N10665",
      "Longitudinal & Spiral Welded",
      "Industrial Process Piping",
    ],
  },
  {
    title: "HASTELLOY B2 ERW PIPES",
    image: hastelloyB2Erw,
    items: [
      "Hastelloy B2 ERW Pipes",
  ...
  {
    title: "HASTELLOY B2 EFW PIPES",
    image: hastelloyB2Round,
    items: [
      "Hastelloy B2 EFW Pipes",
  ...
  {
    title: "HASTELLOY B2 UBO PIPES",
    image: hastelloyB2Square,
    items: [
      "Hastelloy B2 UBO Pipes",
  ...
  {
    title: "HASTELLOY B2 SPECIALTY PIPES",
    image: hastelloyB2Hollow,
    items: [
      "Hastelloy B2 Nickel-Molybdenum Alloy",
      "High Mo (26-30%) for Reducing Environments",
      "Resistant to Pitting & Stress Corrosion Cracking",
...
const gradesData = [
  {
    ...
    uns: "N10665",
    werkstoff: "2.4617",
    standard: "ASTM B622 / B619 / B626 / B775",
  }
];
...
const chemicalData = [
  {
    ...
    ni: "Balance",
    mo: "26.0 – 30.0",
    other: "Fe: 2.0 max, Co: 1.0 max, Cu: 0.5 max, P: 0.04 max, S: 0.03 max",
  }
];
...
const leftItems = [
  "Hastelloy B2 Seamless & Welded Pipes",
  "Hastelloy B2 ERW & EFW Pipes",
  "ASTM B622 / B619 / B626 / B775 Compliant",
  "Excellent Resistance to Hydrochloric & Sulfuric Acids",
  "Resistant to Pitting, Crevice Corrosion & SCC",
  "Hastelloy B2 Pipes Manufacturer in India",
];

const rightItems = [
  "ASTM B622 / B619 / B626 / B775 Hastelloy B2 Pipes",
  ...
  "Hastelloy B2 Hollow Section & Square Pipes",
  "Hastelloy B2 Pipe Supplier in Mumbai",
];

const searchTerms = [
  "Hastelloy B2 Pipe Price Per Kg",
  ...
  "Hastelloy B2 Pipe Price In Mumbai",
  "Hastelloy B2 Pipe Dimensions",
  "Hastelloy B2 Pipe Specifications Pdf",
  "Hastelloy B2 Hydrochloric Acid Resistance",
  "Hastelloy B2 Pipe Price List",
  "Hastelloy B2 Pipe Weight Calculator",
  "Hastelloy B2 Pipe Mechanical Properties",
  "Hastelloy B2 Pipe Stockist",
  "Hastelloy B2 Heat Treatment",
  "Hastelloy B2 Pipe Price Per Kg In India",
  "Hastelloy B2 Seamless Pipe Exporter",
  "Hastelloy B2 Welded Pipe Supplier",
  "Hastelloy B2 Pipe Schedule",
  "Hastelloy B2 Equivalent Grades",
  "Hastelloy B2 UNS N10665",
  "Hastelloy B2 2.4617",
  "Hastelloy B2 Pipe Manufacturers In Mumbai",
  "Buy Hastelloy B2 Pipes In India",
];
...
const HastelloyB2PipesDetails = () => {
  return (
    <>
        <Helmet>
            <title>Hastelloy B2 Pipes Supplier – UNS N10665 Nickel-Molybdenum Alloy Pipes</title>
            <meta
            name="description"
            content="Supplier of Hastelloy B2 pipes (UNS N10665, 2.4617) with exceptional resistance to hydrochloric acid and reducing environments. Seamless, welded, ERW, EFW pipes available."
            />
        </Helmet>
      ...
      <div className="product-details-container">
        ...
        <section className="product-content">
            <div className="content-header">
                <h1>HASTELLOY B2 PIPES SUPPLIER – NICKEL-MOLYBDENUM ALLOY PIPES</h1>
            </div>
            <div className="content-image">
                <img src={hastelloyb2} alt="Hastelloy B2 Pipes" className="main-image" />
            </div>
        ...
        <section className="product-content">
            <div className="content-header">
                <h2>HASTELLOY B2 PIPES: EXCEPTIONAL RESISTANCE TO REDUCING ACIDS</h2>
                <p>Hastelloy B2 (UNS N10665) is a nickel‑molybdenum alloy renowned for its outstanding resistance to hydrochloric acid, sulfuric acid, and other reducing media. With a high molybdenum content (26–30%) and low carbon and silicon, it provides excellent resistance to pitting, crevice corrosion, and stress corrosion cracking in severely reducing environments. This makes it the material of choice for chemical processing, pharmaceutical, and pollution control applications.</p>
                <hr/>
                <h3>KEY FEATURES OF HASTELLOY B2 PIPES</h3>
                <p><strong>Superior Reducing Acid Resistance</strong> – Excellent performance in hydrochloric, sulfuric, and phosphoric acids at various concentrations and temperatures.</p>
                <p><strong>High Strength & Ductility</strong> – Maintains good mechanical properties over a wide temperature range, from cryogenic to elevated temperatures.</p>
                <p><strong>Good Weldability & Fabrication</strong> – Can be welded using standard techniques, with low tendency for carbide precipitation.</p>
                <hr/>
                <h3>SPECIFICATIONS & STANDARDS</h3>
                <p>Our Hastelloy B2 pipes conform to international standards including <strong>ASTM B622</strong> (seamless), <strong>ASTM B619</strong> (welded), <strong>ASTM B626</strong> (welded tube), and <strong>ASME SB622 / SB619 / SB626</strong>. Available in seamless, welded, ERW, and EFW forms with custom schedules and lengths.</p>
            </div>
        </section>
    ...
    <h2>Specification: Hastelloy B2 Pipes</h2>
    ...
    <section className="stock-section">
      <div className="stock-container">
        ...
        <div className="stock-heading">
          <h2>READY STOCK AVAILABILITY – HASTELLOY B2 PIPES</h2>
        </div>
    ...
    <section className="grades-section">
      <div className="container">
        ...
        <div className="section-title">
          <h2>EQUIVALENT GRADES: HASTELLOY B2</h2>
        </div>
    ...
    <section className="chemical-section">
      <div className="container">
        ...
        <div className="section-title">
          <h2>CHEMICAL COMPOSITION OF HASTELLOY B2 PIPES</h2>
        </div>
    ...
    <section className="mechanical-section">
      <div className="container">
        ...
        <div className="section-title">
          <h2>MECHANICAL PROPERTIES OF HASTELLOY B2 PIPING</h2>
        </div>
    ...
    <section className="thickness-section">
      <div className="container">
        ...
        <div className="section-title">
          <h2>
            SIZE RANGE AVAILABILITY: HASTELLOY B2 PIPES
    ...
    <section className="coil-weight-section">
      <div className="container">
        ...
        <div className="section-title">
          <h2>UNIFIED WEIGHT CHART: HASTELLOY B2 PIPES</h2>
        </div>
    ...
    <section className="finish-weight-section">
      <div className="container">
        ...
        <div className="section-title">
          <h2>HASTELLOY B2 PIPE SUPPLY RANGE (UNIFIED)</h2>
    ...
    <section className="gauge-chart-section">
      <div className="container">
        ...
        <div className="section-title">
          <h2>UNIFIED HASTELLOY B2 PIPE PRICE RANGE</h2>
        </div>
    ...
    <section className="specialty-weight-section">
      <div className="container">
        ...
        <div className="section-title">
          <h2>SPECIALIZED IN FOLLOWING HASTELLOY B2 PIPES</h2>
        </div>
    ...
    <section className="tolerance-section">
      <div className="container">
        ...
        <div className="section-title">
          <h2>SEARCHES RELATED TO HASTELLOY B2 PIPES</h2>
        </div>
...
export default HastelloyB2PipesDetails;