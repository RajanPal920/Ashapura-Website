...
// Replace these image paths with your actual Inconel Plates product images
import inconelHR from "../../products-image/ss-hr-plates.webp";
import inconelCR from "../../products-image/ss-cr-plates.webp";
import inconelSpecialty from "../../products-image/ss-custom-plates.webp";

import inconelMain from "../../products-image/ss-inconel-600-plates.webp";
...
const stockData = [
  {
    title: "INCONEL 600 HOT ROLLED PLATES",
    image: inconelHR,
    items: [
      "Inconel 600 Hot Rolled Plates",
      "ASTM B168 / ASME SB168",
      "UNS N06600 / 2.4816",
      "No.1 Finish – High-Temperature Service",
    ],
  },
  {
    title: "INCONEL 625 COLD ROLLED PLATES",
    image: inconelCR,
    items: [
      "Inconel 625 Cold Rolled Plates",
  ...
  {
    title: "INCONEL 718 SPECIALTY PLATES",
    image: inconelSpecialty,
    items: [
      "Inconel 718 Specialty Plates",
      "ASTM B670 / ASME SB670",
      "UNS N07718 / 2.4668",
      "Precipitation-Hardened for Extreme Strength",
    ],
  },
  {
    title: "INCONEL X-750 PLATES",
    image: inconelSpecialty,
    items: [
  ...
  {
    title: "INCONEL 690 PLATES",
    image: inconelCR,
    items: [
      "Inconel 690 Plates",
      "ASTM B168 / ASME SB168",
      "UNS N06690 / 2.4642",
      "High Chromium for Oxidizing Environments",
    ],
  },
  {
    title: "INCONEL CUSTOM CUT PLATES",
    image: inconelHR,
    items: [
      "Inconel Custom Cut Plates",
      "Precision Shearing & Laser Cutting",
...
// Thickness, weight, gauge, tolerance tables (adapted for Inconel plates, density ~8.4-8.5)
const leftThickness = [
...
const leftItems = [
  "Inconel 600 / 625 / 718 Hot Rolled & Cold Rolled Plates",
  "Inconel X-750 Age-Hardenable Plates",
  "Inconel 690 High-Chromium Plates for Oxidizing Service",
  "ASTM B168, B443, B670 Compliant",
  "Precision Sheared, Laser Cut, and Machined",
  "Inconel Plates Manufacturer in India",
];

const rightItems = [
  "ASTM B168 / B443 / B670 / ASME SB168 / SB443 / SB670",
  "Standard Sizes: 1000x2000, 1250x2500, 1500x3000, 2000x4000",
  "Thickness Range: 0.4 mm to 150 mm",
  "No.1, 2B, BA, No.4, HL, Mirror Finishes",
  "Mill Edge & Slit Edge Supply",
  "Custom Cut-to-Length & Precision Shearing",
  "Inconel Plates Supplier in Mumbai",
];

const searchTerms = [
  "Inconel 625 Plate Price Per Kg",
  "Inconel 600 Plate Weight Chart",
  "Inconel Plate Supplier In India",
  "Inconel 718 Plate Specifications",
  "Inconel X-750 Plate Price In Mumbai",
  "Inconel 690 Plate Dimensions",
  "Inconel Plate ASTM B168",
  "Inconel Plate Price List",
  "Inconel 625 Plate Weight Calculator",
  "Inconel Plate Mechanical Properties",
  "Inconel Plate Stockist",
  "Inconel 718 Heat Treatment",
  "Inconel Plate Price Per Kg In India",
  "Inconel 600 Plate Exporter",
  "Inconel Plate Manufacturers In Mumbai",
  "Buy Inconel Plates In India",
];
...
const InconelPlatesDetails = () => {
  return (
    <>
      <Helmet>
        <title>Inconel Plates Supplier – Inconel 600, 625, 718, X-750, 690 Plates</title>
        <meta
          name="description"
          content="Supplier of Inconel plates (600, 625, 718, X-750, 690) with outstanding high-temperature strength, oxidation resistance, and corrosion resistance. Hot rolled, cold rolled, polished plates available."
        />
      </Helmet>
      ...
      <div className="product-details-container">
        <div className="product-main-content">
          <section className="product-content">
            <div className="content-header">
              <h1>INCONEL PLATES SUPPLIER – INCONEL 600, 625, 718, X-750, 690</h1>
            </div>
            <div className="content-image">
              <img src={inconelMain} alt="Inconel Plates" className="main-image" />
            </div>
          ...
          <section className="product-content">
            <div className="content-header">
              <h2>INCONEL PLATES: EXCEPTIONAL HIGH-TEMPERATURE STRENGTH AND CORROSION RESISTANCE</h2>
              <p>
                Inconel plates are nickel-chromium-based superalloys engineered to withstand extreme temperatures, aggressive chemical environments, and high mechanical stresses. Our inventory includes <strong>Inconel 600</strong> (UNS N06600) for general high-temperature oxidation resistance, <strong>Inconel 625</strong> (UNS N06625) for outstanding corrosion resistance and high strength, <strong>Inconel 718</strong> (UNS N07718) for the highest strength in the family with excellent weldability, <strong>Inconel X-750</strong> (UNS N07750) for age-hardenable creep resistance, and <strong>Inconel 690</strong> (UNS N06690) for superior resistance to oxidizing acids and aqueous corrosion. These alloys are the preferred choice for critical applications in aerospace, power generation, chemical processing, and marine engineering.
              </p>
              <hr />
              <h3>KEY FEATURES OF INCONEL PLATES</h3>
              <p><strong>High-Temperature Strength</strong> – Maintains mechanical properties up to 1000°C, with exceptional creep and rupture strength.</p>
              <p><strong>Outstanding Corrosion Resistance</strong> – Resists pitting, crevice corrosion, and stress corrosion cracking in chloride-rich environments.</p>
              <p><strong>Excellent Weldability</strong> – Most Inconel grades are readily weldable with proper procedures, maintaining corrosion resistance in the heat‑affected zone.</p>
              <hr />
              <h3>SPECIFICATIONS & STANDARDS</h3>
              <p>
                Our Inconel plates conform to international standards including <strong>ASTM B168</strong> (Inconel 600, 690), <strong>ASTM B443</strong> (Inconel 625), and <strong>ASTM B670</strong> (Inconel 718, X-750), with their ASME equivalents. We supply plates in various finishes (No.1, 2B, BA, No.4, HL, Mirror) and can custom‑cut to your exact dimensions.
              </p>
            </div>
          </section>

          <section className="specification-section">
            <h2>Specification: Inconel Plates</h2>
            <div className="spec-grid">
              <div className="spec-card">
                <h4>Standard</h4>
                <p>ASTM B168 / B443 / B670; ASME SB168 / SB443 / SB670</p>
              </div>
              <div className="spec-card">
          ...
          <section className="stock-section">
            <div className="stock-container">
              <div className="stock-heading">
                <h2>READY STOCK AVAILABILITY – INCONEL PLATES</h2>
              </div>
          ...
          <section className="chemical-section">
            <div className="container">
              <div className="section-title">
                <h2>CHEMICAL COMPOSITION OF INCONEL PLATES</h2>
              </div>
              <div className="table-responsive">
          ...
          <section className="mechanical-section">
            <div className="container">
              <div className="section-title">
                <h2>MECHANICAL PROPERTIES OF INCONEL PLATES</h2>
              </div>
              <div className="table-responsive">
          ...
          <section className="thickness-section">
            <div className="container">
              <div className="section-title">
                <h2>
                  SIZE RANGE AVAILABILITY: INCONEL PLATES
                  <span>(ASTM B168, B443, B670)</span>
                </h2>
          ...
          <section className="coil-weight-section">
            <div className="container">
              <div className="section-title">
                <h2>UNIFIED WEIGHT CHART: INCONEL PLATES</h2>
              </div>
              <div className="table-responsive">
          ...
          <section className="finish-weight-section">
            <div className="container">
              <div className="section-title">
                <h2>INCONEL PLATE SUPPLY RANGE (UNIFIED)</h2>
          ...
          <section className="gauge-chart-section">
            <div className="container">
              <div className="section-title">
                <h2>UNIFIED INCONEL PLATE PRICE RANGE</h2>
              </div>
              <div className="table-responsive">
          ...
          <section className="specialty-weight-section">
            <div className="container">
              <div className="section-title">
                <h2>SPECIALIZED IN FOLLOWING INCONEL PLATES</h2>
              </div>
              <div className="table-responsive">
          ...
          <section className="tolerance-section">
            <div className="container">
              <div className="section-title">
                <h2>SEARCHES RELATED TO INCONEL PLATES</h2>
              </div>
              <div className="table-responsive">
        ...
        <div className="product-sidebar-wrapper">
          ...
          <div className="quote-card">
            <h2>GET A QUOTE</h2>
            <p>Immediate pricing for Inconel plates. Contact our sales team for bulk discounts and technical support.</p>
...
export default InconelPlatesDetails;