...
const stockData = [
  {
    ...
    items: [
      "Incoloy 800 / 800H / 800HT / 825 / 925 Seamless",
      "ASTM B163 / B167 / B407",
      "UNS N08800, N08810, N08811, N08825, N09925",
  ...
  },
  {
    ...
    image: incoloyWelded,
    items: [
      "Incoloy 800 / 800H / 800HT / 825 / 925 Welded",
      "ASTM B514 / B515 / B705",
...
const gradesData = [
  ...
  },
  {
    ...
    uns: "N08825",
    werkstoff: "2.4858",
    standard: "ASTM B163 / B423 / B705 / B704",
  },
  {
    grade: "Incoloy 925",
    uns: "N09925",
...
const leftItems = [
  "Incoloy 800 / 800H / 800HT / 825 / 925 Pipes",
  "Seamless & Welded, ERW & EFW",
  "ASTM B163 / B167 / B407 / B514 / B515 / B423 Compliant",
  "Excellent High-Temperature Creep & Oxidation Resistance",
  "Resistant to Carburization, Nitriding, and Corrosion",
  "Incoloy Pipes Manufacturer in India",
];

const rightItems = [
  "ASTM B163 / B167 / B407 / B514 / B515 Incoloy Pipes",
...
const searchTerms = [
  ...
  "Incoloy Pipe Stockist",
  "Incoloy 800 Pipe Exporter",
  "Incoloy 825 Welded Pipe Supplier",
  "Incoloy 800HT Pipe Schedule",
  "Incoloy 825 Equivalent Grades",
  "Incoloy 825 2.4858",
  "Incoloy 925 2.4859",
  "Incoloy Pipe Manufacturers In Mumbai",
  "Buy Incoloy Pipes In India",
];
...
const IncoloyPipesDetails = () => {
  return (
    <>
        <Helmet>
            <title>Incoloy Pipes Supplier – Nickel-Iron-Chromium Alloy Pipes (800, 800H, 800HT, 825, 925)</title>
            <meta
            name="description"
            content="Supplier of Incoloy pipes (UNS N08800, N08810, N08811, N08825, N09925) with exceptional high-temperature creep strength, oxidation, and corrosion resistance. Seamless, welded, ERW, EFW pipes available."
            />
        </Helmet>
      ...
      <div className="product-details-container">
        ...
        <section className="product-content">
            <div className="content-header">
                <h1>INCOLOY PIPES SUPPLIER – NICKEL-IRON-CHROMIUM ALLOY PIPES (800, 800H, 800HT, 825, 925)</h1>
            </div>
            <div className="content-image">
                <img src={incoloy} alt="Incoloy Pipes" className="main-image" ></img>
            </div>
        ...
        <section className="product-content">
            <div className="content-header">
                ...
                <p>Our Incoloy pipes conform to international standards including <strong>ASTM B163</strong> (seamless tubes), <strong>ASTM B167</strong> (seamless pipes), <strong>ASTM B407</strong> (welded), <strong>ASTM B514</strong> (welded pipe), <strong>ASTM B515</strong> (welded tube), <strong>ASTM B423</strong> (seamless for 825/925), and <strong>ASTM B705</strong> (welded for 825/925). Available in seamless, welded, ERW, and EFW forms with custom schedules and lengths.</p>
            </div>
        </section>
    ...
    <h2>Specification: Incoloy Pipes</h2>

    <div className="spec-grid">

        <div className="spec-card">
            <h4>Standard</h4>
            <p>ASTM B163 / B167 / B407 / B514 / B515 / B423 / B705, ASME SB163 / SB167 / SB407 / SB514 / SB515 / SB423 / SB705</p>
        </div>
    ...
    <section className="stock-section">
      <div className="stock-container">
        ...
        <div className="stock-heading">
          <h2>READY STOCK AVAILABILITY – INCOLOY PIPES</h2>
        </div>
    ...
    <section className="chemical-section">
      <div className="container">
        ...
        <div className="section-title">
          <h2>CHEMICAL COMPOSITION OF INCOLOY PIPES</h2>
        </div>
    ...
    <section className="mechanical-section">
      <div className="container">
        ...
        <div className="section-title">
          <h2>MECHANICAL PROPERTIES OF INCOLOY PIPING</h2>
        </div>
    ...
    <section className="thickness-section">
      <div className="container">
        ...
        <div className="section-title">
          <h2>
            SIZE RANGE AVAILABILITY: INCOLOY PIPES
    ...
    <section className="coil-weight-section">
      <div className="container">
        ...
        <div className="section-title">
          <h2>UNIFIED WEIGHT CHART: INCOLOY PIPES</h2>
        </div>
    ...
    <section className="finish-weight-section">
      <div className="container">
        ...
        <div className="section-title">
          <h2>INCOLOY PIPE SUPPLY RANGE (UNIFIED)</h2>
    ...
    <section className="gauge-chart-section">
      <div className="container">
        ...
        <div className="section-title">
          <h2>UNIFIED INCOLOY PIPE PRICE RANGE</h2>
        </div>
    ...
    <section className="specialty-weight-section">
      <div className="container">
        ...
        <div className="section-title">
          <h2>SPECIALIZED IN FOLLOWING INCOLOY PIPES</h2>
        </div>
    ...
    <section className="tolerance-section">
      <div className="container">
        ...
        <div className="section-title">
          <h2>SEARCHES RELATED TO INCOLOY PIPES</h2>
        </div>
...
export default IncoloyPipesDetails;