...
import monelSeamless from "../../products-image/ss-nimonic-pipes.webp";
import monelWelded from "../../products-image/ss-nichrome-pipes.webp";
import monelErw from "../../products-image/ss-nitronic-pipes.webp";
import monelEfw from "../../products-image/ss-nilo42-pipes.webp";
import monelUbo from "../../products-image/ss-alloy-a286-pipes.webp";
import monelSpecial from "../../products-image/ss-alloy-926-pipes.webp";

import monel from "../../products-image/ss-monel-400-pipes.webp";
import "./Productsdetails.css";


const stockData = [
  {
    title: "MONEL 400 SEAMLESS PIPES",
    image: monelSeamless,
    items: [
  ...
  {
    title: "MONEL K500 SEAMLESS PIPES",
    image: monelWelded,
    items: [
      "Monel K500 Seamless Pipes",
      "ASTM B165 UNS N05500",
      "Precipitation-Hardened Alloy",
      "High Strength & Hardness",
    ],
  },
  {
    title: "MONEL 400 WELDED PIPES",
    image: monelErw,
    items: [
      "Monel 400 Welded Pipes",
      "ASTM B725 / B730",
      "Longitudinal & Spiral Welded",
      "Economical Large Diameters",
    ],
  },
  {
    title: "MONEL K500 WELDED PIPES",
    image: monelEfw,
    items: [
      "Monel K500 Welded Pipes",
      "ASTM B725 UNS N05500",
      "Age-Hardenable Welded",
      "Marine & Cryogenic Service",
    ],
  },
  {
    title: "MONEL ERW & EFW PIPES",
    image: monelUbo,
    items: [
      "Monel ERW / EFW Pipes",
      "Electric Resistance / Fusion Welded",
      "Both 400 & K500 Grades",
      "Custom Schedules & Lengths",
    ],
  },
  {
    title: "MONEL ALLOY PIPES (SPECIALTY)",
    image: monelSpecial,
    items: [
      "Monel 400 & K500 Specialty",
      "Nickel-Copper Alloy Family",
...
const chemicalData = [
  {
    ...
    ni: "63.0 min",
    mo: "—",
    other: "Cu: 28-34, Fe: 2.5 max, S: 0.024 max",
  },
  {
    grade: "Monel K500",
    c: "0.25 max",
    ...
    ni: "63.0 min",
    mo: "—",
    other: "Cu: 27-33, Fe: 2.0 max, Al: 2.3-3.15, Ti: 0.35-0.85",
  }
];
...
const leftItems = [
  ...
  "ASTM B165, B163, B725, B730 Compliant",
  "Excellent Resistance to Seawater & Acids",
  "High Strength for Offshore & Marine",
  "Monel K500 – Age-Hardenable Superior Strength",
  "Monel Pipes Manufacturer in India",
];
...
const rightItems = [
  ...
  "Monel Hollow Section & Square Pipes",
  "Monel Alloy Pipe Supplier in Mumbai",
];

const searchTerms = [
  "Monel 400 Pipe Price Per Kg",
  "Monel K500 Pipe Price Per Kg",
  "Monel 400 Seamless Pipe Weight Chart",
  ...
  "Monel K500 Welded Pipe Supplier",
  "Monel 400 Pipe Schedule",
  "Monel K500 Equivalent Grades",
  "Monel 400 2.4360",
  "Monel K500 2.4375",
  "Monel Pipe Manufacturers In Mumbai",
  "Buy Monel Pipes In India",
];
...
const MonelPipesDetails = () => {
  return (
    <>
        <Helmet>
            <title>Monel Pipes Supplier – Monel 400 & K500 Nickel-Copper Alloy Pipes</title>
            <meta
            name="description"
            content="Supplier of Monel pipes (UNS N04400 & N05500) with exceptional resistance to seawater, acids, and alkalis. Seamless, welded, ERW, EFW pipes available."
            />
        </Helmet>
      ...
      <div className="product-details-container">
        ...
        <section className="product-content">
            <div className="content-header">
                <h1>MONEL PIPES SUPPLIER – NICKEL-COPPER ALLOY PIPES (MONEL 400 & K500)</h1>
            </div>
            <div className="content-image">
                <img src={monel} alt="Monel Pipes" className="main-image" />
            </div>
        ...
        <section className="product-content">
            <div className="content-header">
                <h2>MONEL PIPES: NICKEL-COPPER ALLOYS FOR EXTREME CORROSION SERVICE</h2>
                <p>Monel alloys are renowned for their exceptional corrosion resistance in seawater, hydrofluoric acid, sulfuric acid, and alkalis. This family includes <strong>Monel 400 (UNS N04400)</strong> – a solid-solution alloy with excellent toughness, and <strong>Monel K500 (UNS N05500)</strong> – an age-hardenable variant offering superior strength and hardness. These pipes are widely used in marine engineering, chemical processing, oil & gas, and cryogenic applications.</p>
                <hr/>
                <h3>MONEL 400 PIPES</h3>
                <p><strong>Monel 400</strong> offers outstanding resistance to flowing seawater and steam at high temperatures. It maintains good mechanical properties down to cryogenic temperatures and is easily welded and fabricated.</p>
                <h3>MONEL K500 PIPES</h3>
                <p><strong>Monel K500</strong> contains aluminum and titanium, which are precipitated through heat treatment to achieve nearly twice the yield strength of Monel 400. It is ideal for high-load components such as pump shafts, valves, and marine propellers.</p>
                <hr/>
                <h3>SPECIFICATIONS & STANDARDS</h3>
                <p>Our Monel pipes conform to international standards including <strong>ASTM B165</strong> (seamless), <strong>ASTM B725</strong> (welded), <strong>ASTM B163</strong> (seamless tubes), and <strong>ASME SB165 / SB725</strong>. Available in seamless, welded, ERW, and EFW forms with custom schedules and lengths.</p>
            </div>
        </section>
    ...
    <h2>Specification: Monel Pipes (400 & K500)</h2>

    <div className="spec-grid">

        <div className="spec-card">
            <h4>Standard</h4>
            <p>ASTM B165 / B163 / B725 / B730, ASME SB165 / SB163 / SB725</p>
        </div>
    ...
    <section className="stock-section">
      <div className="stock-container">
        ...
        <div className="stock-heading">
          <h2>READY STOCK AVAILABILITY – MONEL PIPES</h2>
        </div>
    ...
    <section className="chemical-section">
      <div className="container">
        ...
        <div className="section-title">
          <h2>CHEMICAL COMPOSITION OF MONEL PIPES</h2>
        </div>
    ...
    <section className="mechanical-section">
      <div className="container">
        ...
        <div className="section-title">
          <h2>MECHANICAL PROPERTIES OF MONEL PIPING</h2>
        </div>
    ...
    <section className="thickness-section">
      <div className="container">
        ...
        <div className="section-title">
          <h2>
            SIZE RANGE AVAILABILITY: MONEL PIPES
            <span>(ASTM B165 / B725 / B163)</span>
          </h2>

          <p>
            Available in Seamless, Welded, ERW, EFW for both 400 & K500
          </p>
        </div>
    ...
    <section className="coil-weight-section">
      <div className="container">
        ...
        <div className="section-title">
          <h2>UNIFIED WEIGHT CHART: MONEL PIPES</h2>
        </div>
    ...
    <section className="finish-weight-section">
      <div className="container">
        ...
        <div className="section-title">
          <h2>MONEL PIPE SUPPLY RANGE (UNIFIED)</h2>
    ...
    <section className="gauge-chart-section">
      <div className="container">
        ...
        <div className="section-title">
          <h2>UNIFIED MONEL PIPE PRICE RANGE</h2>
        </div>
    ...
    <section className="specialty-weight-section">
      <div className="container">
        ...
        <div className="section-title">
          <h2>SPECIALIZED IN FOLLOWING MONEL PIPES</h2>
        </div>
    ...
    <section className="tolerance-section">
      <div className="container">
        ...
        <div className="section-title">
          <h2>SEARCHES RELATED TO MONEL PIPES</h2>
        </div>
...
export default MonelPipesDetails;