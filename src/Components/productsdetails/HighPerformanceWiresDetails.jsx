...
// Replace these image paths with your actual High Performance Alloy Wires product images
import hpaRoundWire from "../../products-image/ss-welded-wires.webp";
import hpaSquareWire from "../../products-image/ss-filler-wires.webp";
import hpaFlatWire from "../../products-image/ss-bobbin-wires.webp";
import hpaCoilWire from "../../products-image/ss-bright-wires.webp";
import hpaCustomWire from "../../products-image/ss-cold-heading-wires.webp";
import hpaWeldingWire from "../../products-image/ss-rope-wires.webp";
...
const stockData = [
  {
    title: "INCONEL ROUND WIRES (600/625/718/X-750)",
    image: hpaRoundWire,
    items: [
  ...
  {
    title: "INCOLOY ROUND WIRES (800/825)",
    image: hpaRoundWire,
    items: [
      "Incoloy 800 / 800H / 800HT Round Wires (ASTM B408)",
      "Incoloy 825 Round Wires (ASTM B425)",
      "High-Temperature & Corrosion-Resistant Alloy Wires",
      "Wires for Furnace & Chemical Processing Equipment",
    ],
  },
  {
    title: "HASTELLOY ROUND WIRES (C276/C22/B2/B3/X)",
    image: hpaRoundWire,
    items: [
      "Hastelloy C276 Round Wires (ASTM B574)",
      "Hastelloy C22 Round Wires (ASTM B574)",
      "Hastelloy B2 / B3 / X Round Wires",
      "Wires for Severe Acid & Chloride Environments",
    ],
  },
  {
    title: "MONEL ROUND WIRES (400/K500)",
    image: hpaRoundWire,
    items: [
      "Monel 400 Round Wires (ASTM B164)",
      "Monel K500 Round Wires (ASTM B164)",
      "Seawater & Marine Grade Alloy Wires",
      "High-Strength Nickel-Copper Alloy Wires",
    ],
  },
  {
    title: "NIMONIC & NICHROME ROUND WIRES",
    image: hpaRoundWire,
    items: [
      "Nimonic 75 / 80A / 90 Round Wires",
      "Nichrome 80/20 Resistance Alloy Wires",
      "High-Temperature Creep Resistant Wires",
      "Heating Element & Aerospace Wires",
    ],
  },
  {
    title: "HIGH PERFORMANCE ALLOY SQUARE, FLAT & WELDING WIRES",
    image: hpaFlatWire,
    items: [
...
// Approx weight per meter for alloy wires (avg density ~8.0-8.9, we'll use 8.4 as typical)
const leftWireData = [
...
const leftItems = [
  "Inconel 600 / 625 / 718 / X-750 Round & Profile Wires",
  "Incoloy 800 / 825 Round & Profile Wires",
  "Hastelloy C276 / C22 / B2 / B3 / X Wires",
  "Monel 400 / K500 Round & Profile Wires",
  "Nimonic 75 / 80A & Nichrome 80/20 Wires",
  "Square, Flat, Welding & Custom Wires",
  "High Performance Alloy Wires Manufacturer in India",
];
...
const rightItems = [
  ...
  "High Performance Alloy Wires Supplier in Mumbai",
];

const searchTerms = [
  "Inconel 625 Wire Price Per Kg",
  "Hastelloy C276 Wire Weight Chart",
  "Incoloy 825 Wire Supplier In India",
  "Inconel 718 Wire Specifications",
  "Monel 400 Wire Price In Mumbai",
  "Inconel 600 Wire Dimensions",
  "High Performance Alloy Wire Price List",
  "Inconel 625 Wire Weight Calculator",
  "Hastelloy C22 Wire Mechanical Properties",
  "High Performance Alloy Wire Stockist",
  "Nimonic 75 Wire Equivalent Grades",
  "High Performance Alloy Wire Price Per Kg In India",
  "Inconel 600 Wire Exporter",
  "High Performance Alloy Wire Manufacturers In Mumbai",
  "Buy High Performance Alloy Wires In India",
];
...
const HighPerformanceWiresDetails = () => {
  return (
    <>
      <Helmet>
        <title>High Performance Alloy Wires Supplier – Inconel, Incoloy, Hastelloy, Monel, Nimonic</title>
        <meta
          name="description"
          content="Leading supplier of High Performance Alloy Wires including Inconel 600/625/718, Incoloy 800/825, Hastelloy C276/C22, Monel 400/K500, Nimonic 75/80A. Round, square, flat, welding wires, and custom sizes available."
        />
      </Helmet>
      ...
      <div className="product-details-container">
        <div className="product-main-content">
          <section className="product-content">
            <div className="content-header">
              <h1>HIGH PERFORMANCE ALLOY WIRES SUPPLIER – ROUND, SQUARE, FLAT & CUSTOM</h1>
            </div>
            <div className="content-image">
              <img src={highPerformance} alt="High Performance Alloy Wires" className="main-image" />
            </div>
          ...
          <section className="product-content">
            <div className="content-header">
              <h2>HIGH PERFORMANCE ALLOY WIRES – ENGINEERED FOR EXTREME CONDITIONS</h2>
              <p>
                Our comprehensive range of <strong>High Performance Alloy Wires</strong> covers the most demanding nickel-based superalloys, including <strong>Inconel</strong> (600, 625, 718, X-750), <strong>Incoloy</strong> (800, 825), <strong>Hastelloy</strong> (C276, C22, B2, B3, X), <strong>Monel</strong> (400, K500), <strong>Nimonic</strong> (75, 80A), and <strong>Nichrome</strong> (80/20). These alloys are specifically engineered to withstand extreme temperatures, highly corrosive chemicals, and severe mechanical stress. Whether you need high-temperature oxidation resistance, exceptional acid resistance, or high strength-to-weight ratio, our wires deliver reliable and long-lasting performance in the most challenging industrial environments.
              </p>
              <hr />
              <h3>ROUND, SQUARE, FLAT & CUSTOM ALLOY WIRES</h3>
              <p>
                We supply high-performance alloy wires in <strong>round</strong>, <strong>square</strong>, <strong>flat</strong>, and <strong>custom profiles</strong>, available from 0.1 mm to 50 mm diameter (or equivalent cross-section). Our inventory includes cold-drawn, annealed, stress-relieved, and spring-tempered wires to meet the stringent demands of springs, fasteners, welding, and precision components.
              </p>
              <h3>APPLICATIONS & ADVANTAGES</h3>
              <p>
                These alloy wires are the material of choice for critical applications in <strong>aerospace</strong> (springs, fasteners, control cables), <strong>chemical processing</strong> (electrodes, wire mesh), <strong>oil & gas</strong> (downhole tools), <strong>marine engineering</strong> (rigging, mooring), <strong>medical</strong> (sutures, orthodontics), and <strong>power generation</strong> (heating elements, thermocouples). Their unique combination of corrosion resistance, high-temperature strength, and fabricability ensures reliable service in the most demanding environments.
              </p>
              <hr />
              <h3>COMPLIANCE & STANDARDS</h3>
              <p>
                Our high-performance alloy wires are manufactured and tested in accordance with <strong>ASTM / ASME</strong> specifications, including <strong>ASTM B166, B446, B637, B408, B425, B574, B164</strong> and their ASME equivalents. We provide comprehensive mill test certificates, PMI reports, and third-party inspection services to ensure full traceability and quality assurance.
              </p>
            </div>
          </section>

          <section className="specification-section">
            <h2>Specification: High Performance Alloy Wires</h2>
          ...
          <section className="stock-section">
            <div className="stock-container">
              <div className="stock-heading">
                <h2>READY STOCK AVAILABILITY – HIGH PERFORMANCE ALLOY WIRES</h2>
              </div>
          ...
          <section className="chemical-section">
            <div className="container">
              <div className="section-title">
                <h2>CHEMICAL COMPOSITION OF HIGH PERFORMANCE ALLOY WIRES</h2>
              </div>
              <div className="table-responsive">
          ...
          <section className="mechanical-section">
            <div className="container">
              <div className="section-title">
                <h2>MECHANICAL PROPERTIES OF HIGH PERFORMANCE ALLOY WIRES</h2>
              </div>
              <div className="table-responsive">
          ...
          <section className="thickness-section">
            <div className="container">
              <div className="section-title">
                <h2>
                  DIAMETER RANGE AVAILABILITY: HIGH PERFORMANCE ALLOY WIRES
          ...
          <section className="coil-weight-section">
            <div className="container">
              <div className="section-title">
                <h2>UNIFIED WEIGHT CHART: HIGH PERFORMANCE ALLOY WIRES</h2>
              </div>
              <div className="table-responsive">
          ...
          <section className="finish-weight-section">
            <div className="container">
              <div className="section-title">
                <h2>HIGH PERFORMANCE ALLOY WIRE SUPPLY RANGE (UNIFIED)</h2>
          ...
          <section className="gauge-chart-section">
            <div className="container">
              <div className="section-title">
                <h2>UNIFIED HIGH PERFORMANCE ALLOY WIRE PRICE RANGE</h2>
              </div>
              <div className="table-responsive">
          ...
          <section className="specialty-weight-section">
            <div className="container">
              <div className="section-title">
                <h2>SPECIALIZED IN FOLLOWING HIGH PERFORMANCE ALLOY WIRES</h2>
              </div>
              <div className="table-responsive">
          ...
          <section className="tolerance-section">
            <div className="container">
              <div className="section-title">
                <h2>SEARCHES RELATED TO HIGH PERFORMANCE ALLOY WIRES</h2>
              </div>
              <div className="table-responsive">
        ...
        <div className="product-sidebar-wrapper">
          ...
          <div className="quote-card">
            <h2>GET A QUOTE</h2>
            <p>Immediate pricing for High Performance Alloy Wires. Contact our sales team for bulk discounts and technical support.</p>
...
export default HighPerformanceWiresDetails;
