...
// Replace these image paths with your actual Hastelloy C22 product images
import hastelloyC22Seamless from "../../products-image/ss-nimonic-pipes.webp";
import hastelloyC22Welded from "../../products-image/ss-nitronic-pipes.webp";
import hastelloyC22Erw from "../../products-image/ss-nichrome-pipes.webp";
import hastelloyC22Round from "../../products-image/ss-nilo42-pipes.webp";
import hastelloyC22Square from "../../products-image/ss-alloy-926-pipes.webp";
import hastelloyC22Hollow from "../../products-image/ss-alloy-a286-pipes.webp";
...
const stockData = [
  {
    title: "HASTELLOY C22 SEAMLESS PIPES",
    image: hastelloyC22Seamless,
    items: [
      "Hastelloy C22 Seamless Pipes (ASTM B622)",
      "UNS N06022 / 2.4602 Seamless Piping",
      "Cold Drawn & Annealed C22 Seamless Tubes",
      "Seamless Pipes for Severe Corrosive Service",
    ],
  },
  {
    title: "HASTELLOY C22 WELDED PIPES",
    image: hastelloyC22Welded,
    items: [
      "Hastelloy C22 Welded Pipes (ASTM B619 / B775)",
      "Hastelloy C22 ERW / EFW Pipes",
      "Large Diameter Welded C22 Pipes",
      "Heavy Wall Welded Hastelloy C22 Piping",
    ],
  },
  {
    title: "HASTELLOY C22 ERW PIPES",
    image: hastelloyC22Erw,
    items: [
      "Hastelloy C22 ERW Pipes",
      "Electric Resistance Welded C22 Pipes",
      "Hastelloy C22 ERW Round & Square Pipes",
      "Precision Welded C22 for Chemical Processing",
    ],
  },
  {
    title: "HASTELLOY C22 ROUND PIPES",
    image: hastelloyC22Round,
    items: [
      "Hastelloy C22 Round Pipes",
      "Hastelloy C22 Round Hollow Sections",
      "Hastelloy C22 Round Pipes for Heat Exchangers",
      "Precision Hastelloy C22 Round Pipes",
    ],
  },
  {
    title: "HASTELLOY C22 SQUARE PIPES",
    image: hastelloyC22Square,
    items: [
      "Hastelloy C22 Square Pipes",
      "Hastelloy C22 Square Hollow Sections",
      "Hastelloy C22 Square Tubes for Structural Use",
      "Custom Hastelloy C22 Square Pipes",
    ],
  },
  {
    title: "HASTELLOY C22 HOLLOW PIPES",
    image: hastelloyC22Hollow,
    items: [
      "Hastelloy C22 Hollow Pipes",
      "Hastelloy C22 Heavy Wall Hollow Pipes",
      "Hastelloy C22 Hollow Section",
      "Hastelloy C22 Hollow Pipes for Heat Exchangers",
    ],
  },
...
const gradesData = [
  {
    ...
    uns: "N06022",
    werkstoff: "2.4602",
    standard: "ASTM B622 / B619 / B366 / B564",
  },
  {
    grade: "Hastelloy C22 (DIN)",
    uns: "N06022",
    werkstoff: "2.4602",
    standard: "EN 2.4602 / NiCrMo-4",
  },
];
...
const chemicalData = [
  {
    ...
    ni: "Balance",
    mo: "12.5-14.5",
    other: "W: 2.5-3.5, Fe: 2.0-6.0, Co: 2.5 max, V: 0.35 max",
  },
];

const mechanicalData = [
  {
    grade: "Hastelloy C22 (Annealed)",
...
const leftItems = [
  "Hastelloy C22 Seamless & Welded Pipes",
  "Hastelloy C22 Annealed & Cold Drawn Pipes",
  "Hastelloy C22 ERW & EFW Pipes",
  "Hastelloy C22 Round, Square & Rectangular Pipes",
  "Hastelloy C22 Heavy Wall & Hollow Pipes",
  "Hastelloy C22 Buttweld & Forged Fittings (Elbows, Tees, Reducers)",
  "Hastelloy C22 Pipe & Fittings Manufacturer in India",
];

const rightItems = [
  "ASTM B622 / B619 / B775 / B366 / B564",
  ...
  "Hastelloy C22 Hollow Section & Square Pipes",
  "Hastelloy C22 Pipe & Fittings Supplier in Mumbai",
];

const searchTerms = [
  "Hastelloy C22 Pipe Price Per Kg",
  ...
  "Hastelloy C22 Pipe Price In Mumbai",
  "Hastelloy C22 Pipe Dimensions",
  "Hastelloy C22 Pipe Specifications Pdf",
  ...
  "Hastelloy C22 Pipe Stockist",
  "Hastelloy C22 Pipe Equivalent Grades",
  "Hastelloy C22 Pipe Price Per Kg In India",
  "Hastelloy C22 Seamless Pipe Exporter",
  "Hastelloy C22 Welded Pipe Supplier",
  "Hastelloy C22 Pipe Sizes",
  "Hastelloy C22 Pipe Schedule",
  "Hastelloy C22 Pipe UNS N06022",
  "Hastelloy C22 Pipe 2.4602",
  "Hastelloy C22 Fittings Stockist",
  "Hastelloy C22 Pipe & Fittings Manufacturers In Mumbai",
  "Buy Hastelloy C22 Pipes & Fittings In India",
];
...
const HastelloyC22PipesDetails = () => {
  return (
    <>
      <Helmet>
        <title>Hastelloy C22 Pipes & Fittings Supplier, Stockist & Exporter</title>
        <meta
          name="description"
          content="Leading supplier of Hastelloy C22 (UNS N06022) pipes and fittings in seamless, welded, ERW, and custom sizes. Exceptional resistance to both oxidizing and reducing acids for chemical processing."
        />
      </Helmet>
      ...
      <Banner
        title="HASTELLOY C22 PIPES & FITTINGS"
        image={ProductBanner}
      />
      ...
      <div className="product-details-container">
        <div className="product-main-content">
          <section className="product-content">
            <div className="content-header">
              <h1>HASTELLOY C22 PIPES & FITTINGS SUPPLIER – SEAMLESS, WELDED, ERW & CUSTOM</h1>
            </div>
            <div className="content-image">
              <img src={hastelloyc22} alt="Hastelloy C22 Pipes & Fittings" className="main-image" />
            </div>
          ...
          <section className="product-content">
            <div className="content-header">
              <h2>HASTELLOY C22 PIPES & FITTINGS – VERSATILE ALLOY FOR OXIDIZING & REDUCING ACIDS</h2>
              <p>
                <strong>Hastelloy C22</strong> (UNS N06022 / Werkstoff 2.4602) is a nickel-chromium-molybdenum-tungsten alloy that offers exceptional resistance to both oxidizing and reducing acids, as well as to pitting, crevice corrosion, and stress-corrosion cracking. Unlike many other alloys, C22 is highly versatile and performs well in a wide range of corrosive environments, including wet chlorine, formic and acetic acids, ferric and cupric chlorides, and mixed acids. Its outstanding thermal stability and weldability make it a preferred choice for demanding chemical processing applications.
              </p>
              <hr />
              <h3>SEAMLESS & WELDED HASTELLOY C22 PIPES</h3>
              <p>
                We supply Hastelloy C22 pipes in <strong>seamless (ASTM B622)</strong> and <strong>welded (ASTM B619 / B775)</strong> forms, available from ½" NB to 24" NB and schedules SCH 5 to SCH XXS. Our inventory includes solution-annealed, cold-drawn, and precision tubes for critical service conditions.
              </p>
              <h3>COMPLETE RANGE OF HASTELLOY C22 FITTINGS</h3>
              <p>
                In addition to pipes, we offer a comprehensive line of <strong>Hastelloy C22 fittings</strong> including elbows, tees, reducers, caps, stub ends, flanges, and forged fittings. All fittings are manufactured in accordance with <strong>ASTM B366 (buttweld)</strong> and <strong>ASTM B564 (forged)</strong> standards, ensuring perfect compatibility and leak-free performance.
              </p>
              <h3>APPLICATIONS & ADVANTAGES</h3>
              <p>
                Hastelloy C22 is widely used in <strong>chemical processing</strong> (reactors, distillation columns, heat exchangers), <strong>pharmaceuticals</strong>, <strong>pollution control</strong>, <strong>waste treatment</strong>, and <strong>petrochemical</strong> industries. Its resistance to both localized and uniform corrosion ensures long service life even in the most aggressive environments.
              </p>
              <hr />
              <h3>COMPLIANCE & STANDARDS</h3>
              <p>
                Our Hastelloy C22 products are manufactured and tested in accordance with <strong>ASTM / ASME</strong> specifications, including <strong>ASTM B622, B619, B775, B366, B564</strong>. We provide comprehensive mill test certificates, PMI reports, and third-party inspection services to ensure full traceability and quality assurance.
              </p>
            </div>
          </section>

          <section className="specification-section">
            <h2>UNIFIED SPECIFICATION: HASTELLOY C22 PIPES & FITTINGS</h2>
            <div className="spec-grid">
              <div className="spec-card">
                <h4>Standard</h4>
                <p>ASTM / ASME B622, B619, B775, B366, B564</p>
              </div>
              <div className="spec-card">
                <h4>Size Range</h4>
                <p>½" NB – 24" NB (Pipes); ½" – 24" (Fittings)</p>
              </div>
              <div className="spec-card">
              ...
              <div className="spec-card">
                <h4>Forms</h4>
                <p>Seamless, Welded, ERW, EFW, Electro-polished, Cold Drawn; Elbows, Tees, Reducers, Caps, Flanges, Forged Fittings</p>
              </div>
              <div className="spec-card">
          ...
          <section className="stock-section">
            <div className="stock-container">
              <div className="stock-heading">
                <h2>READY STOCK AVAILABILITY – HASTELLOY C22 PIPES & FITTINGS</h2>
              </div>
          ...
          <section className="grades-section">
            <div className="container">
              <div className="section-title">
                <h2>EQUIVALENT GRADES: HASTELLOY C22</h2>
              </div>
          ...
          <section className="chemical-section">
            <div className="container">
              <div className="section-title">
                <h2>CHEMICAL COMPOSITION OF HASTELLOY C22 PIPES</h2>
              </div>
              <div className="table-responsive">
          ...
          <section className="mechanical-section">
            <div className="container">
              <div className="section-title">
                <h2>MECHANICAL PROPERTIES OF HASTELLOY C22 PIPING</h2>
              </div>
              <div className="table-responsive">
          ...
          <section className="thickness-section">
            <div className="container">
              <div className="section-title">
                <h2>
                  SIZE RANGE AVAILABILITY: HASTELLOY C22 PIPES
          ...
          <section className="coil-weight-section">
            <div className="container">
              <div className="section-title">
                <h2>UNIFIED WEIGHT CHART: HASTELLOY C22 PIPES</h2>
              </div>
              <div className="table-responsive">
          ...
          <section className="finish-weight-section">
            <div className="container">
              <div className="section-title">
                <h2>HASTELLOY C22 PIPE SUPPLY RANGE (UNIFIED)</h2>
          ...
          <section className="gauge-chart-section">
            <div className="container">
              <div className="section-title">
                <h2>UNIFIED HASTELLOY C22 PIPE PRICE RANGE</h2>
              </div>
              <div className="table-responsive">
          ...
          <section className="specialty-weight-section">
            <div className="container">
              <div className="section-title">
                <h2>SPECIALIZED IN FOLLOWING HASTELLOY C22 PIPES & FITTINGS</h2>
              </div>
              <div className="table-responsive">
          ...
          <section className="tolerance-section">
            <div className="container">
              <div className="section-title">
                <h2>SEARCHES RELATED TO HASTELLOY C22 PIPES & FITTINGS</h2>
              </div>
              <div className="table-responsive">
        ...
        <div className="product-sidebar-wrapper">
          ...
          <div className="quote-card">
            <h2>GET A QUOTE</h2>
            <p>Immediate pricing for Hastelloy C22 pipes and fittings. Contact our sales team for bulk discounts and technical support.</p>
...
export default HastelloyC22PipesDetails;
