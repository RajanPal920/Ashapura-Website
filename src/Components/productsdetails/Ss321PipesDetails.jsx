...
// Replace these image paths with your actual SS 321 product images
import ss321Seamless from "../../products-image/ss-nimonic-pipes.webp";
import ss321Welded from "../../products-image/ss-nitronic-pipes.webp";
import ss321Erw from "../../products-image/ss-nichrome-pipes.webp";
import ss321Round from "../../products-image/ss-nilo42-pipes.webp";
import ss321Square from "../../products-image/ss-alloy-a286-pipes.webp";
import ss321Hollow from "../../products-image/ss-alloy-926-pipes.webp";

import ss321 from "../../products-image/stainless-steel-321-pipes.webp";
...
const stockData = [
  {
    ...
    image: ss321Seamless,
    items: [
      "SS 321 Seamless Pipes (ASTM A312 / A213)",
      "UNS S32100 / 1.4541 Seamless Piping",
      "Cold Drawn & Annealed 321 Seamless Tubes",
      "High Temperature Seamless Pipes for Aerospace Service",
    ],
  },
  {
    ...
    image: ss321Welded,
    items: [
      "SS 321 Welded Pipes (ASTM A312 / A358)",
      "Stainless Steel 321 ERW / EFW Pipes",
      "Large Diameter Welded 321 Pipes",
      "Heavy Wall Welded SS 321 Piping Systems",
    ],
  },
  {
    ...
    items: [
      "SS 321 ERW Pipes",
      "Electric Resistance Welded 321 Pipes",
      "SS 321 ERW Round & Square Pipes",
      "Precision Welded 321 for Chemical Processing",
    ],
  },
  {
    title: "SS 321 ROUND PIPES",
    image: ss321Round,
    items: [
      "SS 321 Round Pipes",
      "SS 321 Round Hollow Sections",
      "SS 321 Round Pipes for Heat Exchangers",
      "Precision Stainless Steel 321 Round Pipes",
    ],
  },
  {
    title: "SS 321 SQUARE PIPES",
    image: ss321Square,
    items: [
      "SS 321 Square Pipes",
      "SS 321 Square Hollow Sections",
      "SS 321 Square Tubes for Structural Use",
      "Custom SS 321 Square Pipes",
    ],
  },
  {
    ...
    items: [
      "SS 321 Hollow Pipes",
      "SS 321 Heavy Wall Hollow Pipes",
      "SS 321 Hollow Section",
      "SS 321 Hollow Pipes for Heat Exchangers",
    ],
  }
];
...
const gradesData = [
  ...
  },
  {
    ...
    uns: "S32100",
    werkstoff: "1.4541",
    standard: "EN 1.4541 / X6CrNiTi18-10",
  },
];
...
const chemicalData = [
  {
    ...
    ni: "9.0-12.0",
    mo: "—",
    other: "Ti: 5(C+N) min, P: 0.045 max, S: 0.030 max",
  },
];

const mechanicalData = [
  {
    grade: "SS 321 (Annealed)",
...
const leftItems = [
  "SS 321 Seamless & Welded Pipes (ASTM A312 / A269)",
  "SS 321 Annealed & Cold Drawn Pipes",
  "SS 321 ERW & EFW Pipes (ASTM A358)",
  "SS 321 Round, Square & Rectangular Pipes",
  "SS 321 Heavy Wall & Hollow Pipes",
  "SS 321 Stabilized Grade Pipes for Intergranular Corrosion Resistance",
  "SS 321 Pipe Manufacturer in India",
];
...
const rightItems = [
  ...
  "SS 321 Hollow Section & Square Pipes",
  "SS 321 Pipe Supplier in Mumbai",
];

const searchTerms = [
  "SS 321 Pipe Price Per Kg",
  "Stainless Steel 321 Seamless Pipe Weight Chart",
  "SS 321 Pipe Supplier In India",
  "SS 321 Chemical Composition",
  "SS 321 Pipe Pressure Rating",
  "SS 321 Pipe Price In Mumbai",
  "SS 321 Pipe Dimensions",
  "SS 321 Pipe Specifications Pdf",
  "SS 321 Intergranular Corrosion Resistance",
  "SS 321 Pipe Price List",
  "SS 321 Pipe Weight Calculator",
  "SS 321 Pipe Mechanical Properties",
  "SS 321 Pipe Stockist",
  "SS 321 Pipe Equivalent Grades",
  "SS 321 Pipe Price Per Kg In India",
  "SS 321 Seamless Pipe Exporter",
  "SS 321 Welded Pipe Supplier",
  "SS 321 Pipe Sizes",
  "SS 321 Pipe Schedule",
  "SS 321 Pipe UNS S32100",
  "SS 321 Pipe 1.4541",
  "Stainless Steel 321 Pipe Manufacturers In Mumbai",
  "Buy SS 321 Pipes In India",
];
...
const Ss321PipesDetails = () => {
  return (
    <>
      <Helmet>
        <title>Stainless Steel 321 Pipes Supplier, Stockist & Exporter</title>
        <meta
          name="description"
          content="Leading supplier of Stainless Steel 321 (UNS S32100) pipes in seamless, welded, ERW, and custom sizes. Titanium-stabilized grade offering excellent intergranular corrosion resistance and high-temperature strength."
        />
      </Helmet>
      ...
      <Banner
        title="STAINLESS STEEL 321 PIPES"
        image={ProductBanner}
      />
      ...
      <div className="product-details-container">
        <div className="product-main-content">
          <section className="product-content">
            <div className="content-header">
              <h1>STAINLESS STEEL 321 PIPES SUPPLIER – SEAMLESS, WELDED, ERW & CUSTOM</h1>
            </div>
            <div className="content-image">
              <img src={ss321} alt="Stainless Steel 321 Pipes" className="main-image" />
            </div>
          ...
          <section className="product-content">
            <div className="content-header">
              <h2>SS 321 PIPES – TITANIUM-STABILIZED AUSTENITIC STAINLESS STEEL FOR HIGH-TEMPERATURE SERVICE</h2>
              <p>
                <strong>Stainless Steel 321</strong> (UNS S32100 / Werkstoff 1.4541) is a titanium-stabilized austenitic stainless steel specifically designed to combat intergranular corrosion. The addition of titanium prevents the precipitation of chromium carbides during welding or exposure to elevated temperatures, ensuring that the material maintains its corrosion resistance even after prolonged service in the 425°C to 900°C (800°F to 1650°F) range. It offers excellent mechanical properties at elevated temperatures and is widely used in aerospace, chemical processing, and high-temperature industrial equipment.
              </p>
              <hr />
              <h3>SEAMLESS & WELDED SS 321 PIPES</h3>
              <p>
                We supply SS 321 pipes in <strong>seamless (ASTM A312 / A213)</strong> and <strong>welded (ASTM A312 / A358)</strong> forms, available from ½" NB to 24" NB and schedules SCH 5 to SCH XXS. Our inventory includes solution-annealed, cold-drawn, and precision tubes that meet the stringent requirements of aerospace exhaust systems and chemical processing units.
              </p>
              <h3>APPLICATIONS & ADVANTAGES</h3>
              <p>
                SS 321 is the material of choice for critical applications in <strong>aerospace</strong> (jet engine exhaust systems, aircraft components), <strong>chemical processing</strong> (reaction vessels, heat exchangers), <strong>refinery equipment</strong>, and <strong>high-temperature industrial furnaces</strong>. Its immunity to sensitization and excellent creep-rupture strength ensure reliable, long-lasting service in environments where repeated heating and cooling cycles would cause standard 304 or 316 grades to fail.
              </p>
              <hr />
              <h3>COMPLIANCE & STANDARDS</h3>
              <p>
                Our SS 321 pipes are manufactured and tested in accordance with <strong>ASTM / ASME</strong> specifications, including <strong>ASTM A312, A213, A269, A358</strong>. We provide comprehensive mill test certificates, PMI reports, and third-party inspection services to ensure full traceability and quality assurance.
              </p>
            </div>
          </section>

          <section className="specification-section">
            <h2>UNIFIED SPECIFICATION: SS 321 PIPES</h2>
          ...
          <section className="stock-section">
            <div className="stock-container">
              <div className="stock-heading">
                <h2>READY STOCK AVAILABILITY – SS 321 PIPES</h2>
              </div>
          ...
          <section className="grades-section">
            <div className="container">
              <div className="section-title">
                <h2>EQUIVALENT GRADES: STAINLESS STEEL 321</h2>
              </div>
          ...
          <section className="chemical-section">
            <div className="container">
              <div className="section-title">
                <h2>CHEMICAL COMPOSITION OF SS 321 PIPES</h2>
              </div>
              <div className="table-responsive">
          ...
          <section className="mechanical-section">
            <div className="container">
              <div className="section-title">
                <h2>MECHANICAL PROPERTIES OF SS 321 PIPING</h2>
              </div>
              <div className="table-responsive">
          ...
          <section className="thickness-section">
            <div className="container">
              <div className="section-title">
                <h2>
                  SIZE RANGE AVAILABILITY: SS 321 PIPES
          ...
          <section className="coil-weight-section">
            <div className="container">
              <div className="section-title">
                <h2>UNIFIED WEIGHT CHART: SS 321 PIPES</h2>
              </div>
              <div className="table-responsive">
          ...
          <section className="finish-weight-section">
            <div className="container">
              <div className="section-title">
                <h2>SS 321 PIPE SUPPLY RANGE (UNIFIED)</h2>
          ...
          <section className="gauge-chart-section">
            <div className="container">
              <div className="section-title">
                <h2>UNIFIED SS 321 PIPE PRICE RANGE</h2>
              </div>
              <div className="table-responsive">
          ...
          <section className="specialty-weight-section">
            <div className="container">
              <div className="section-title">
                <h2>SPECIALIZED IN FOLLOWING SS 321 PIPES</h2>
              </div>
              <div className="table-responsive">
          ...
          <section className="tolerance-section">
            <div className="container">
              <div className="section-title">
                <h2>SEARCHES RELATED TO SS 321 PIPES</h2>
              </div>
              <div className="table-responsive">
        ...
        <div className="product-sidebar-wrapper">
          ...
          <div className="quote-card">
            <h2>GET A QUOTE</h2>
            <p>Immediate pricing for SS 321 pipes. Contact our sales team for bulk discounts and technical support.</p>
...
export default Ss321PipesDetails;
