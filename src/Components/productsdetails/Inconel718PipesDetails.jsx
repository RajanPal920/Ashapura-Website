...
// Replace these image paths with your actual Inconel 718 product images
...
const stockData = [
  {
    title: "INCONEL 718 SEAMLESS PIPES",
    image: inconelSeamless,
    items: [
      "Inconel 718 Seamless Pipes (ASTM B983)",
      "UNS N07718 / 2.4668 Seamless Piping",
      "Cold Drawn & Precipitation-Hardened Pipes",
      "Aerospace & Gas Turbine Grade 718 Seamless Tubes",
    ],
  },
  {
    title: "INCONEL 718 WELDED PIPES",
    image: inconelWelded,
    items: [
      "Inconel 718 Welded Pipes (ASTM B517)",
      "Inconel 718 ERW / EFW Pipes",
      "Large Diameter Welded 718 Pipes",
      "High-Temperature Welded Piping Systems",
    ],
  },
  {
    title: "INCONEL 718 ERW PIPES",
    image: inconelErw,
    items: [
      "Inconel 718 ERW Pipes",
      "Electric Resistance Welded 718 Pipes",
      "Inconel 718 ERW Round & Square Pipes",
      "Precision Welded 718 for Critical Applications",
    ],
  },
  {
    title: "INCONEL 718 ROUND PIPES",
    image: inconelRound,
    items: [
      "Inconel 718 Round Pipes",
      "Inconel 718 Round Hollow Sections",
      "Inconel 718 Round Pipes for Rocket Engines",
      "Precision Inconel 718 Round Pipes",
    ],
  },
  {
    title: "INCONEL 718 SQUARE PIPES",
    image: inconelSquare,
    items: [
      "Inconel 718 Square Pipes",
      "Inconel 718 Square Hollow Sections",
      "Inconel 718 Square Tubes for Structural Use",
      "Custom Inconel 718 Square Pipes",
    ],
  },
  {
    title: "INCONEL 718 HOLLOW PIPES",
    image: inconelHollow,
    items: [
      "Inconel 718 Hollow Pipes",
      "Inconel 718 Heavy Wall Hollow Pipes",
      "Inconel 718 Hollow Section",
      "Inconel 718 Hollow Pipes for Heat Exchangers",
    ],
  }
];
...
const gradesData = [
  ...
  {
    grade: "Inconel 718 (AMS)",
    uns: "N07718",
    werkstoff: "2.4668",
    standard: "AMS 5582 / AMS 5662",
  },
];
...
const leftItems = [
  "Inconel 718 Seamless & Welded Pipes",
  "Inconel 718 Age-Hardened Pipes",
  "Inconel 718 ERW & EFW Pipes",
  "Inconel 718 Round, Square & Rectangular Pipes",
  "Inconel 718 Heavy Wall & Hollow Pipes",
  "Inconel 718 Pipes for Rocket Engines & Gas Turbines",
  "Inconel 718 Pipe Manufacturer in India",
];

const rightItems = [
  "ASTM B983 / B517 / B167 / AMS 5582 / 5662",
  "Seamless Round, Square, and Rectangular Pipes",
  "Custom Sizes, Schedules, and Cut-to-Length Supply",
  "Solution Annealed / Age-Hardened / Cold Drawn Pipes",
  "Electropolished & Precision Tubing Solutions",
  "Inconel 718 Hollow Section & Square Pipes",
  "Inconel 718 Pipe Supplier in Mumbai",
];

const searchTerms = [
  "Inconel 718 Pipe Price Per Kg",
  "Inconel 718 Seamless Pipe Weight Chart",
  "Inconel 718 Pipe Supplier In India",
  "Inconel 718 Chemical Composition",
  "Inconel 718 Pipe Pressure Rating",
  "Inconel 718 Pipe Price In Mumbai",
  "Inconel 718 Pipe Dimensions",
  "Inconel 718 Pipe Specifications Pdf",
  "Inconel 718 Age Hardening Heat Treatment",
  "Inconel 718 Pipe Price List",
  "Inconel 718 Pipe Weight Calculator",
  "Inconel 718 Pipe Mechanical Properties",
  "Inconel 718 Pipe Stockist",
  "Inconel 718 Pipe Equivalent Grades",
  "Inconel 718 Pipe Price Per Kg In India",
  "Inconel 718 Seamless Pipe Exporter",
  "Inconel 718 Welded Pipe Supplier",
  "Inconel 718 Pipe Sizes",
  "Inconel 718 Pipe Schedule",
  "Inconel 718 Pipe UNS N07718",
  "Inconel 718 Pipe 2.4668",
  "Inconel 718 Pipe Manufacturers In Mumbai",
  "Buy Inconel 718 Pipes In India",
];
...
const Inconel718PipesDetails = () => {
  return (
    <>
      <Helmet>
        <title>Inconel 718 Pipes Supplier, Stockist & Exporter</title>
        <meta
          name="description"
          content="Leading supplier of Inconel 718 (UNS N07718) pipes in seamless, welded, ERW, and age-hardened conditions. Exceptionally high strength for aerospace, gas turbines, and oil & gas applications."
        />
      </Helmet>
      ...
      <div className="product-details-container">
        <div className="product-main-content">
          <section className="product-content">
            <div className="content-header">
              <h1>INCONEL 718 PIPES SUPPLIER – SEAMLESS, WELDED, ERW & AGE-HARDENED</h1>
            </div>
            <div className="content-image">
              <img src={inconel718} alt="Inconel 718 Pipes" className="main-image" />
            </div>
          ...
          <section className="product-content">
            <div className="content-header">
              <h2>INCONEL 718 PIPES – PRECIPITATION-HARDENED SUPERALLOY WITH OUTSTANDING WELDABILITY</h2>
              <p>
                <strong>Inconel 718</strong> (UNS N07718 / Werkstoff 2.4668) is a precipitation-hardenable nickel-chromium superalloy that offers an exceptional combination of high strength, creep resistance, and outstanding weldability. Unlike many other superalloys, Inconel 718 can be readily welded without post-weld cracking, making it the most widely used alloy in the aerospace and gas turbine industries. It maintains its mechanical properties at temperatures up to 700°C (1300°F) and exhibits excellent oxidation and corrosion resistance.
              </p>
              <hr />
              <h3>SEAMLESS & WELDED INCONEL 718 PIPES</h3>
              <p>
                We supply Inconel 718 pipes in <strong>seamless (ASTM B983 / B167)</strong> and <strong>welded (ASTM B517)</strong> forms, available from ½" NB to 24" NB and schedules SCH 5 to SCH XXS. Our inventory includes solution-annealed pipes for fabrication, fully age-hardened pipes for immediate service, as well as ERW, EFW, and cold-drawn precision tubes to meet the most stringent specifications.
              </p>
              <h3>APPLICATIONS & ADVANTAGES</h3>
              <p>
                Inconel 718 is the material of choice for critical applications in <strong>aerospace</strong> (jet engines, turbine disks, combustors), <strong>rocket engines</strong> (thrust chambers, nozzles), and <strong>oil & gas</strong> (downhole tools, high-pressure valves). It also finds extensive use in nuclear reactors, chemical processing, and cryogenic systems due to its exceptional resistance to stress-corrosion cracking and high fatigue life.
              </p>
              <hr />
              <h3>COMPLIANCE & STANDARDS</h3>
              <p>
                Our Inconel 718 pipes are manufactured and tested in accordance with <strong>ASTM / ASME</strong> and <strong>AMS</strong> specifications, including <strong>ASTM B983, B517, B167</strong> and <strong>AMS 5582, AMS 5662</strong>. We provide comprehensive mill test certificates, PMI reports, age-hardening heat treatment certifications, and third-party inspection services to ensure full traceability.
              </p>
            </div>
          </section>

          <section className="specification-section">
            <h2>UNIFIED SPECIFICATION: INCONEL 718 PIPES</h2>
            <div className="spec-grid">
              <div className="spec-card">
                <h4>Standard</h4>
                <p>ASTM / ASME B983, B517, B167 / AMS 5582, AMS 5662</p>
              </div>
              <div className="spec-card">
                <h4>Size Range</h4>
          ...
          <section className="stock-section">
            <div className="stock-container">
              <div className="stock-heading">
                <h2>READY STOCK AVAILABILITY – INCONEL 718 PIPES</h2>
              </div>
          ...
          <section className="grades-section">
            <div className="container">
              <div className="section-title">
                <h2>EQUIVALENT GRADES: INCONEL 718</h2>
              </div>
          ...
          <section className="chemical-section">
            <div className="container">
              <div className="section-title">
                <h2>CHEMICAL COMPOSITION OF INCONEL 718 PIPES</h2>
              </div>
              <div className="table-responsive">
          ...
          <section className="mechanical-section">
            <div className="container">
              <div className="section-title">
                <h2>MECHANICAL PROPERTIES OF INCONEL 718 PIPING</h2>
              </div>
              <div className="table-responsive">
          ...
          <section className="thickness-section">
            <div className="container">
              <div className="section-title">
                <h2>
                  SIZE RANGE AVAILABILITY: INCONEL 718 PIPES
          ...
          <section className="coil-weight-section">
            <div className="container">
              <div className="section-title">
                <h2>UNIFIED WEIGHT CHART: INCONEL 718 PIPES</h2>
              </div>
              <div className="table-responsive">
          ...
          <section className="finish-weight-section">
            <div className="container">
              <div className="section-title">
                <h2>INCONEL 718 PIPE SUPPLY RANGE (UNIFIED)</h2>
          ...
          <section className="gauge-chart-section">
            <div className="container">
              <div className="section-title">
                <h2>UNIFIED INCONEL 718 PIPE PRICE RANGE</h2>
              </div>
              <div className="table-responsive">
          ...
          <section className="specialty-weight-section">
            <div className="container">
              <div className="section-title">
                <h2>SPECIALIZED IN FOLLOWING INCONEL 718 PIPES</h2>
              </div>
              <div className="table-responsive">
          ...
          <section className="tolerance-section">
            <div className="container">
              <div className="section-title">
                <h2>SEARCHES RELATED TO INCONEL 718 PIPES</h2>
              </div>
              <div className="table-responsive">
        ...
        <div className="product-sidebar-wrapper">
          ...
          <div className="quote-card">
            <h2>GET A QUOTE</h2>
            <p>Immediate pricing for Inconel 718 pipes. Contact our sales team for bulk discounts and technical support.</p>
...
export default Inconel718PipesDetails;