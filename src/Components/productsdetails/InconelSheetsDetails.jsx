...
// Replace these image paths with your actual Inconel Sheets product images
import inconelHRSheets from "../../products-image/ss-hr-sheets.webp";
import inconelCRSheets from "../../products-image/ss-cr-sheets.webp";
import inconelCoils from "../../products-image/ss-perforated-sheets.webp";
...
const stockData = [
  {
    title: "INCONEL 600 HOT ROLLED SHEETS",
    image: inconelHRSheets,
    items: [
      "Inconel 600 Hot Rolled Sheets (ASTM B168)",
      "UNS N06600 / 2.4816",
  ...
  {
    title: "INCONEL 625 COLD ROLLED SHEETS",
    image: inconelCRSheets,
    items: [
      "Inconel 625 Cold Rolled Sheets (ASTM B443)",
      "UNS N06625 / 2.4856",
  ...
  {
    title: "INCONEL 718 SPECIALTY SHEETS",
    image: inconelCRSheets,
    items: [
      "Inconel 718 Specialty Sheets (ASTM B670)",
      "UNS N07718 / 2.4668",
      "Precipitation-Hardenable for Maximum Strength",
...
const gradesData = [
  ...
  { grade: "Inconel 690", uns: "N06690", werkstoff: "2.4642", standard: "ASTM B168 / ASME SB168" },
];
...
// Thickness and weight charts for sheets (average density ~8.4 g/cm³)
const leftThickness = [
...
// Approx weights for Inconel sheets (density ~8.4 g/cm³)
const leftData = [
...
const leftItems = [
  "Inconel 600 / 625 / 718 / X-750 / 690 Hot Rolled & Cold Rolled Sheets",
  ...
  "Inconel Sheets Manufacturer in India",
];
...
const rightItems = [
  ...
  "Inconel Sheets Supplier in Mumbai",
];

const searchTerms = [
  "Inconel 625 Sheet Price Per Kg",
  "Inconel 600 Sheet Weight Chart",
  "Inconel Sheet Supplier In India",
  "Inconel 718 Sheet Specifications",
  "Inconel X-750 Sheet Price In Mumbai",
  "Inconel 690 Sheet Dimensions",
  "Inconel Sheet Price List",
  "Inconel 625 Sheet Weight Calculator",
  "Inconel Sheet Mechanical Properties",
  "Inconel Sheet Stockist",
  "Inconel 718 Sheet Heat Treatment",
  "Inconel Sheet Price Per Kg In India",
  "Inconel 600 Sheet Exporter",
  "Inconel Sheet Manufacturers In Mumbai",
  "Buy Inconel Sheets In India",
];
...
const InconelSheetsDetails = () => {
  return (
    <>
      <Helmet>
        <title>Inconel Sheets Supplier – Inconel 600, 625, 718, X-750, 690 Sheets</title>
        <meta
          name="description"
          content="Leading supplier of Inconel sheets including 600, 625, 718, X-750, 690. Hot rolled, cold rolled, coils, strips, circles, and custom sizes. Exceptional high-temperature strength and corrosion resistance."
        />
      </Helmet>
      ...
      <div className="product-details-container">
        <div className="product-main-content">
          <section className="product-content">
            <div className="content-header">
              <h1>INCONEL SHEETS SUPPLIER – HOT ROLLED, COLD ROLLED, COILS & CUSTOM SIZES</h1>
            </div>
            <div className="content-image">
              <img src={inconel} alt="Inconel Sheets" className="main-image" />
            </div>
          ...
          <section className="stock-section">
            <div className="stock-container">
              <div className="stock-heading">
                <h2>READY STOCK AVAILABILITY – INCONEL SHEETS</h2>
              </div>
          ...
          <section className="chemical-section">
            <div className="container">
              <div className="section-title">
                <h2>CHEMICAL COMPOSITION OF INCONEL SHEETS</h2>
              </div>
              <div className="table-responsive">
          ...
          <section className="mechanical-section">
            <div className="container">
              <div className="section-title">
                <h2>MECHANICAL PROPERTIES OF INCONEL SHEETS</h2>
              </div>
              <div className="table-responsive">
          ...
          <section className="thickness-section">
            <div className="container">
              <div className="section-title">
                <h2>
                  THICKNESS RANGE AVAILABILITY: INCONEL SHEETS
          ...
          <section className="coil-weight-section">
            <div className="container">
              <div className="section-title">
                <h2>UNIFIED WEIGHT CHART: INCONEL SHEETS</h2>
              </div>
              <div className="table-responsive">
          ...
          <section className="finish-weight-section">
            <div className="container">
              <div className="section-title">
                <h2>INCONEL SHEET SUPPLY RANGE (UNIFIED)</h2>
          ...
          <section className="gauge-chart-section">
            <div className="container">
              <div className="section-title">
                <h2>UNIFIED INCONEL SHEET PRICE RANGE</h2>
              </div>
              <div className="table-responsive">
          ...
          <section className="specialty-weight-section">
            <div className="container">
              <div className="section-title">
                <h2>SPECIALIZED IN FOLLOWING INCONEL SHEETS</h2>
              </div>
              <div className="table-responsive">
          ...
          <section className="tolerance-section">
            <div className="container">
              <div className="section-title">
                <h2>SEARCHES RELATED TO INCONEL SHEETS</h2>
              </div>
              <div className="table-responsive">
        ...
        <div className="product-sidebar-wrapper">
          ...
          <div className="quote-card">
            <h2>GET A QUOTE</h2>
            <p>Immediate pricing for Inconel sheets. Contact our sales team for bulk discounts and technical support.</p>
...
export default InconelSheetsDetails;