...
import monel400HR from "../../products-image/ss-hr-plates.webp";
import monel400CR from "../../products-image/ss-cr-plates.webp";
import monel400Specialty from "../../products-image/ss-custom-plates.webp";

import monel400 from "../../products-image/ss-monel-400-plates.webp";

import "./Productsdetails.css";

const stockData = [
  {
    title: "MONEL 400 HOT ROLLED PLATES",
    image: monel400HR,
    items: [
  ...
  {
    title: "MONEL 400 COLD ROLLED PLATES",
    image: monel400CR,
    items: [
  ...
  {
    title: "MONEL 400 SPECIALTY PLATES",
    image: monel400Specialty,
    items: [
      "Monel 400 Specialty Plates",
      "Marine & Seawater Corrosion Resistant",
      "High Nickel & Copper Content",
      "For Chemical Processing & Marine Equipment",
    ],
  },
];
...
const leftData = [
  { size: "4000 × 2000 × 2.0", weight: "141.3" },
  { size: "4000 × 2000 × 3.0", weight: "211.9" },
  { size: "2500 × 1250 × 4.0", weight: "110.4" },
  { size: "3000 × 1500 × 4.0", weight: "158.9" },
  { size: "4000 × 2000 × 4.0", weight: "282.6" },
  { size: "2500 × 1250 × 5.0", weight: "138.0" },
];

const rightData = [
  { size: "3000 × 1500 × 5.0", weight: "198.7" },
  { size: "4000 × 2000 × 5.0", weight: "353.2" },
  { size: "2500 × 1250 × 6.0", weight: "165.6" },
  { size: "3000 × 1500 × 6.0", weight: "238.4" },
  { size: "4000 × 2000 × 6.0", weight: "423.8" },
  { size: "—", weight: "—" },
];
...
const leftDataNew = [
  ...
  { size: "3000 × 1500 × 3.0", weight: "119.2" },
  { size: "2000 × 1000 × 4.0", weight: "70.6" },
  { size: "2500 × 1250 × 4.0", weight: "110.4" },
  { size: "3000 × 1500 × 4.0", weight: "158.9" },
...
const rightDataNew = [
  ...
  { size: "4000 × 2000 × 8.0", weight: "565.1" },
  { size: "2500 × 1250 × 10.0", weight: "276.0" },
  { size: "3000 × 1500 × 10.0", weight: "397.4" },
  { size: "4000 × 1500 × 10.0", weight: "529.8" },
  { size: "4000 × 2000 × 10.0", weight: "706.4" },
  { size: "2500 × 1250 × 12.0", weight: "331.2" },
  { size: "3000 × 1500 × 12.0", weight: "476.8" },
  { size: "4000 × 1500 × 12.0", weight: "635.8" },
...
const leftItems = [
  "Hot Rolled & Cold Rolled Monel 400 Plates",
  "ASTM B127 / ASME SB127 Compliant",
  "High Ni (63-70%) & Cu (28-34%) for Marine Resistance",
  "Excellent Resistance to Seawater & Chlorides",
  "Outstanding Performance in Hydrofluoric Acid",
  "Monel 400 Plates Manufacturer in India",
];

const rightItems = [
  "ASTM B127 / SB127 Monel 400 Plates",
  ...
  "Monel 400 Plates Supplier in Mumbai",
];

const searchTerms = [
  "Monel 400 Plate Price Per Kg",
  ...
  "Monel 400 Plate Dimensions",
  "Monel 400 Plate Specifications Pdf",
  "Monel 400 Seawater Resistance",
  "Monel 400 Plate Price List",
  "Monel 400 Plate Weight Calculator",
  "Monel 400 Mechanical Properties",
  "Monel 400 Plate Stockist",
  "Monel 400 Heat Treatment",
  "Monel 400 Plate Price Per Kg In India",
  "Monel 400 2.4360",
  "Monel 400 Plates Manufacturers In Mumbai",
  "Buy Monel 400 Plates In India",
];
...
const MonelPlatesDetails = () => {
  return (
    <>
      <Helmet>
        <title>Monel 400 Plates Supplier – UNS N04400 Nickel-Copper Alloy Plates</title>
        <meta
          name="description"
          content="Supplier of Monel 400 plates (UNS N04400, 2.4360) with exceptional resistance to seawater, marine environments, and hydrofluoric acid. Hot rolled, cold rolled, polished plates available."
        />
      </Helmet>
        ...
        <div className="product-main-content">
          <section className="product-content">
            <div className="content-header">
              <h1>MONEL 400 PLATES SUPPLIER – UNS N04400 NICKEL-COPPER ALLOY PLATES</h1>
            </div>
            <div className="content-image">
              <img src={monel400} alt="Monel 400 Plates" className="main-image" />
            </div>
          ...
          <section className="product-content">
            <div className="content-header">
              <h2>MONEL 400 PLATES: EXCEPTIONAL PERFORMANCE IN MARINE & CHEMICAL ENVIRONMENTS</h2>
              ...
              <hr />
              <h3>KEY FEATURES OF MONEL 400 PLATES</h3>
              ...
              <p><strong>Good Weldability & Fabricability</strong> – Monel 400 can be readily welded, brazed, and soldered using standard techniques, maintaining corrosion resistance in the heat‑affected zone.</p>
              <hr />
              <h3>SPECIFICATIONS & STANDARDS</h3>
              <p>Our Monel 400 plates conform to international standards including <strong>ASTM B127 / ASME SB127</strong> (standard specification for nickel‑copper alloy plate, sheet, and strip). We supply plates in various finishes (No.1, 2B, BA, No.4, HL, Mirror) and can custom‑cut to your exact dimensions.</p>
            </div>
          </section>

          <section className="specification-section">
            <h2>Specification: Monel 400 Plates</h2>
          ...
          <section className="stock-section">
            <div className="stock-container">
              <div className="stock-heading">
                <h2>READY STOCK AVAILABILITY – MONEL 400 PLATES</h2>
              </div>
          ...
          <section className="chemical-section">
            <div className="container">
              <div className="section-title">
                <h2>CHEMICAL COMPOSITION OF MONEL 400 PLATES</h2>
              </div>
              <div className="table-responsive">
          ...
          <section className="mechanical-section">
            <div className="container">
              <div className="section-title">
                <h2>MECHANICAL PROPERTIES OF MONEL 400 PLATES</h2>
              </div>
              <div className="table-responsive">
          ...
          <section className="thickness-section">
            <div className="container">
              <div className="section-title">
                <h2>
                  SIZE RANGE AVAILABILITY: MONEL 400 PLATES
                  <span>(ASTM B127 / SB127)</span>
                </h2>
          ...
          <section className="coil-weight-section">
            <div className="container">
              <div className="section-title">
                <h2>UNIFIED WEIGHT CHART: MONEL 400 PLATES</h2>
              </div>
              <div className="table-responsive">
          ...
          <section className="finish-weight-section">
            <div className="container">
              <div className="section-title">
                <h2>MONEL 400 PLATE SUPPLY RANGE (UNIFIED)</h2>
          ...
          <section className="gauge-chart-section">
            <div className="container">
              <div className="section-title">
                <h2>UNIFIED MONEL 400 PLATE PRICE RANGE</h2>
              </div>
              <div className="table-responsive">
          ...
          <section className="specialty-weight-section">
            <div className="container">
              <div className="section-title">
                <h2>SPECIALIZED IN FOLLOWING MONEL 400 PLATES</h2>
              </div>
              <div className="table-responsive">
          ...
          <section className="tolerance-section">
            <div className="container">
              <div className="section-title">
                <h2>SEARCHES RELATED TO MONEL 400 PLATES</h2>
              </div>
              <div className="table-responsive">
...
export default MonelPlatesDetails;
