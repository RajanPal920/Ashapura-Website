...
// Replace these image paths with your actual Inconel 625 product images
...
const stockData = [
  {
    title: "INCONEL 625 SEAMLESS PIPES",
    image: inconelSeamless,
    items: [
      "Inconel 625 Seamless Pipes (ASTM B444)",
      "UNS N06625 / 2.4856 Seamless Piping",
      "Cold Drawn & Annealed 625 Seamless Tubes",
      "Aerospace & Marine Grade 625 Seamless Pipes",
    ],
  },
  {
    title: "INCONEL 625 WELDED PIPES",
    image: inconelWelded,
    items: [
      "Inconel 625 Welded Pipes (ASTM B705 / B775)",
      "Inconel 625 ERW / EFW Pipes",
      "Large Diameter Welded 625 Pipes",
      "High-Corrosion Welded Piping Systems",
    ],
  },
  {
    title: "INCONEL 625 ERW PIPES",
    image: inconelErw,
    items: [
      "Inconel 625 ERW Pipes",
      "Electric Resistance Welded 625 Pipes",
      "Inconel 625 ERW Round & Square Pipes",
      "Precision Welded 625 for Critical Applications",
    ],
  },
  {
    title: "INCONEL 625 ROUND PIPES",
    image: inconelRound,
    items: [
      "Inconel 625 Round Pipes",
      "Inconel 625 Round Hollow Sections",
      "Inconel 625 Round Pipes for Chemical Processing",
      "Precision Inconel 625 Round Pipes",
    ],
  },
  {
    title: "INCONEL 625 SQUARE PIPES",
    image: inconelSquare,
    items: [
      "Inconel 625 Square Pipes",
      "Inconel 625 Square Hollow Sections",
      "Inconel 625 Square Tubes for Structural Use",
      "Custom Inconel 625 Square Pipes",
    ],
  },
  {
    title: "INCONEL 625 HOLLOW PIPES",
    image: inconelHollow,
    items: [
      "Inconel 625 Hollow Pipes",
      "Inconel 625 Heavy Wall Hollow Pipes",
      "Inconel 625 Hollow Section",
      "Inconel 625 Hollow Pipes for Heat Exchangers",
    ],
  }
];
...
const gradesData = [
  {
    ...
    uns: "N06625",
    werkstoff: "2.4856",
    standard: "ASTM B444 / B705 / B517",
  },
  {
    grade: "Inconel 625 (AMS)",
    uns: "N06625",
    werkstoff: "2.4856",
    standard: "AMS 5581 / ASTM B829",
  },
];
...
const chemicalData = [
  {
    ...
    ni: "58.0 min",
    mo: "8.0-10.0",
    other: "Nb+Ta: 3.15-4.15, Fe: 5.0 max, Al: 0.40 max, Ti: 0.40 max",
  },
];

const mechanicalData = [
  {
    grade: "Inconel 625 (Annealed)",
    tensile: "825 MPa (120 ksi) min",
...
const leftItems = [
  "Inconel 625 Seamless & Welded Pipes",
  "Inconel 625 Annealed & Cold Drawn Pipes",
  "Inconel 625 ERW & EFW Pipes",
  "Inconel 625 Round, Square & Rectangular Pipes",
  "Inconel 625 Heavy Wall & Hollow Pipes",
  "Inconel 625 Pipes for Marine & Chemical Processing",
  "Inconel 625 Pipe Manufacturer in India",
];

const rightItems = [
  "ASTM B444 / B705 / B517 / B829 / AMS 5581",
  ...
  "Inconel 625 Hollow Section & Square Pipes",
...
const searchTerms = [
  ...
  "Inconel 625 Pipe Price In Mumbai",
  "Inconel 625 Pipe Dimensions",
  "Inconel 625 Pipe Specifications Pdf",
  "Inconel 625 Corrosion Resistance",
  "Inconel 625 Pipe Price List",
  "Inconel 625 Pipe Weight Calculator",
  "Inconel 625 Pipe Mechanical Properties",
  "Inconel 625 Pipe Stockist",
  "Inconel 625 Pipe Equivalent Grades",
  "Inconel 625 Pipe Price Per Kg In India",
  "Inconel 625 Seamless Pipe Exporter",
  "Inconel 625 Welded Pipe Supplier",
  "Inconel 625 Pipe Sizes",
  "Inconel 625 Pipe Schedule",
  "Inconel 625 Pipe UNS N06625",
  "Inconel 625 Pipe 2.4856",
  "Inconel 625 Pipe Manufacturers In Mumbai",
  "Buy Inconel 625 Pipes In India",
];
...
const Inconel625PipesDetails = () => {
  return (
    <>
      <Helmet>
        <title>Inconel 625 Pipes Supplier, Stockist & Exporter</title>
        <meta
          name="description"
          content="Leading supplier of Inconel 625 (UNS N06625) pipes in seamless, welded, ERW, and custom sizes. Excellent corrosion resistance for marine, chemical, and nuclear applications."
        />
      </Helmet>
      ...
      <div className="product-details-container">
        <div className="product-main-content">
          <section className="product-content">
            <div className="content-header">
              <h1>INCONEL 625 PIPES SUPPLIER – SEAMLESS, WELDED, ERW & CUSTOM</h1>
            </div>
            <div className="content-image">
              <img src={inconel625} alt="Inconel 625 Pipes" className="main-image" />
            </div>
          ...
          <section className="product-content">
            <div className="content-header">
              <h2>INCONEL 625 PIPES – NICKEL-CHROMIUM-MOLYBDENUM SUPERALLOY FOR ULTIMATE CORROSION RESISTANCE</h2>
              <p>
                <strong>Inconel 625</strong> (UNS N06625 / Werkstoff 2.4856) is a nickel-chromium-molybdenum superalloy engineered for exceptional resistance to a wide range of severely corrosive environments, including seawater, acids, and high-temperature oxidizing conditions. It offers outstanding resistance to pitting, crevice corrosion, and stress corrosion cracking, making it the go-to material for the most demanding industrial applications.
              </p>
              <hr />
              <h3>SEAMLESS & WELDED INCONEL 625 PIPES</h3>
              <p>
                We supply Inconel 625 pipes in <strong>seamless (ASTM B444)</strong> and <strong>welded (ASTM B705 / B775)</strong> forms, available from ½" NB to 24" NB and schedules SCH 5 to SCH XXS. Our inventory includes solution-annealed, cold-drawn, and precision tubes to meet the most stringent specifications.
              </p>
              <h3>APPLICATIONS & ADVANTAGES</h3>
              <p>
                Inconel 625 is the material of choice for critical applications in <strong>marine engineering</strong> (propellers, shafts), <strong>chemical processing</strong> (reactors, heat exchangers), <strong>aerospace</strong> (exhaust systems), and <strong>nuclear reactors</strong>. Its high strength, excellent weldability, and fatigue resistance ensure reliable performance in extreme conditions, from cryogenic temperatures up to 980°C (1800°F).
              </p>
              <hr />
              <h3>COMPLIANCE & STANDARDS</h3>
              <p>
                Our Inconel 625 pipes are manufactured and tested in accordance with <strong>ASTM / ASME</strong> and <strong>AMS</strong> specifications, including <strong>ASTM B444, B705, B517, B775, B829</strong> and <strong>AMS 5581</strong>. We provide comprehensive mill test certificates, PMI reports, and third-party inspection services to ensure full traceability.
              </p>
            </div>
          </section>

          <section className="specification-section">
            <h2>UNIFIED SPECIFICATION: INCONEL 625 PIPES</h2>
            <div className="spec-grid">
              <div className="spec-card">
                <h4>Standard</h4>
                <p>ASTM / ASME B444, B705, B517, B775, B829 / AMS 5581</p>
              </div>
              <div className="spec-card">
                <h4>Size Range</h4>
          ...
          <section className="stock-section">
            <div className="stock-container">
              <div className="stock-heading">
                <h2>READY STOCK AVAILABILITY – INCONEL 625 PIPES</h2>
              </div>
          ...
          <section className="grades-section">
            <div className="container">
              <div className="section-title">
                <h2>EQUIVALENT GRADES: INCONEL 625</h2>
              </div>
          ...
          <section className="chemical-section">
            <div className="container">
              <div className="section-title">
                <h2>CHEMICAL COMPOSITION OF INCONEL 625 PIPES</h2>
              </div>
              <div className="table-responsive">
          ...
          <section className="mechanical-section">
            <div className="container">
              <div className="section-title">
                <h2>MECHANICAL PROPERTIES OF INCONEL 625 PIPING</h2>
              </div>
              <div className="table-responsive">
          ...
          <section className="thickness-section">
            <div className="container">
              <div className="section-title">
                <h2>
                  SIZE RANGE AVAILABILITY: INCONEL 625 PIPES
                  <span>(ASTM / ASME B444, B705, B517)</span>
                </h2>
          ...
          <section className="coil-weight-section">
            <div className="container">
              <div className="section-title">
                <h2>UNIFIED WEIGHT CHART: INCONEL 625 PIPES</h2>
              </div>
              <div className="table-responsive">
          ...
          <section className="finish-weight-section">
            <div className="container">
              <div className="section-title">
                <h2>INCONEL 625 PIPE SUPPLY RANGE (UNIFIED)</h2>
          ...
          <section className="gauge-chart-section">
            <div className="container">
              <div className="section-title">
                <h2>UNIFIED INCONEL 625 PIPE PRICE RANGE</h2>
              </div>
              <div className="table-responsive">
          ...
          <section className="specialty-weight-section">
            <div className="container">
              <div className="section-title">
                <h2>SPECIALIZED IN FOLLOWING INCONEL 625 PIPES</h2>
              </div>
              <div className="table-responsive">
          ...
          <section className="tolerance-section">
            <div className="container">
              <div className="section-title">
                <h2>SEARCHES RELATED TO INCONEL 625 PIPES</h2>
              </div>
              <div className="table-responsive">
        ...
        <div className="product-sidebar-wrapper">
          ...
          <div className="quote-card">
            <h2>GET A QUOTE</h2>
            <p>Immediate pricing for Inconel 625 pipes. Contact our sales team for bulk discounts and technical support.</p>
...
export default Inconel625PipesDetails;