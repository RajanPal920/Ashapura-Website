...
// Replace these image paths with your actual Nickel 200/201 images
import nickelSeamless from "../../products-image/ss-nimonic-pipes.webp";
import nickelWelded from "../../products-image/ss-nichrome-pipes.webp";
import nickelErw from "../../products-image/ss-nitronic-pipes.webp";
import nickelEfw from "../../products-image/ss-nilo42-pipes.webp";
import nickelUbo from "../../products-image/ss-alloy-a286-pipes.webp";
import nickelSpecial from "../../products-image/ss-alloy-926-pipes.webp";

import nickelAlloy from "../../products-image/nickel-alloy-201-pipes.webp"; 
import "./Productsdetails.css";

const stockData = [
  {
    title: "NICKEL 200 / 201 SEAMLESS PIPES",
    image: nickelSeamless,
    items: [
      "Nickel 200 Seamless Pipes (ASTM B161)",
      "Nickel 201 Seamless Pipes (ASTM B161)",
      "UNS N02200 / N02201 Seamless Piping",
      "Cold Drawn Nickel 200/201 Seamless Pipes",
    ],
  },
  {
    title: "NICKEL 200 / 201 WELDED PIPES",
    image: nickelWelded,
    items: [
      "Nickel 200 Welded Pipes (ASTM B725)",
      "Nickel 201 Welded Pipes (ASTM B725)",
      "ERW Nickel 200/201 Pipes",
      "Large Diameter Welded Nickel Pipes",
    ],
  },
  {
    title: "NICKEL 200 / 201 ERW PIPES",
    image: nickelErw,
    items: [
      "Nickel 200 ERW Pipes",
      "Nickel 201 ERW Pipes",
      "Electric Resistance Welded Nickel Pipes",
      "Nickel 200/201 ERW Round & Square Pipes",
    ],
  },
  {
    title: "NICKEL 200 / 201 ROUND PIPES",
    image: nickelEfw,
    items: [
      "Nickel 200 Round Pipes",
      "Nickel 201 Round Hollow Sections",
      "Nickel 200/201 Round Pipes for Chemical Industry",
      "Precision Nickel 200/201 Round Pipes",
    ],
  },
  {
    title: "NICKEL 200 / 201 SQUARE PIPES",
    image: nickelUbo,
    items: [
      "Nickel 200 Square Pipes",
      "Nickel 201 Square Hollow Sections",
      "Nickel 200/201 Square Tubes",
      "Custom Nickel 200/201 Square Pipes",
    ],
  },
  {
    title: "NICKEL 200 / 201 HOLLOW PIPES",
    image: nickelSpecial,
    items: [
      "Nickel 200 Hollow Pipes",
      "Nickel 201 Heavy Wall Hollow Pipes",
      "Nickel 200/201 Hollow Section",
      "Nickel 200/201 Hollow Pipes for Heat Exchangers",
    ],
  }
];
...
const mechanicalData = [
  {
    grade: "Nickel 200",
    tensile: "462 MPa (67 ksi)",
    yield: "148 MPa (21.5 ksi)",
    elongation: "45%",
    density: "8.89 g/cm³",
  },
  {
...
// Thickness, weight, gauge, tolerance tables remain the same (generic pipe data)
// but headings will be updated.
const leftThickness = [
  "0.4 mm",
  "0.5 mm",
  "0.8 mm",
...
const leftItems = [
  "Nickel 200 / 201 Seamless & Welded Pipes",
  "Nickel 200 / 201 ERW & EFW Pipes",
  "Nickel 200 / 201 Round, Square & Rectangular Pipes",
  "Nickel 200 / 201 Heavy Wall Pipes",
  "Nickel 200 / 201 Heat Exchanger Tubes",
  "Nickel 200 / 201 Caustic Soda Resistant Piping",
  "Nickel 200 / 201 Pipes Manufacturer in India",
];

const rightItems = [
  "ASTM B161 / B725 / B730 / B775 Nickel Pipes",
  ...
  "Nickel 200 / 201 Hollow Section & Square Pipes",
  "Nickel 200 / 201 Pipe Supplier in Mumbai",
];

const searchTerms = [
  "Nickel 200 Pipe Price Per Kg",
  "Nickel 201 Seamless Pipe Weight Chart",
  "Nickel 200 Pipe Supplier In India",
  "Nickel 201 Chemical Composition",
  "Nickel 200 Pipe Pressure Rating",
  "Nickel 201 Pipe Price In Mumbai",
  "Nickel 200 Pipe Dimensions",
  "Nickel 201 Pipe Specifications Pdf",
  "Nickel 200 Pipe Corrosion Resistance",
  "Nickel 201 Pipe Price List",
  "Nickel 200 Pipe Weight Calculator",
  "Nickel 201 Pipe Mechanical Properties",
  "Nickel 200 Pipe Stockist",
  "Nickel 201 Pipe Heat Treatment",
  "Nickel 200 Pipe Price Per Kg In India",
  "Nickel 201 Seamless Pipe Exporter",
  "Nickel 200 Welded Pipe Supplier",
  "Nickel 201 Pipe Sizes",
  "Nickel 200 Pipe Schedule",
  "Nickel 201 Pipe Equivalent Grades",
  "Nickel 200 Pipe UNS N02200",
  "Nickel 201 Pipe 2.4068",
  "Nickel Alloy 200/201 Pipe Manufacturers In Mumbai",
  "Buy Nickel Alloy 200/201 Pipes In India",
];

// Countries, Cities, Products, Materials remain unchanged from the original
const countries = [
  { name: "India", code: "IN" },
  { name: "Japan", code: "JP" },
  { name: "Russia", code: "RU" },
...
const NickelAlloy200PipesDetails = () => {
  return (
    <>
      <Helmet>
        <title>Nickel Alloy 200 / 201 Pipes Supplier, Stockist & Exporter</title>
        <meta
          name="description"
          content="Leading supplier of Nickel 200 (UNS N02200) and Nickel 201 (UNS N02201) pipes in seamless, welded, ERW, and custom sizes. High resistance to caustic soda and alkalis."
        />
      </Helmet>
      ...
      <Banner
        title="NICKEL ALLOY 200 / 201 PIPES"
        image={ProductBanner}
      />
      ...
      <div className="product-details-container">
        <div className="product-main-content">
          <section className="product-content">
            <div className="content-header">
              <h1>NICKEL ALLOY 200/201 PIPES SUPPLIER – SEAMLESS, WELDED, ERW & CUSTOM</h1>
            </div>
            <div className="content-image">
              <img src={nickelAlloy} alt="Nickel Alloy 200/201 Pipes" className="main-image" />
            </div>
          ...
          <section className="product-content">
            <div className="content-header">
              <h2>NICKEL 200 / 201 PIPES – PURE NICKEL FOR DEMANDING ALKALINE ENVIRONMENTS</h2>
              <p>
                <strong>Nickel 200</strong> (UNS N02200) and <strong>Nickel 201</strong> (UNS N02201) are commercially pure wrought nickel alloys. They offer exceptional resistance to caustic soda and other alkaline media, excellent thermal and electrical conductivity, and good mechanical properties across a wide range of temperatures. Nickel 201 is the low-carbon version, ideal for service above 315°C (600°F) where carbon precipitation may cause embrittlement.
              </p>
              <hr />
              <h3>SEAMLESS & WELDED NICKEL 200/201 PIPES</h3>
              <p>
                Our Nickel 200/201 pipes are available in <strong>seamless (ASTM B161)</strong> and <strong>welded (ASTM B725)</strong> forms, ranging from ½" NB to 24" NB, in schedules SCH 5 to SCH XXS. We also supply ERW, EFW, and cold-drawn pipes for precision applications.
              </p>
              <h3>APPLICATIONS & ADVANTAGES</h3>
              <p>
                Nickel 200/201 pipes are widely used in the production of caustic soda, soap, and other alkaline chemicals. They are also employed in food processing equipment, heat exchangers, condensers, and electrical components. The alloys' low magnetic permeability and high ductility make them easy to form and weld.
              </p>
              <hr />
              <h3>COMPLIANCE & STANDARDS</h3>
              <p>
                Our Nickel 200/201 pipes are manufactured in strict accordance with <strong>ASTM / ASME</strong> specifications such as <strong>ASTM B161, B725, B163, B730, B775</strong> and <strong>ASME SB161, SB725, SB163, SB730, SB775</strong>. We provide full material test certificates, PMI reports, and third-party inspections.
              </p>
            </div>
          </section>

          <section className="specification-section">
            <h2>UNIFIED SPECIFICATION: NICKEL 200 / 201 PIPES</h2>
            <div className="spec-grid">
              <div className="spec-card">
                <h4>Standard</h4>
                <p>ASTM / ASME B161, B725, B163, B730</p>
              </div>
              <div className="spec-card">
                <h4>Size Range</h4>
              ...
              <div className="spec-card">
                <h4>Length</h4>
                <p>Custom lengths up to 12 meters (single random / double random)</p>
              </div>
              <div className="spec-card">
                <h4>Forms</h4>
          ...
          <section className="stock-section">
            <div className="stock-container">
              <div className="stock-heading">
                <h2>READY STOCK AVAILABILITY – NICKEL 200 / 201 PIPES</h2>
              </div>
          ...
          <section className="chemical-section">
            <div className="container">
              <div className="section-title">
                <h2>CHEMICAL COMPOSITION OF NICKEL 200 / 201 PIPES</h2>
              </div>
              <div className="table-responsive">
          ...
          <section className="mechanical-section">
            <div className="container">
              <div className="section-title">
                <h2>MECHANICAL PROPERTIES OF NICKEL 200 / 201 PIPING</h2>
              </div>
              <div className="table-responsive">
          ...
          <section className="thickness-section">
            <div className="container">
              <div className="section-title">
                <h2>
                  SIZE RANGE AVAILABILITY: NICKEL 200 / 201 PIPES
                  <span>(ASTM / ASME B161, B725, B163)</span>
                </h2>
          ...
          <section className="coil-weight-section">
            <div className="container">
              <div className="section-title">
                <h2>UNIFIED WEIGHT CHART: NICKEL 200 / 201 PIPES</h2>
              </div>
              <div className="table-responsive">
          ...
          <section className="finish-weight-section">
            <div className="container">
              <div className="section-title">
                <h2>NICKEL 200 / 201 PIPE SUPPLY RANGE (UNIFIED)</h2>
          ...
          <section className="gauge-chart-section">
            <div className="container">
              <div className="section-title">
                <h2>UNIFIED NICKEL 200 / 201 PIPE PRICE RANGE</h2>
              </div>
              <div className="table-responsive">
          ...
          <section className="specialty-weight-section">
            <div className="container">
              <div className="section-title">
                <h2>SPECIALIZED IN FOLLOWING NICKEL 200 / 201 PIPES</h2>
              </div>
              <div className="table-responsive">
          ...
          <section className="tolerance-section">
            <div className="container">
              <div className="section-title">
                <h2>SEARCHES RELATED TO NICKEL 200 / 201 PIPES</h2>
              </div>
              <div className="table-responsive">
        ...
        <div className="product-sidebar-wrapper">
          ...
          <div className="quote-card">
            <h2>GET A QUOTE</h2>
            <p>Immediate pricing for Nickel 200/201 pipes. Contact our sales team for bulk discounts and technical support.</p>
...
export default NickelAlloy200PipesDetails;