...
import incoloyHollow from "../../products-image/ss-nichrome-pipes.webp";

import incoloy800 from "../../products-image/ss-incoloy-800h-pipes.webp";
import "./Productsdetails.css";


const stockData = [
  {
    title: "INCOLOY 800H SEAMLESS PIPES",
    image: incoloySeamless,
    items: [
      "Incoloy 800H Seamless Pipes",
      "ASTM B167 UNS N08810",
      "High-Temperature Creep Resistance",
      "Excellent Oxidation Resistance",
    ],
  },
  {
    title: "INCOLOY 800HT SEAMLESS PIPES",
    image: incoloyWelded,
    items: [
      "Incoloy 800HT Seamless Pipes",
      "ASTM B167 UNS N08811",
      "Enhanced Creep-Rupture Strength",
      "Al + Ti Controlled for Superior Performance",
    ],
  },
  {
    title: "INCOLOY 800H WELDED PIPES",
    image: incoloyErw,
    items: [
      "Incoloy 800H Welded Pipes",
      "ASTM B514 / B515",
  ...
  {
    title: "INCOLOY 800HT WELDED PIPES",
    image: incoloyRound,
    items: [
      "Incoloy 800HT Welded Pipes",
      "ASTM B514 / B515 UNS N08811",
      "High Strength Welded",
      "Petrochemical & Reformer Service",
    ],
  },
  {
    title: "INCOLOY ERW & EFW PIPES",
    image: incoloySquare,
    items: [
      "Incoloy 800H / 800HT ERW / EFW",
  ...
  {
    title: "INCOLOY 800H / 800HT SPECIALTY PIPES",
    image: incoloyHollow,
    items: [
      "Incoloy 800H & 800HT Family",
...
const gradesData = [
  {
    ...
    uns: "N08810",
    werkstoff: "1.4958",
    standard: "ASTM B163 / B167 / B407 / B514 / B515",
  },
  {
    grade: "Incoloy 800HT",
    uns: "N08811",
...
const leftItems = [
  "Incoloy 800H & 800HT Seamless / Welded Pipes",
  "ASTM B163 / B167 / B407 / B514 / B515 Compliant",
  "Excellent Creep-Rupture Strength at High Temperatures",
  "Resistant to Carburization & Oxidation up to 1100°C",
  "Incoloy 800HT – Enhanced Al+Ti for Superior Strength",
  "Incoloy 800H / 800HT Manufacturer in India",
];
...
const rightItems = [
  ...
  "Incoloy Hollow Section & Square Pipes",
  "Incoloy 800H/HT Pipe Supplier in Mumbai",
];

const searchTerms = [
  "Incoloy 800H Pipe Price Per Kg",
  "Incoloy 800HT Pipe Price Per Kg",
  ...
  "Incoloy 800H Pipe Price In Mumbai",
  "Incoloy 800HT Heat Treatment",
  "Incoloy 800H Pipe Specifications Pdf",
  "Incoloy 800H vs 800HT Difference",
  "Incoloy 800H Pipe Weight Calculator",
  "Incoloy 800H Pipe Stockist",
  "Incoloy 800H Pipe Exporter",
  "Incoloy 800HT Welded Pipe Supplier",
  "Incoloy 800H Pipe Schedule",
  "Incoloy 800HT Equivalent Grades",
  "Incoloy 800H 1.4958",
  "Incoloy 800HT 1.4959",
  "Incoloy 800H Pipe Manufacturers In Mumbai",
  "Buy Incoloy 800H Pipes In India",
];
...
const Incoloy800PipesDetails = () => {
  return (
    <>
        <Helmet>
            <title>Incoloy 800H / 800HT Pipes Supplier – UNS N08810 / N08811 Alloy Pipes</title>
            <meta
            name="description"
            content="Supplier of Incoloy 800H / 800HT pipes (UNS N08810 / N08811) with exceptional high-temperature creep and rupture strength. Seamless, welded, ERW, EFW pipes available."
            />
        </Helmet>
        ...
        <Banner
            title="INCOLOY 800H / 800HT PIPES"
            image={ProductBanner}
        />
      ...
      <div className="product-details-container">
        ...
        <section className="product-content">
            <div className="content-header">
                <h1>INCOLOY 800H / 800HT PIPES SUPPLIER – NICKEL-IRON-CHROMIUM ALLOY PIPES</h1>
            </div>
            <div className="content-image">
                <img src={incoloy800} alt="Incoloy 800H / 800HT Pipes" className="main-image" />
            </div>
        ...
        <section className="product-content">
            <div className="content-header">
                <h2>INCOLOY 800H / 800HT PIPES: HIGH-TEMPERATURE STRENGTH AND OXIDATION RESISTANCE</h2>
                <p>Incoloy 800H (UNS N08810) and Incoloy 800HT (UNS N08811) are nickel-iron-chromium alloys designed for exceptional creep and rupture strength at elevated temperatures. With a controlled carbon content and additions of aluminum and titanium, these alloys offer superior resistance to oxidation, carburization, and nitriding up to 1100°C. They are the premier choice for steam methane reformers (SMR), industrial furnaces, and petrochemical processing equipment.</p>
                <hr/>
                <h3>INCOLOY 800H PIPES</h3>
                <p><strong>Incoloy 800H</strong> features a carbon content of 0.05–0.10% and restricted aluminum and titanium levels (0.15–0.60%). This composition provides excellent creep-rupture strength and is widely used in high-temperature process piping.</p>
                <h3>INCOLOY 800HT PIPES</h3>
                <p><strong>Incoloy 800HT</strong> has a similar carbon content but with a higher, controlled combination of aluminum and titanium (0.85–1.20%). This precipitates fine particles that further enhance rupture strength and long-term stability, making it ideal for the most demanding applications.</p>
                <hr/>
                <h3>SPECIFICATIONS & STANDARDS</h3>
                <p>Our Incoloy 800H and 800HT pipes conform to international standards including <strong>ASTM B163</strong> (seamless tubes), <strong>ASTM B167</strong> (seamless pipes), <strong>ASTM B407</strong> (welded), <strong>ASTM B514</strong> (welded pipe), and <strong>ASTM B515</strong> (welded tube). Available in seamless, welded, ERW, and EFW forms with custom schedules and lengths.</p>
            </div>
        </section>
    ...
    <h2>Specification: Incoloy 800H / 800HT Pipes</h2>

    <div className="spec-grid">

        <div className="spec-card">
            <h4>Standard</h4>
            <p>ASTM B163 / B167 / B407 / B514 / B515, ASME SB163 / SB167 / SB407 / SB514 / SB515</p>
        </div>
    ...
    <section className="stock-section">
      <div className="stock-container">
        ...
        <div className="stock-heading">
          <h2>READY STOCK AVAILABILITY – INCOLOY 800H / 800HT PIPES</h2>
        </div>
    ...
    <section className="grades-section">
      <div className="container">
        ...
        <div className="section-title">
          <h2>EQUIVALENT GRADES: INCOLOY 800H & 800HT</h2>
        </div>
    ...
    <section className="chemical-section">
      <div className="container">
        ...
        <div className="section-title">
          <h2>CHEMICAL COMPOSITION OF INCOLOY 800H / 800HT PIPES</h2>
        </div>
    ...
    <section className="mechanical-section">
      <div className="container">
        ...
        <div className="section-title">
          <h2>MECHANICAL PROPERTIES OF INCOLOY 800H / 800HT PIPING</h2>
        </div>
    ...
    <section className="thickness-section">
      <div className="container">
        ...
        <div className="section-title">
          <h2>
            SIZE RANGE AVAILABILITY: INCOLOY 800H / 800HT PIPES
            <span>(ASTM B163 / B167 / B407 / B514 / B515)</span>
          </h2>

          <p>
            Available in Seamless, Welded, ERW, EFW for both grades
          </p>
        </div>
    ...
    <section className="coil-weight-section">
      <div className="container">
        ...
        <div className="section-title">
          <h2>UNIFIED WEIGHT CHART: INCOLOY 800H / 800HT PIPES</h2>
        </div>
    ...
    <section className="finish-weight-section">
      <div className="container">
        ...
        <div className="section-title">
          <h2>INCOLOY 800H / 800HT PIPE SUPPLY RANGE (UNIFIED)</h2>
    ...
    <section className="gauge-chart-section">
      <div className="container">
        ...
        <div className="section-title">
          <h2>UNIFIED INCOLOY 800H / 800HT PIPE PRICE RANGE</h2>
        </div>
    ...
    <section className="specialty-weight-section">
      <div className="container">
        ...
        <div className="section-title">
          <h2>SPECIALIZED IN FOLLOWING INCOLOY 800H / 800HT PIPES</h2>
        </div>
    ...
    <section className="tolerance-section">
      <div className="container">
        ...
        <div className="section-title">
          <h2>SEARCHES RELATED TO INCOLOY 800H / 800HT PIPES</h2>
        </div>
...
export default Incoloy800PipesDetails;
