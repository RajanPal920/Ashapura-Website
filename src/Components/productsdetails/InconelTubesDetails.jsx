...
// Replace these image paths with your actual Inconel Tubes product images
import inconelSeamlessTubes from "../../products-image/ss-seamless-tubes.webp";
import inconelWeldedTubes from "../../products-image/ss-welded-tubes.webp";
import inconelErwTubes from "../../products-image/ss-erw-tubes.webp";
import inconelRoundTubes from "../../products-image/ss-seamless-2-tubes.webp";
import inconelSquareTubes from "../../products-image/ss-heatexchanger-tubes.webp";
import inconelHollowTubes from "../../products-image/ss-hollow-tubes.webp";
...
const stockData = [
  {
    title: "INCONEL 600 SEAMLESS TUBES",
    image: inconelSeamlessTubes,
    items: [
      "Inconel 600 Seamless Tubes (ASTM B163)",
      "UNS N06600 / 2.4816",
      "Cold Drawn & Annealed",
  ...
  {
    title: "INCONEL 625 SEAMLESS TUBES",
    image: inconelSeamlessTubes,
    items: [
  ...
  {
    title: "INCONEL 718 SEAMLESS TUBES",
    image: inconelSeamlessTubes,
    items: [
  ...
  {
    title: "INCONEL X-750 SEAMLESS TUBES",
    image: inconelSeamlessTubes,
    items: [
  ...
  {
    title: "INCONEL 690 SEAMLESS TUBES",
    image: inconelSeamlessTubes,
    items: [
      "Inconel 690 Seamless Tubes (ASTM B163)",
      "UNS N06690 / 2.4642",
  ...
  {
    title: "INCONEL WELDED & ERW TUBES",
    image: inconelWeldedTubes,
    items: [
      "Inconel 600 / 625 Welded Tubes (ASTM B517)",
      "Inconel 718 / X-750 ERW Tubes",
...
const gradesData = [
  { grade: "Inconel 600", uns: "N06600", werkstoff: "2.4816", standard: "ASTM B163 / B167 / B517" },
  ...
  { grade: "Inconel 690", uns: "N06690", werkstoff: "2.4642", standard: "ASTM B163 / B167" },
];
...
// Approx weight per meter (kg/m) for Inconel tubes (density ~8.4) – wall 1mm
const leftTubeData = [
  { size: "6 mm OD x 1 mm WT", weight: "0.132" },
  { size: "8 mm OD x 1 mm WT", weight: "0.184" },
  { size: "10 mm OD x 1 mm WT", weight: "0.237" },
  { size: "12 mm OD x 1 mm WT", weight: "0.289" },
  { size: "14 mm OD x 1 mm WT", weight: "0.341" },
  { size: "16 mm OD x 1 mm WT", weight: "0.394" },
  { size: "18 mm OD x 1 mm WT", weight: "0.446" },
  { size: "20 mm OD x 1 mm WT", weight: "0.499" },
];
const rightTubeData = [
  { size: "25 mm OD x 1 mm WT", weight: "0.631" },
  { size: "30 mm OD x 1 mm WT", weight: "0.763" },
  { size: "35 mm OD x 1 mm WT", weight: "0.895" },
  { size: "40 mm OD x 1 mm WT", weight: "1.027" },
  { size: "50 mm OD x 1 mm WT", weight: "1.291" },
  { size: "63 mm OD x 1 mm WT", weight: "1.634" },
  { size: "80 mm OD x 1 mm WT", weight: "2.081" },
  { size: "100 mm OD x 1 mm WT", weight: "2.607" },
];
...
const rightTubeDataNew = [
  ...
  { size: "80 mm OD x 1 mm WT", weight: "2.081" },
  { size: "100 mm OD x 1 mm WT", weight: "2.607" },
  { size: "125 mm OD x 1 mm WT", weight: "3.264" },
  { size: "160 mm OD x 1 mm WT", weight: "4.185" },
  { size: "200 mm OD x 1 mm WT", weight: "5.238" },
  { size: "250 mm OD x 1 mm WT", weight: "6.557" },
  { size: "300 mm OD x 1 mm WT", weight: "7.877" },
  { size: "350 mm OD x 1 mm WT", weight: "9.196" },
  { size: "400 mm OD x 1 mm WT", weight: "10.515" },
  { size: "450 mm OD x 1 mm WT", weight: "11.835" },
  { size: "500 mm OD x 1 mm WT", weight: "13.154" },
  { size: "—", weight: "—" },
];
...
const leftItems = [
  "Inconel 600 / 625 / 718 / X-750 / 690 Seamless & Welded Tubes",
  "ASTM B163, B444, B983, B517 Compliant",
  "High-Temperature Oxidation & Corrosion Resistance",
  "Precipitation-Hardenable Grades (718, X-750) for Maximum Strength",
  "Excellent Resistance to Pitting, Crevice Corrosion & SCC",
  "Inconel Tubes Manufacturer in India",
];

const rightItems = [
  "ASTM B163 / B444 / B983 / B517 / ASME SB163 / SB444 / SB983 / SB517",
  ...
  "Inconel Tubes Supplier in Mumbai",
];

const searchTerms = [
  "Inconel 625 Tube Price Per Kg",
  "Inconel 600 Seamless Tube Weight Chart",
  "Inconel Tube Supplier In India",
  "Inconel 718 Tube Specifications",
  "Inconel X-750 Tube Price In Mumbai",
  "Inconel 690 Tube Dimensions",
  "Inconel Tube Price List",
  "Inconel 625 Tube Weight Calculator",
  "Inconel Tube Mechanical Properties",
  "Inconel Tube Stockist",
  "Inconel 718 Tube Heat Treatment",
  "Inconel Tube Price Per Kg In India",
  "Inconel 600 Tube Exporter",
  "Inconel Tube Manufacturers In Mumbai",
  "Buy Inconel Tubes In India",
];
...
const InconelTubesDetails = () => {
  return (
    <>
      <Helmet>
        <title>Inconel Tubes Supplier – Inconel 600, 625, 718, X-750, 690 Tubes</title>
        <meta
          name="description"
          content="Leading supplier of Inconel tubes including 600, 625, 718, X-750, 690. Seamless, welded, ERW, and custom sizes. Exceptional high-temperature strength and corrosion resistance for aerospace, chemical, and marine applications."
        />
      </Helmet>
      ...
      <div className="product-details-container">
        <div className="product-main-content">
          <section className="product-content">
            <div className="content-header">
              <h1>INCONEL TUBES SUPPLIER – SEAMLESS, WELDED, ERW & CUSTOM</h1>
            </div>
            <div className="content-image">
              <img src={inconel} alt="Inconel Tubes" className="main-image" />
            </div>
          ...
          <section className="product-content">
            <div className="content-header">
              <h2>INCONEL TUBES – ENGINEERED FOR EXTREME TEMPERATURE AND CORROSION RESISTANCE</h2>
              <p>
                Our comprehensive range of <strong>Inconel Tubes</strong> covers the most popular nickel-chromium superalloys, including <strong>Inconel 600</strong>, <strong>625</strong>, <strong>718</strong>, <strong>X-750</strong>, and <strong>690</strong>. These alloys are specifically engineered to withstand extreme temperatures, highly corrosive environments, and severe mechanical stress. Inconel 600 offers excellent oxidation resistance up to 1000°C; Inconel 625 provides outstanding resistance to pitting and crevice corrosion in chloride-rich environments; Inconel 718 is a precipitation-hardenable alloy delivering the highest strength in the family; Inconel X-750 offers age-hardenable creep resistance; and Inconel 690 provides superior resistance to oxidizing acids and aqueous corrosion. Whether you need tubes for heat exchangers, chemical reactors, or aerospace components, our Inconel tubes deliver reliable and long-lasting performance.
              </p>
              <hr />
              <h3>SEAMLESS & WELDED INCONEL TUBES</h3>
              <p>
                We supply Inconel tubes in <strong>seamless</strong> (ASTM B163, B444, B983) and <strong>welded / ERW</strong> (ASTM B517) forms. Available in OD ranges from 6 mm to 500 mm with wall thicknesses from 0.5 mm to 25 mm. Our inventory includes cold-drawn, annealed, and precision tubes to meet the stringent demands of heat exchangers, furnaces, and critical aerospace components.
              </p>
              <h3>APPLICATIONS & ADVANTAGES</h3>
              <p>
                Inconel tubes are the material of choice for critical applications in <strong>aerospace</strong> (hydraulic systems, engine components), <strong>chemical processing</strong> (reactors, heat exchangers), <strong>oil & gas</strong> (downhole tools, sour gas service), <strong>marine engineering</strong> (condensers, seawater piping), and <strong>power generation</strong> (boiler tubes, gas turbine components). Their unique combination of high-temperature strength, corrosion resistance, and fabricability ensures reliable service in the most demanding environments.
              </p>
              <hr />
              <h3>COMPLIANCE & STANDARDS</h3>
              <p>
                Our Inconel tubes are manufactured and tested in accordance with <strong>ASTM / ASME</strong> specifications, including <strong>ASTM B163, B444, B983, B517</strong> and their ASME equivalents. We provide comprehensive mill test certificates, PMI reports, and third-party inspection services to ensure full traceability and quality assurance.
              </p>
            </div>
          </section>

          <section className="specification-section">
            <h2>Specification: Inconel Tubes</h2>
            <div className="spec-grid">
              <div className="spec-card">
                <h4>Standard</h4>
                <p>ASTM B163, B444, B983, B517; ASME SB163, SB444, SB983, SB517</p>
              </div>
              <div className="spec-card">
                <h4>OD Range</h4>
                <p>6 mm – 500 mm</p>
          ...
          <section className="stock-section">
            <div className="stock-container">
              <div className="stock-heading">
                <h2>READY STOCK AVAILABILITY – INCONEL TUBES</h2>
              </div>
          ...
          <section className="chemical-section">
            <div className="container">
              <div className="section-title">
                <h2>CHEMICAL COMPOSITION OF INCONEL TUBES</h2>
              </div>
              <div className="table-responsive">
          ...
          <section className="mechanical-section">
            <div className="container">
              <div className="section-title">
                <h2>MECHANICAL PROPERTIES OF INCONEL TUBES</h2>
              </div>
              <div className="table-responsive">
          ...
          <section className="thickness-section">
            <div className="container">
              <div className="section-title">
                <h2>
                  OD RANGE AVAILABILITY: INCONEL TUBES
                  <span>(ASTM B163, B444, B983, B517)</span>
                </h2>
          ...
          <section className="coil-weight-section">
            <div className="container">
              <div className="section-title">
                <h2>UNIFIED WEIGHT CHART: INCONEL TUBES (1 mm Wall Thickness)</h2>
              </div>
              <div className="table-responsive">
          ...
          <section className="finish-weight-section">
            <div className="container">
              <div className="section-title">
                <h2>INCONEL TUBE SUPPLY RANGE (UNIFIED)</h2>
          ...
          <section className="gauge-chart-section">
            <div className="container">
              <div className="section-title">
                <h2>UNIFIED INCONEL TUBE PRICE RANGE</h2>
              </div>
              <div className="table-responsive">
          ...
          <section className="specialty-weight-section">
            <div className="container">
              <div className="section-title">
                <h2>SPECIALIZED IN FOLLOWING INCONEL TUBES</h2>
              </div>
              <div className="table-responsive">
          ...
          <section className="tolerance-section">
            <div className="container">
              <div className="section-title">
                <h2>SEARCHES RELATED TO INCONEL TUBES</h2>
              </div>
              <div className="table-responsive">
        ...
        <div className="product-sidebar-wrapper">
          ...
          <div className="quote-card">
            <h2>GET A QUOTE</h2>
            <p>Immediate pricing for Inconel tubes. Contact our sales team for bulk discounts and technical support.</p>
...
export default InconelTubesDetails;