...
import CoilsBanner from "../../products-image/ss-incoloy-coils.webp";
...
const gradesData = [
  {
    ...
    uns: "N08800",
    werkstoff: "1.4876",
    standard: "NCF 800 / Z8NC32-21 / NA 15",
  },
  {
    grade: "Incoloy 800H",
    uns: "N08810",
    werkstoff: "1.4958",
    standard: "NCF 800H / X5NiCrAlTi31-20 / NA 15(H)",
  },
  {
    grade: "Incoloy 800HT",
    uns: "N08811",
    werkstoff: "1.4859",
    standard: "NCF 800HT / X8NiCrAlTi32-21 / NA 15(HT)",
  },
  {
    grade: "Incoloy 825",
    uns: "N08825",
    werkstoff: "2.4858",
    standard: "NCF 825 / NiCr21Mo / NA 16 / XH38BT",
  },
  {
    grade: "Incoloy 925",
    uns: "N09925",
...
const IncoloyCoilsDetails = () => {
  return (
    <>
        <Helmet>
            <title>Incoloy Coils Supplier</title>
            <meta
            name="description"
            content="Supplier and stockist of Incoloy coils including grades 800, 800H, 800HT, 825, 925, and DS 330 for heat-resistant and corrosion-resistant applications."
            />
        </Helmet>
      ...
      <div className="product-details-container">
        ...
        <section className="product-content">
            <div className="content-header">
                <h1>INCOLOY COILS SUPPLIER – 800, 800H, 800HT, 825, 925 &amp; DS 330</h1>
            </div>
            <div className="content-image">
                <img src={CoilsBanner} alt="Incoloy Coils" className="main-image" />
            </div>
        ...
        <section className="product-content">
            <div className="content-header">
                <h2>INCOLOY COILS: TECHNICAL OVERVIEW</h2>
                <p>Incoloy coils represent a specialized family of nickel-iron-chromium superalloys engineered to bridge the performance gap between conventional stainless steels and high-cost nickel alloys. These materials are designed for applications requiring excellent high-temperature strength and resistance to oxidation, carburization, and various forms of aqueous corrosion.</p>
                <hr/>
                <h3>INCOLOY 800, 800H, AND 800HT: HIGH-TEMPERATURE STABILITY</h3>
                <p>Incoloy 800 (UNS N08800) is used primarily for service up to 1100°F (593°C), offering general resistance to oxidation and nitriding. For higher temperature requirements, Incoloy 800H and 800HT are utilized for greater creep and rupture strength in petrochemical furnaces, steam generators, and industrial heating elements.</p>
                <h3>INCOLOY DS AND ALLOY 330: RESISTANCE TO CARBURIZATION</h3>
                <p>Incoloy DS and Alloy 330 are specifically engineered for the heat-treating industry. Their higher silicon content provides superior resistance to internal oxidation and green rot in carburizing and nitriding atmospheres, making them suitable for furnace muffles, heat-treating baskets, and radiant tubes.</p>
                <h3>INCOLOY 825 AND 925: ADVANCED CORROSION RESISTANCE</h3>
                <p>Incoloy 825 is titanium-stabilized with added molybdenum and copper for exceptional resistance to chloride-ion stress corrosion cracking and aggressive acids. Incoloy 925 delivers the same superior corrosion resistance with significantly higher strength through precipitation hardening.</p>
                <hr/>
                <h3>MANUFACTURING STANDARDS AND QUALITY ASSURANCE</h3>
                <p>Our Incoloy coils are manufactured in strict accordance with international standards, including <strong>ASTM B409, ASTM B424, and ASME SB409</strong>. We offer hot-rolled, cold-rolled, and precision-slit coils with rigorous PMI, ultrasonic, and tensile verification supported by test certificates and inspection reports.</p>
            </div>
        </section>
    ...
    <h2>Specification of Incoloy 800 / 800H / 800HT / 825 / 925 / DS 330 Coils</h2>

    <div className="spec-grid">

        <div className="spec-card">
            <h4>Standard</h4>
            <p>ASTM B409 / ASME SB409</p>
        </div>
        ...
        <div className="spec-card">
            ...
            <p>Cutting, Polishing, Threading, NDT, Destructive &amp; Ultrasonic Testing</p>
        </div>
    ...
    <section className="stock-section">
      <div className="stock-container">
        ...
        <div className="stock-heading">
          <h2>STOCK AVAILABILITY OF INCOLOY COILS</h2>
        </div>
    ...
    <section className="grades-section">
      <div className="container">
        ...
        <div className="section-title">
          <h2>EQUIVALENT GRADES: INCOLOY 800 / 800H / 800HT / 825 / 925 / DS 330 COILS</h2>
        </div>
    ...
    <section className="chemical-section">
      <div className="container">
        ...
        <div className="section-title">
          <h2>CHEMICAL COMPOSITION OF INCOLOY ALLOY COILS</h2>
        </div>
    ...
    <section className="thickness-section">
      <div className="container">
        ...
        <div className="section-title">
          <h2>
            THICKNESS AVAILABILITY: INCOLOY COILS
            <span>(ASTM B409 / ASME SB409)</span>
          </h2>

          <p>
            Available for Incoloy 800, 800H, 800HT, 825, 925, and DS 330 coils
          </p>
        </div>
    ...
    <section className="coil-weight-section">
      <div className="container">
        ...
        <div className="section-title">
          <h2>INCOLOY COLD ROLLED COILS (DESCALED) WEIGHT CHART</h2>
        </div>
    ...
    <section className="finish-weight-section">
      <div className="container">
        ...
        <div className="section-title">
          <h2>INCOLOY 800 / 800H / 800HT / 825 / 925 / DS 330 COIL STOCK AVAILABILITY</h2>

          <p>
            ASTM SB409 / SB424 / SB163 Incoloy coils in standard stock sizes
          </p>
        </div>
    ...
    <section className="gauge-chart-section">
      <div className="container">
        ...
        <div className="section-title">
          <h2>INCOLOY COILS THICKNESS GAUGE CHART</h2>
        </div>
    ...
    <section className="specialty-weight-section">
      <div className="container">
        ...
        <div className="section-title">
          <h2>INCOLOY COILS WEIGHT / SIZE CHART</h2>
        </div>
    ...
    <section className="tolerance-section">
      <div className="container">
        ...
        <div className="section-title">
          <h2>INCOLOY COILS THICKNESS TOLERANCE</h2>
        </div>
    ...
    <section className="specialized-section">
      <div className="container">
        ...
        <div className="section-title orange-border">
          <h2>SPECIALIZED IN INCOLOY 800 / 800H / 800HT / 825 / 925 / DS 330 COILS</h2>
        </div>
    ...
    <section className="searches-section">
      <div className="container">
        ...
        <div className="search-box">
          ...
          <div className="section-title">
            <h2>SEARCHES RELATED TO INCOLOY ALLOY COILS</h2>
          </div>
...
export default IncoloyCoilsDetails;
