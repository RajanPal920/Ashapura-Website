...
// Replace these image paths with your actual Incoloy 825 product images
import incoloy825Seamless from "../../products-image/ss-nimonic-pipes.webp";
import incoloy825Welded from "../../products-image/ss-nitronic-pipes.webp";
import incoloy825Erw from "../../products-image/ss-nilo42-pipes.webp";
import incoloy825Round from "../../products-image/ss-alloy-a286-pipes.webp";
import incoloy825Square from "../../products-image/ss-alloy-926-pipes.webp";
import incoloy825Hollow from "../../products-image/ss-nichrome-pipes.webp";

import incoloy825Alloy from "../../products-image/ss-incoloy-825-pipes.webp"; 
import "./Productsdetails.css";

const stockData = [
  {
    title: "INCOLOY 825 SEAMLESS PIPES",
    image: incoloy825Seamless,
    items: [
      "Incoloy 825 Seamless Pipes (ASTM B423)",
      "UNS N08825 / 2.4858 Seamless Piping",
      "Cold Drawn & Annealed 825 Seamless Tubes",
      "Seamless Pipes for Sulfuric Acid Service",
    ],
  },
  {
    title: "INCOLOY 825 WELDED PIPES",
    image: incoloy825Welded,
    items: [
      "Incoloy 825 Welded Pipes (ASTM B705 / B775)",
      "Incoloy 825 ERW / EFW Pipes",
      "Large Diameter Welded 825 Pipes",
      "Heavy Wall Welded Incoloy 825 Piping Systems",
    ],
  },
  {
    title: "INCOLOY 825 ERW PIPES",
    image: incoloy825Erw,
    items: [
      "Incoloy 825 ERW Pipes",
      "Electric Resistance Welded 825 Pipes",
      "Incoloy 825 ERW Round & Square Pipes",
      "Precision Welded 825 for Chemical Processing",
    ],
  },
  {
    title: "INCOLOY 825 ROUND PIPES",
    image: incoloy825Round,
    items: [
      "Incoloy 825 Round Pipes",
      "Incoloy 825 Round Hollow Sections",
      "Incoloy 825 Round Pipes for Heat Exchangers",
      "Precision Incoloy 825 Round Pipes",
    ],
  },
  {
    title: "INCOLOY 825 SQUARE PIPES",
    image: incoloy825Square,
    items: [
      "Incoloy 825 Square Pipes",
      "Incoloy 825 Square Hollow Sections",
      "Incoloy 825 Square Tubes for Structural Use",
      "Custom Incoloy 825 Square Pipes",
    ],
  },
  {
    title: "INCOLOY 825 HOLLOW PIPES",
    image: incoloy825Hollow,
    items: [
      "Incoloy 825 Hollow Pipes",
      "Incoloy 825 Heavy Wall Hollow Pipes",
      "Incoloy 825 Hollow Section",
      "Incoloy 825 Hollow Pipes for Heat Exchangers",
    ],
  }
];
...
const gradesData = [
  {
    ...
    uns: "N08825",
    werkstoff: "2.4858",
    standard: "ASTM B423 / B705 / B775",
  },
  {
    grade: "Incoloy 825 (DIN)",
    uns: "N08825",
    werkstoff: "2.4858",
    standard: "EN 2.4858 / NiCr21Mo",
  },
];
...
const mechanicalData = [
  {
    grade: "Incoloy 825 (Annealed)",
    tensile: "586 MPa (85 ksi) min",
    yield: "241 MPa (35 ksi) min",
    elongation: "30%",
    density: "8.14 g/cm³",
  },
];
...
const leftItems = [
  "Incoloy 825 Seamless & Welded Pipes",
  "Incoloy 825 Annealed & Cold Drawn Pipes",
  "Incoloy 825 ERW & EFW Pipes",
  "Incoloy 825 Round, Square & Rectangular Pipes",
  "Incoloy 825 Heavy Wall & Hollow Pipes",
  "Incoloy 825 Pipes for Sulfuric Acid & Chemical Processing",
  "Incoloy 825 Pipe Manufacturer in India",
];

const rightItems = [
  "ASTM B423 / B705 / B775 / B163 / B366",
  ...
  "Incoloy 825 Hollow Section & Square Pipes",
  "Incoloy 825 Pipe Supplier in Mumbai",
];

const searchTerms = [
  "Incoloy 825 Pipe Price Per Kg",
  "Incoloy 825 Seamless Pipe Weight Chart",
  "Incoloy 825 Pipe Supplier In India",
  "Incoloy 825 Chemical Composition",
  "Incoloy 825 Pipe Pressure Rating",
  "Incoloy 825 Pipe Price In Mumbai",
  "Incoloy 825 Pipe Dimensions",
  "Incoloy 825 Pipe Specifications Pdf",
  "Incoloy 825 Sulfuric Acid Resistance",
  "Incoloy 825 Pipe Price List",
  "Incoloy 825 Pipe Weight Calculator",
  "Incoloy 825 Pipe Mechanical Properties",
  "Incoloy 825 Pipe Stockist",
  "Incoloy 825 Pipe Equivalent Grades",
  "Incoloy 825 Pipe Price Per Kg In India",
  "Incoloy 825 Seamless Pipe Exporter",
  "Incoloy 825 Welded Pipe Supplier",
  "Incoloy 825 Pipe Sizes",
  "Incoloy 825 Pipe Schedule",
  "Incoloy 825 Pipe UNS N08825",
  "Incoloy 825 Pipe 2.4858",
  "Incoloy 825 Pipe Manufacturers In Mumbai",
  "Buy Incoloy 825 Pipes In India",
];
...
const Incoloy825PipesDetails = () => {
  return (
    <>
      <Helmet>
        <title>Incoloy 825 Pipes Supplier, Stockist & Exporter</title>
        <meta
          name="description"
          content="Leading supplier of Incoloy 825 (UNS N08825) pipes in seamless, welded, ERW, and custom sizes. Excellent resistance to sulfuric acid and stress corrosion cracking for chemical processing."
        />
      </Helmet>
      ...
      <div className="product-details-container">
        <div className="product-main-content">
          <section className="product-content">
            <div className="content-header">
              <h1>INCOLOY 825 PIPES SUPPLIER – SEAMLESS, WELDED, ERW & CUSTOM</h1>
            </div>
            <div className="content-image">
              <img src={incoloy825Alloy} alt="Incoloy 825 Pipes" className="main-image" />
            </div>
          ...
          <section className="product-content">
            <div className="content-header">
              <h2>INCOLOY 825 PIPES – NICKEL-IRON-CHROMIUM ALLOY WITH EXCELLENT ACID RESISTANCE</h2>
              <p>
                <strong>Incoloy 825</strong> (UNS N08825 / Werkstoff 2.4858) is a nickel-iron-chromium alloy specifically engineered for superior resistance to reducing and oxidizing acids, stress-corrosion cracking, pitting, and crevice corrosion. The addition of molybdenum and copper enhances its resistance to sulfuric and phosphoric acids, while titanium stabilizes the alloy against intergranular corrosion. This combination makes Incoloy 825 a versatile and reliable choice for the most aggressive chemical environments.
              </p>
              <hr />
              <h3>SEAMLESS & WELDED INCOLOY 825 PIPES</h3>
              <p>
                We supply Incoloy 825 pipes in <strong>seamless (ASTM B423)</strong> and <strong>welded (ASTM B705 / B775)</strong> forms, available from ½" NB to 24" NB and schedules SCH 5 to SCH XXS. Our inventory includes solution-annealed, cold-drawn, and precision tubes to meet the most stringent specifications for chemical reactors and heat exchangers.
              </p>
              <h3>APPLICATIONS & ADVANTAGES</h3>
              <p>
                Incoloy 825 is the material of choice for critical applications in <strong>sulfuric and phosphoric acid production</strong>, <strong>chemical processing</strong> (reactors, distillation columns), <strong>offshore oil & gas</strong> (sour gas service), <strong>pollution control</strong> (scrubbers), and <strong>seawater cooling</strong> systems. Its excellent resistance to chloride stress-corrosion cracking ensures long service life in demanding industrial environments.
              </p>
              <hr />
              <h3>COMPLIANCE & STANDARDS</h3>
              <p>
                Our Incoloy 825 pipes are manufactured and tested in accordance with <strong>ASTM / ASME</strong> specifications, including <strong>ASTM B423, B705, B775, B163, B366</strong>. We provide comprehensive mill test certificates, PMI reports, and third-party inspection services to ensure full traceability and quality assurance.
              </p>
            </div>
          </section>

          <section className="specification-section">
            <h2>UNIFIED SPECIFICATION: INCOLOY 825 PIPES</h2>
            <div className="spec-grid">
              <div className="spec-card">
                <h4>Standard</h4>
                <p>ASTM / ASME B423, B705, B775, B163, B366</p>
              </div>
              <div className="spec-card">
                <h4>Size Range</h4>
          ...
          <section className="stock-section">
            <div className="stock-container">
              <div className="stock-heading">
                <h2>READY STOCK AVAILABILITY – INCOLOY 825 PIPES</h2>
              </div>
          ...
          <section className="grades-section">
            <div className="container">
              <div className="section-title">
                <h2>EQUIVALENT GRADES: INCOLOY 825</h2>
              </div>
          ...
          <section className="chemical-section">
            <div className="container">
              <div className="section-title">
                <h2>CHEMICAL COMPOSITION OF INCOLOY 825 PIPES</h2>
              </div>
              <div className="table-responsive">
          ...
          <section className="mechanical-section">
            <div className="container">
              <div className="section-title">
                <h2>MECHANICAL PROPERTIES OF INCOLOY 825 PIPING</h2>
              </div>
              <div className="table-responsive">
          ...
          <section className="thickness-section">
            <div className="container">
              <div className="section-title">
                <h2>
                  SIZE RANGE AVAILABILITY: INCOLOY 825 PIPES
                  <span>(ASTM / ASME B423, B705, B775)</span>
                </h2>
          ...
          <section className="coil-weight-section">
            <div className="container">
              <div className="section-title">
                <h2>UNIFIED WEIGHT CHART: INCOLOY 825 PIPES</h2>
              </div>
              <div className="table-responsive">
          ...
          <section className="finish-weight-section">
            <div className="container">
              <div className="section-title">
                <h2>INCOLOY 825 PIPE SUPPLY RANGE (UNIFIED)</h2>
          ...
          <section className="gauge-chart-section">
            <div className="container">
              <div className="section-title">
                <h2>UNIFIED INCOLOY 825 PIPE PRICE RANGE</h2>
              </div>
              <div className="table-responsive">
          ...
          <section className="specialty-weight-section">
            <div className="container">
              <div className="section-title">
                <h2>SPECIALIZED IN FOLLOWING INCOLOY 825 PIPES</h2>
              </div>
              <div className="table-responsive">
          ...
          <section className="tolerance-section">
            <div className="container">
              <div className="section-title">
                <h2>SEARCHES RELATED TO INCOLOY 825 PIPES</h2>
              </div>
              <div className="table-responsive">
        ...
        <div className="product-sidebar-wrapper">
          ...
          <div className="quote-card">
            <h2>GET A QUOTE</h2>
            <p>Immediate pricing for Incoloy 825 pipes. Contact our sales team for bulk discounts and technical support.</p>
...
export default Incoloy825PipesDetails;