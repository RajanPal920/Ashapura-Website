...
// Replace these image paths with your actual Incoloy 800/DS/330 product images
import incoloySeamless from "../../products-image/ss-nimonic-pipes.webp";
import incoloyWelded from "../../products-image/ss-nitronic-pipes.webp";
import incoloyErw from "../../products-image/ss-nilo42-pipes.webp";
import incoloyRound from "../../products-image/ss-alloy-a286-pipes.webp";
import incoloySquare from "../../products-image/ss-alloy-926-pipes.webp";
import incoloyHollow from "../../products-image/ss-alloy-926-pipes.webp";

import incoloySpecial from "../../products-image/ss-incoloy-800-330ds-pipes.webp"; 
import "./Productsdetails.css";

const stockData = [
  {
    title: "INCOLOY 800/DS/330 SEAMLESS PIPES",
    image: incoloySeamless,
    items: [
      "Incoloy 800 / H / HT Seamless Pipes (ASTM B407)",
      "Alloy DS / 330 Seamless Pipes (ASTM B409)",
      "UNS N08800 / N08330 Seamless Piping",
      "Cold Drawn & Annealed High-Temp Seamless Tubes",
    ],
  },
  {
    title: "INCOLOY 800/DS/330 WELDED PIPES",
    image: incoloyWelded,
    items: [
      "Incoloy 800 / 800H / 800HT Welded Pipes",
      "Alloy DS / 330 Welded Pipes (ASTM B514)",
      "Incoloy 800 ERW / EFW Pipes",
      "Large Diameter Welded Pipes for Furnaces",
    ],
  },
  {
    title: "INCOLOY 800/DS/330 ERW PIPES",
    image: incoloyErw,
    items: [
      "Incoloy 800 ERW Pipes",
      "Alloy DS / 330 Electric Resistance Welded Pipes",
      "Incoloy 800 ERW Round & Square Pipes",
      "Precision Welded Pipes for Chemical Processing",
    ],
  },
  {
    title: "INCOLOY 800/DS/330 ROUND PIPES",
    image: incoloyRound,
    items: [
      "Incoloy 800 / 800H Round Pipes",
      "Alloy 330 Round Hollow Sections",
      "Incoloy 800H Round Pipes for Heat Exchangers",
      "Precision Incoloy 800 Round Pipes",
    ],
  },
  {
    title: "INCOLOY 800/DS/330 SQUARE PIPES",
    image: incoloySquare,
    items: [
      "Incoloy 800 Square Pipes",
      "Alloy DS / 330 Square Hollow Sections",
      "Incoloy 800HT Square Tubes for Structural Use",
      "Custom Incoloy 800 Square Pipes",
    ],
  },
  {
    title: "INCOLOY 800/DS/330 HOLLOW PIPES",
    image: incoloyHollow,
    items: [
      "Incoloy 800 Hollow Pipes",
      "Alloy 330 Heavy Wall Hollow Pipes",
      "Incoloy 800H Hollow Section",
      "Incoloy 800 Hollow Pipes for Heat Exchangers",
    ],
  }
];
...
const chemicalData = [
  ...
  },
  {
    ...
    ni: "30.0-35.0",
    mo: "—",
    other: "Al+Ti: 0.85-1.20, Fe: Balance",
  },
  {
    grade: "Incoloy 800HT",
    c: "0.06-0.10",
...
const mechanicalData = [
  ...
  {
    grade: "Incoloy 800HT",
    tensile: "450 MPa (65 ksi)",
    yield: "170 MPa (25 ksi)",
    elongation: "30%",
    density: "7.94 g/cm³",
  },
  {
...
const leftItems = [
  "Incoloy 800 / 800H / 800HT Seamless & Welded Pipes",
  "Alloy DS / 330 High-Silicon Pipes for Carburizing Service",
  "Incoloy 800 ERW & EFW Pipes",
  "Incoloy 800 Round, Square & Rectangular Pipes",
  "Incoloy 800H Heavy Wall & Hollow Pipes",
  "Incoloy 800 Pipes for Furnaces & Heat Exchangers",
  "Incoloy 800 / DS / 330 Pipe Manufacturer in India",
];

const rightItems = [
  "ASTM B407 / B409 / B514 / B536 / B366",
  ...
  "Incoloy 800H Hollow Section & Square Pipes",
  "Incoloy 800 / DS / 330 Pipe Supplier in Mumbai",
];

const searchTerms = [
  "Incoloy 800 Pipe Price Per Kg",
  "Incoloy 800H Seamless Pipe Weight Chart",
  "Incoloy 800 Pipe Supplier In India",
  "Incoloy 800 Chemical Composition",
  "Alloy 330 Pipe Pressure Rating",
  "Incoloy 800 Pipe Price In Mumbai",
  "Incoloy 800H Pipe Dimensions",
  "Incoloy 800 Pipe Specifications Pdf",
  "Incoloy 800 Heat Treatment",
  "Incoloy 800 Pipe Price List",
  "Incoloy 800 Pipe Weight Calculator",
  "Incoloy 800 Pipe Mechanical Properties",
  "Incoloy 800 Pipe Stockist",
  "Alloy DS Pipe Equivalent Grades",
  "Incoloy 800 Pipe Price Per Kg In India",
  "Incoloy 800 Seamless Pipe Exporter",
  "Incoloy 800HT Welded Pipe Supplier",
  "Incoloy 800 Pipe Sizes",
  "Incoloy 800 Pipe Schedule",
  "Incoloy 800 Pipe UNS N08800",
  "Alloy 330 Pipe 1.4886",
  "Incoloy 800 Pipe Manufacturers In Mumbai",
  "Buy Incoloy 800 / DS / 330 Pipes In India",
];
...
const Incoloy800DSPipesDetails = () => {
  return (
    <>
      <Helmet>
        <title>Incoloy 800 / DS / 330 Pipes Supplier, Stockist & Exporter</title>
        <meta
          name="description"
          content="Leading supplier of Incoloy 800 (UNS N08800), Alloy DS, and Alloy 330 (UNS N08330) pipes in seamless, welded, ERW, and custom sizes. Excellent high-temperature oxidation and carburization resistance."
        />
      </Helmet>
      ...
      <Banner
        title="INCOLOY 800 / DS / 330 PIPES"
        image={ProductBanner}
      />
      ...
      <div className="product-details-container">
        <div className="product-main-content">
          <section className="product-content">
            <div className="content-header">
              <h1>INCOLOY 800 / DS / 330 PIPES SUPPLIER – SEAMLESS, WELDED, ERW & CUSTOM</h1>
            </div>
            <div className="content-image">
              <img src={incoloySpecial} alt="Incoloy 800 / DS / 330 Pipes" className="main-image" />
            </div>
          ...
          <section className="product-content">
            <div className="content-header">
              <h2>INCOLOY 800 / DS / 330 PIPES – SUPERIOR CARBURIZATION & OXIDATION RESISTANCE</h2>
              <p>
                Our comprehensive range of <strong>Incoloy 800, 800H, 800HT, Alloy DS, and Alloy 330</strong> pipes offers exceptional high-temperature strength and outstanding resistance to oxidation, carburization, and nitriding. <strong>Incoloy 800 (UNS N08800)</strong> provides good creep and rupture strength up to 816°C. The H and HT variants (UNS N08810 / N08811) are specifically controlled for enhanced creep-rupture properties through precise Al+Ti content. <strong>Alloy DS and Alloy 330 (UNS N08330)</strong> are high-silicon nickel-iron-chromium alloys designed to resist the severe carburizing atmospheres found in heat-treating furnaces and petrochemical applications.
              </p>
              <hr />
              <h3>SEAMLESS & WELDED INCOLOY 800/DS/330 PIPES</h3>
              <p>
                We supply these alloys in <strong>seamless (ASTM B407 / B409)</strong> and <strong>welded (ASTM B514 / B536)</strong> forms, available from ½" NB to 24" NB and schedules SCH 5 to SCH XXS. Our inventory includes solution-annealed, cold-drawn, and precision tubes to meet the demands of the most critical high-temperature installations.
              </p>
              <h3>APPLICATIONS & ADVANTAGES</h3>
              <p>
                These alloys are widely used in <strong>industrial furnaces</strong> (retorts, muffles, radiant tubes), <strong>petrochemical cracking</strong> (ethylene furnaces), <strong>heat exchangers</strong>, and <strong>nuclear steam generators</strong>. Their ability to withstand thermal cycling, high-temperatures, and aggressive gaseous atmospheres ensures reliable and long-lasting performance.
              </p>
              <hr />
              <h3>COMPLIANCE & STANDARDS</h3>
              <p>
                Our pipes are manufactured in accordance with <strong>ASTM / ASME</strong> specifications, including <strong>ASTM B407, B409, B514, B536, B366</strong>. We provide full mill test certificates, PMI reports, and third-party inspection services to ensure complete traceability.
              </p>
            </div>
          </section>

          <section className="specification-section">
            <h2>UNIFIED SPECIFICATION: INCOLOY 800 / DS / 330 PIPES</h2>
            <div className="spec-grid">
              <div className="spec-card">
                <h4>Standard</h4>
                <p>ASTM / ASME B407, B409, B514, B536, B366</p>
              </div>
              <div className="spec-card">
                <h4>Size Range</h4>
          ...
          <section className="stock-section">
            <div className="stock-container">
              <div className="stock-heading">
                <h2>READY STOCK AVAILABILITY – INCOLOY 800 / DS / 330 PIPES</h2>
              </div>
          ...
          <section className="grades-section">
            <div className="container">
              <div className="section-title">
                <h2>EQUIVALENT GRADES: INCOLOY 800 / DS / 330</h2>
              </div>
          ...
          <section className="chemical-section">
            <div className="container">
              <div className="section-title">
                <h2>CHEMICAL COMPOSITION OF INCOLOY 800 / DS / 330 PIPES</h2>
              </div>
              <div className="table-responsive">
          ...
          <section className="mechanical-section">
            <div className="container">
              <div className="section-title">
                <h2>MECHANICAL PROPERTIES OF INCOLOY 800 / DS / 330 PIPING</h2>
              </div>
              <div className="table-responsive">
          ...
          <section className="thickness-section">
            <div className="container">
              <div className="section-title">
                <h2>
                  SIZE RANGE AVAILABILITY: INCOLOY 800 / DS / 330 PIPES
                  <span>(ASTM / ASME B407, B409, B514)</span>
                </h2>
          ...
          <section className="coil-weight-section">
            <div className="container">
              <div className="section-title">
                <h2>UNIFIED WEIGHT CHART: INCOLOY 800 / DS / 330 PIPES</h2>
              </div>
              <div className="table-responsive">
          ...
          <section className="finish-weight-section">
            <div className="container">
              <div className="section-title">
                <h2>INCOLOY 800 / DS / 330 PIPE SUPPLY RANGE (UNIFIED)</h2>
          ...
          <section className="gauge-chart-section">
            <div className="container">
              <div className="section-title">
                <h2>UNIFIED INCOLOY 800 / DS / 330 PIPE PRICE RANGE</h2>
              </div>
              <div className="table-responsive">
          ...
          <section className="specialty-weight-section">
            <div className="container">
              <div className="section-title">
                <h2>SPECIALIZED IN FOLLOWING INCOLOY 800 / DS / 330 PIPES</h2>
              </div>
              <div className="table-responsive">
          ...
          <section className="tolerance-section">
            <div className="container">
              <div className="section-title">
                <h2>SEARCHES RELATED TO INCOLOY 800 / DS / 330 PIPES</h2>
              </div>
              <div className="table-responsive">
        ...
        <div className="product-sidebar-wrapper">
          ...
          <div className="quote-card">
            <h2>GET A QUOTE</h2>
            <p>Immediate pricing for Incoloy 800 / DS / 330 pipes. Contact our sales team for bulk discounts and technical support.</p>
...
export default Incoloy800DSPipesDetails;