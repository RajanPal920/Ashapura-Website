...
const stockData = [
  {
    title: "INCONEL 690 SEAMLESS PIPES",
    image: inconelSeamless,
    items: [
      "Inconel 690 Seamless Pipes",
      "ASTM B167 / B163 Seamless",
      "UNS N06690 / EN 2.4642",
      "High-Temperature & Corrosion Resistant",
    ],
  },
  {
    title: "INCONEL 690 WELDED PIPES",
    image: inconelWelded,
    items: [
      "Inconel 690 Welded Pipes",
      "ASTM B407 / B517 Welded",
      "Longitudinal & Spiral Welded",
      "Industrial Process Piping",
    ],
  },
  {
    title: "INCONEL 690 ERW PIPES",
    image: inconelErw,
    items: [
      "Inconel 690 ERW Pipes",
  ...
  {
    title: "INCONEL 690 EFW PIPES",
    image: inconelEfw,
    items: [
      "Inconel 690 EFW Pipes",
  ...
  {
    title: "INCONEL 690 UBO PIPES",
    image: inconelUbo,
    items: [
      "Inconel 690 UBO Pipes",
      "Unified Bare Outer Pipes",
      "Superior SCC Resistance",
      "For Nuclear & Chemical Service",
    ],
  },
  {
    title: "INCONEL 690 SPECIALTY PIPES",
    image: inconelSpecial,
    items: [
      "Inconel 690 Nickel-Chromium Alloy",
      "High Chromium (28-31%)",
      "Excellent Resistance to Caustic & High-Temp Water",
...
const leftItems = [
  "Inconel 690 Seamless & Welded Pipes",
  "Inconel 690 ERW & EFW Pipes",
  "ASTM B163 / B167 / B407 / B517 Compliant",
  "High Chromium Content for Oxidizing Media",
  "Excellent Resistance to Stress Corrosion Cracking (SCC)",
  "Inconel 690 for Nuclear & Chemical Processing",
  "Inconel 690 Pipes Manufacturer in India",
];

const rightItems = [
  "ASTM B163 / B167 / B407 / B517 Inconel 690 Pipes",
  ...
  "Inconel 690 Hollow Section & Square Pipes",
  "Inconel 690 Pipe Supplier in Mumbai",
];

const searchTerms = [
  "Inconel 690 Pipe Price Per Kg",
  ...
  "Inconel 690 Pipe Price In Mumbai",
  "Inconel 690 Pipe Dimensions",
  "Inconel 690 Pipe Specifications Pdf",
  "Inconel 690 Stress Corrosion Cracking",
  "Inconel 690 Pipe Price List",
  "Inconel 690 Pipe Weight Calculator",
  "Inconel 690 Pipe Mechanical Properties",
  "Inconel 690 Pipe Stockist",
  "Inconel 690 Heat Treatment",
  "Inconel 690 Pipe Price Per Kg In India",
  "Inconel 690 Seamless Pipe Exporter",
  "Inconel 690 Welded Pipe Supplier",
  "Inconel 690 Pipe Schedule",
  "Inconel 690 Equivalent Grades",
  "Inconel 690 UNS N06690",
  "Inconel 690 2.4642",
  "Inconel 690 Pipe Manufacturers In Mumbai",
  "Buy Inconel 690 Pipes In India",
];
...
const Inconel690PipesDetails = () => {
  return (
    <>
        <Helmet>
            <title>Inconel 690 Pipes Supplier – UNS N06690 Nickel-Chromium Alloy Pipes</title>
            <meta
            name="description"
            content="Supplier of Inconel 690 pipes (UNS N06690, 2.4642) with exceptional resistance to stress corrosion cracking, caustic media, and high-temperature water. Seamless, welded, ERW, EFW pipes available."
            />
        </Helmet>
      ...
      <div className="product-details-container">
        ...
        <section className="product-content">
            <div className="content-header">
                <h1>INCONEL 690 PIPES SUPPLIER – NICKEL-CHROMIUM ALLOY PIPES</h1>
            </div>
            <div className="content-image">
                <img src={inconel690} alt="Inconel 690 Pipes" className="main-image" />
            </div>
        ...
        <section className="product-content">
            <div className="content-header">
                <h2>INCONEL 690 PIPES: SUPERIOR CORROSION RESISTANCE FOR NUCLEAR & CHEMICAL SERVICE</h2>
                <p>Inconel 690 (UNS N06690) is a high-chromium nickel-based alloy designed to resist stress corrosion cracking (SCC) and other forms of aqueous corrosion. With a chromium content of 28–31%, it provides exceptional resistance to oxidizing media, caustic environments, and high-temperature water, making it a preferred material for nuclear reactor components, chemical processing equipment, and heat exchangers.</p>
                <hr/>
                <h3>KEY FEATURES OF INCONEL 690 PIPES</h3>
                <p><strong>Outstanding SCC Resistance</strong> – High chromium content provides exceptional resistance to chloride-induced stress corrosion cracking in high-temperature water.</p>
                <p><strong>Excellent Resistance to Caustic Media</strong> – Performs exceptionally well in strong alkaline solutions and oxidizing acids.</p>
                <p><strong>Good Weldability & Fabrication</strong> – Can be welded using conventional methods, retaining its corrosion-resistant properties in the heat-affected zone.</p>
                <hr/>
                <h3>SPECIFICATIONS & STANDARDS</h3>
                <p>Our Inconel 690 pipes conform to international standards including <strong>ASTM B163</strong> (seamless tubes), <strong>ASTM B167</strong> (seamless pipes), <strong>ASTM B407</strong> (welded), and <strong>ASTM B517</strong> (EFW). Available in seamless, welded, ERW, and EFW forms with custom schedules and lengths to suit critical applications.</p>
            </div>
        </section>
    ...
    <h2>Specification: Inconel 690 Pipes</h2>

    <div className="spec-grid">

        <div className="spec-card">
            <h4>Standard</h4>
            <p>ASTM B163 / B167 / B407 / B517, ASME SB163 / SB167 / SB407 / SB517</p>
        </div>
    ...
    <section className="stock-section">
      <div className="stock-container">
        ...
        <div className="stock-heading">
          <h2>READY STOCK AVAILABILITY – INCONEL 690 PIPES</h2>
        </div>
    ...
    <section className="grades-section">
      <div className="container">
        ...
        <div className="section-title">
          <h2>EQUIVALENT GRADES: INCONEL 690</h2>
        </div>
    ...
    <section className="chemical-section">
      <div className="container">
        ...
        <div className="section-title">
          <h2>CHEMICAL COMPOSITION OF INCONEL 690 PIPES</h2>
        </div>
    ...
    <section className="mechanical-section">
      <div className="container">
        ...
        <div className="section-title">
          <h2>MECHANICAL PROPERTIES OF INCONEL 690 PIPING</h2>
        </div>
    ...
    <section className="thickness-section">
      <div className="container">
        ...
        <div className="section-title">
          <h2>
            SIZE RANGE AVAILABILITY: INCONEL 690 PIPES
    ...
    <section className="coil-weight-section">
      <div className="container">
        ...
        <div className="section-title">
          <h2>UNIFIED WEIGHT CHART: INCONEL 690 PIPES</h2>
        </div>
    ...
    <section className="finish-weight-section">
      <div className="container">
        ...
        <div className="section-title">
          <h2>INCONEL 690 PIPE SUPPLY RANGE (UNIFIED)</h2>
    ...
    <section className="gauge-chart-section">
      <div className="container">
        ...
        <div className="section-title">
          <h2>UNIFIED INCONEL 690 PIPE PRICE RANGE</h2>
        </div>
    ...
    <section className="specialty-weight-section">
      <div className="container">
        ...
        <div className="section-title">
          <h2>SPECIALIZED IN FOLLOWING INCONEL 690 PIPES</h2>
        </div>
    ...
    <section className="tolerance-section">
      <div className="container">
        ...
        <div className="section-title">
          <h2>SEARCHES RELATED TO INCONEL 690 PIPES</h2>
        </div>
...
export default Inconel690PipesDetails;